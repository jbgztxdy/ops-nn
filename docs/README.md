...
| [环境部署](./context/quick_install.md)            | 介绍项目的基础环境搭建，包括软件包和第三方依赖的获取和安装， |
...
| [图融合Pass列表](./op_pass_list.md)               | 介绍项目支持的所有图融合规则。                               |


## 附录
| 文档                                | 说明                                                         |
| ----------------------------------- | ------------------------------------------------------------ |
| [算子基本概念](context/基本概念.md) | 介绍算子相关的基础概念和特性，包括量化/稀疏等术语、数据类型、数据格式等。 |
