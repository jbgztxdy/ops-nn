...
1. **安装社区版CANN toolkit包**
    ...
    - Atlas A2/A3系列产品：单击[下载链接](https://mirror-centralrepo.devcloud.cn-north-4.huaweicloud.com/artifactory/cann-run-release/software/8.5.0-20251226000923458/)获取软件包。
