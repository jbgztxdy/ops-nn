...
#include "level2/aclnn_quant_scatter_v2.h"
...
TEST_F(l2_inplace_quant_scatter_test_v2, ascend910_95_test_normal_input) {
...
TEST_F(l2_inplace_quant_scatter_test_v2, ascend910_95_test_dtype_combine_succ1) {
  // 使用**Desc描述host api输入输出
  auto selfRefDesc = TensorDesc({24, 4096, 128}, ACL_INT8, ACL_FORMAT_ND);
  auto indicesDesc = TensorDesc({24}, ACL_INT32, ACL_FORMAT_ND);
  auto updatesDesc = TensorDesc({24, 1, 128}, ACL_FLOAT16, ACL_FORMAT_ND);
...
TEST_F(l2_inplace_quant_scatter_test_v2, ascend910_95_test_dtype_combine_succ2) {
  // 使用**Desc描述host api输入输出
  auto selfRefDesc = TensorDesc({24, 4096, 128}, ACL_INT8, ACL_FORMAT_ND);
  auto indicesDesc = TensorDesc({24}, ACL_INT32, ACL_FORMAT_ND);
  auto updatesDesc = TensorDesc({24, 1, 128}, ACL_FLOAT16, ACL_FORMAT_ND);
...
TEST_F(l2_inplace_quant_scatter_test_v2, ascend910_95_test_empty) {
  // 使用**Desc描述host api输入输出
...
TEST_F(l2_inplace_quant_scatter_test_v2, ascend910_95_test_abnormal_self_nullptr) {
  // 使用**Desc描述host api输入输出
...
TEST_F(l2_inplace_quant_scatter_test_v2, ascend910_95_test_abnormal_indices_nullptr) {
  // 使用**Desc描述host api输入输出
  auto selfRefDesc = TensorDesc({24, 4096, 0}, ACL_INT8, ACL_FORMAT_ND);
...
TEST_F(l2_inplace_quant_scatter_test_v2, ascend910_95_test_abnormal_updates_nullptr) {
  // 使用**Desc描述host api输入输出
  auto selfRefDesc = TensorDesc({24, 4096, 0}, ACL_INT8, ACL_FORMAT_ND);
  auto indicesDesc = TensorDesc({24}, ACL_INT32, ACL_FORMAT_ND);
...
TEST_F(l2_inplace_quant_scatter_test_v2, ascend910_95_test_abnormal_quantScales_nullptr) {
  // 使用**Desc描述host api输入输出
  auto selfRefDesc = TensorDesc({24, 4096, 0}, ACL_INT8, ACL_FORMAT_ND);
  auto indicesDesc = TensorDesc({24}, ACL_INT32, ACL_FORMAT_ND);
  auto updatesDesc = TensorDesc({24, 1, 128}, ACL_BF16, ACL_FORMAT_ND);
