...
protected:
    static void SetUpTestCase() { std::cout << "l2_index_put_impl_test SetUp" << std::endl; }
...
TEST_F(l2_index_put_impl_test, l2_index_put_impl_test_001)
{
    ...
    auto ut = OP_API_UT(aclnnIndexPutImpl,
                        INPUT(self_desc, tensor_list_desc, value_desc, accumulate, unsafe), // host api输入
                        OUTPUT());
