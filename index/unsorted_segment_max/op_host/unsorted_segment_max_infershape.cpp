...
/*!
 * \file unsorted_segment_max_infershape.cpp
 * \brief
 */
...
{
  const char* opName_ = "UnsortedSegmentMax";
  ...
  if (num_segments_tensor->GetShapeSize() > 1) {
    OP_LOGE_FOR_INVALID_SHAPESIZE(opName_, "Size of num_segments",
...
IMPL_OP_INFERSHAPE(UnsortedSegmentMax)
