...
#include "index/gather_elements_v2/op_host/op_api/aclnn_gather.h"
...
TEST_F(l2Gather, case_norm_int32)
{
...
TEST_F(l2Gather, Ascend910_95_case_norm_bool)
{
    auto tensor_desc = TensorDesc({4, 4}, ACL_BOOL, ACL_FORMAT_ND);
    int64_t dim = 1;
