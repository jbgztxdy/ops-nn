...
#ifndef SCATTERMIN_PROTO_H_
#define SCATTERMIN_PROTO_H_

#include "graph/operator_reg.h"

namespace ge {
/**
* @brief Reduces sparse "updates" into a variable reference by taking the element-wise minimum. \n
