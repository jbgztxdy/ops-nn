...
ASCENDC_TPL_ARGS_DECL(repeatInterleaveGrad, REDUCE_TPL_KEY_DECL(),
                      ASCENDC_TPL_UINT_DECL(TemplateNum, REPEAT_INTERLEAVE_GRAD_BIT_WIDTH, ASCENDC_TPL_UI_RANGE, 1, 0,
                                            4));

ASCENDC_TPL_SEL(
    // empty
    ASCENDC_TPL_ARGS_SEL(REDUCE_TPL_KEY_SEL_EMPTY(), ASCENDC_TPL_UINT_SEL(TemplateNum, ASCENDC_TPL_UI_RANGE, 1, 0, 4)),
    // A
    ASCENDC_TPL_ARGS_SEL(REDUCE_TPL_KEY_SEL_A(), ASCENDC_TPL_UINT_SEL(TemplateNum, ASCENDC_TPL_UI_RANGE, 1, 0, 4)),
    // AR
