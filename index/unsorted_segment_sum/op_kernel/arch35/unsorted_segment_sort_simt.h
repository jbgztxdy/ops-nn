...
template <typename TX, typename Index>
__aicore__ inline void KernelUnsortedSegmentSortSimt<TX, Index>::Init(GM_ADDR x, GM_ADDR segmentIds, GM_ADDR output)
{
...
template <typename TX, typename Index>
__aicore__ inline void KernelUnsortedSegmentSortSimt<TX, Index>::CopyInX(
...
template <typename TX, typename Index>
__aicore__ inline void KernelUnsortedSegmentSortSimt<TX, Index>::CopyInIndex(
    int64_t baseCoreOffset, int64_t loopIdx, int64_t stride, int64_t length)
{
...
template <typename TX, typename Index>
__aicore__ inline int32_t KernelUnsortedSegmentSortSimt<TX, Index>::GetUniqueCount(
    LocalTensor<uint32_t>& cumSumLocal, LocalTensor<Index>& sortedSegmentLocal)
{
    ...
    uint32_t vl = Ops::Base::GetVRegSize() / sizeof(Index);
    uint16_t loopCnt = (uint16_t)(Ops::Base::CeilDiv(static_cast<uint32_t>(tilingData_->maxIndexNum + 1), vl));
...
template <typename TX, typename Index>
__aicore__ inline void KernelUnsortedSegmentSortSimt<TX, Index>::ProcessEachLoop(uint32_t maxIndexNum)
{
    ...
    AscendC::Simt::VF_CALL<SegmentReduceSortSimt<TX, Index>>(
...
template <typename TX, typename Index>
__aicore__ inline void KernelUnsortedSegmentSortSimt<TX, Index>::Process()
{
