...
#ifndef UNSORTED_SEGMENT_SUM_H
#define UNSORTED_SEGMENT_SUM_H
...
public:
    ...
    __aicore__ inline void SimtShell(COM_T inputLength)
    {
        ...
        AscendC::Simt::VF_CALL<SimtComputeSegment<T, Index, COM_T>>(
...
private:
    TPipe* pipe_ = nullptr;
    const UnsortedSegmentSumSimtTilingData* td_;
