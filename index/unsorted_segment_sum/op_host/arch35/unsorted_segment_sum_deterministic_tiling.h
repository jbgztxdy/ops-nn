...
TILING_DATA_FIELD_DEF(uint32_t, singleCoreSampleNum); // number of ids for first ub process
TILING_DATA_FIELD_DEF(uint32_t, tailSampleNum);
TILING_DATA_FIELD_DEF(uint32_t, maxLoopInCore);       // for first ub process
TILING_DATA_FIELD_DEF(uint32_t, usedLogicCore);       // for first ub process
TILING_DATA_FIELD_DEF(uint32_t, secondSampleNum);     // for second ub process
TILING_DATA_FIELD_DEF(uint32_t, thirdSampleNum);      // for third ub process
TILING_DATA_FIELD_DEF(uint32_t, row32BAlign);         // element num align to 32B
TILING_DATA_FIELD_DEF(uint32_t, maxThread);
TILING_DATA_FIELD_DEF(uint32_t, halfUBSize);     
END_TILING_DATA_DEF;
