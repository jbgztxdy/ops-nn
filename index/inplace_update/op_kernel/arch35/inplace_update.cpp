 ...
 * \brief kernel entry for InplaceUpdate
 */
    ...
    GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    if constexpr (schMode == static_cast<uint32_t>(InplaceUpdateTilingKey::TILING_KEY_DEFAULT)) {
        NsInplaceUpdate::Process<DTYPE_X>(x, indices, v, y, workspace, &tilingData);
    }
}
