...
ASCENDC_TPL_ARGS_DECL(IndexPutWithSortV2, ASCENDC_TPL_BOOL_DECL(ACCUMULATE, 0, 1),
                      ASCENDC_TPL_BOOL_DECL(ALL_INDEXED, 0, 1), ASCENDC_TPL_BOOL_DECL(INDEXED_BLOCK_MODE, 0, 1),
                      ASCENDC_TPL_BOOL_DECL(IS_CAST, 0, 1), ASCENDC_TPL_BOOL_DECL(KERNEL_SIMD, 0, 1));

ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(ACCUMULATE, 0, 1), ASCENDC_TPL_BOOL_SEL(ALL_INDEXED, 0, 1),
                                     ASCENDC_TPL_BOOL_SEL(INDEXED_BLOCK_MODE, 0, 1),
                                     ASCENDC_TPL_BOOL_SEL(IS_CAST, 0, 1), ASCENDC_TPL_BOOL_SEL(KERNEL_SIMD, 0),
                                     ASCENDC_TPL_TILING_STRUCT_SEL(IndexPutWithSortV2TilingData)),
                ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(ACCUMULATE, 0, 1), ASCENDC_TPL_BOOL_SEL(ALL_INDEXED, 0, 1),
                                     ASCENDC_TPL_BOOL_SEL(INDEXED_BLOCK_MODE, 0, 1),
                                     ASCENDC_TPL_BOOL_SEL(IS_CAST, 0, 1), ASCENDC_TPL_BOOL_SEL(KERNEL_SIMD, 1),
