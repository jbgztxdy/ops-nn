 ...
 * \brief ScatterMax kernel entry: var[indices[m]] = max(var[indices[m]], updates[m]) (in place).
 */
...
extern "C" __global__ __aicore__ void scatter_max(GM_ADDR var, GM_ADDR indices, GM_ADDR updates, GM_ADDR y,
                                                  GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    ScatterReduceSimt<DTYPE_VAR, DTYPE_INDICES, int64_t, MODE_MAX> op(tilingData, pipe);
