...
/*!
 * \file scatter_max_infershape.cpp
 * \brief ScatterMax infershape: output var has the same shape/dtype as input var (in-place).
 */
...
static ge::graphStatus InferShape4ScatterMax(gert::InferShapeContext* context)
{
...
static ge::graphStatus InferDataType4ScatterMax(gert::InferDataTypeContext* context)
{
