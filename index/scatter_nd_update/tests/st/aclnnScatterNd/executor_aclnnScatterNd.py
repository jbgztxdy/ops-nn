...
@register("onnx_scatter_nd")
class OnnxScatterND(BaseApi):

    def __init__(self, task_result: TaskResult):
        super(OnnxScatterND, self).__init__(task_result)
    ...
    def __call__(self, input_data: InputDataset, with_output: bool = False):
        ...
        out = tf.tensor_scatter_nd_update(tensor=data, indices=indices, updates=updates).numpy()
