...
#include "../../../op_api/aclnn_max_unpool3d_backward.h"
...
protected:
    static void SetUpTestCase() { std::cout << "l2_max_unpool3d_backward_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "l2_max_unpool3d_backward_test TearDown" << std::endl; }
};
...
TEST_F(l2_max_unpool3d_backward_test, case_gradOutput_nullptr)
{
    ...
    auto ut = OP_API_UT(aclnnMaxUnpool3dBackward, INPUT(nullptr, self_desc, indices_desc, output_szie, stride, padding),
                        OUTPUT(out_desc));
...
TEST_F(l2_max_unpool3d_backward_test, case_self_nullptr)
{
    ...
    auto ut = OP_API_UT(aclnnMaxUnpool3dBackward,
                        INPUT(gradOutput_desc, nullptr, indices_desc, output_szie, stride, padding), OUTPUT(out_desc));
    uint64_t workspace_size = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);
}
...
TEST_F(l2_max_unpool3d_backward_test, case_indices_nullptr)
{
    ...
    auto ut = OP_API_UT(aclnnMaxUnpool3dBackward,
                        INPUT(gradOutput_desc, self_desc, nullptr, output_szie, stride, padding), OUTPUT(out_desc));
    uint64_t workspace_size = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);
}
...
TEST_F(l2_max_unpool3d_backward_test, case_out_nullptr)
{
    ...
    auto ut = OP_API_UT(aclnnMaxUnpool3dBackward,
                        INPUT(gradOutput_desc, self_desc, indices_desc, output_szie, stride, padding), OUTPUT(nullptr));
    uint64_t workspace_size = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);
}
...
TEST_F(l2_max_unpool3d_backward_test, case_bfloat16)
{
    ...
    auto ut = OP_API_UT(aclnnMaxUnpool3dBackward,
                        INPUT(gradOutput_desc, self_desc, indices_desc, output_szie, stride, padding),
                        OUTPUT(out_desc));
