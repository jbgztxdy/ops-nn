...
#include "level2/aclnn_nonzero_v2.h"
...
// 正常场景_INT64
TEST_F(l2_nonzero_v2_test, case_004_INT64) {
...
// 正常场景_INT32
TEST_F(l2_nonzero_v2_test, case_005_INT32) {
...
// 正常场景_INT16
TEST_F(l2_nonzero_v2_test, case_006_INT16) {
...
// 正常场景_DOUBLE
TEST_F(l2_nonzero_v2_test, case_012_DOUBLE) {
...
// 正常场景_UINT16
TEST_F(l2_nonzero_v2_test, case_013_UINT16) {
  auto self_tensor_desc = TensorDesc({3, 5}, ACL_UINT16, ACL_FORMAT_ND);
  auto out_tensor_desc = TensorDesc({2, 15}, ACL_INT64, ACL_FORMAT_ND);
...
// 正常场景_UINT32
TEST_F(l2_nonzero_v2_test, case_014_UINT32) {
  auto self_tensor_desc = TensorDesc({3, 5}, ACL_UINT32, ACL_FORMAT_ND);
  auto out_tensor_desc = TensorDesc({2, 15}, ACL_INT64, ACL_FORMAT_ND);
...
// 正常场景_UINT64
TEST_F(l2_nonzero_v2_test, case_015_UINT64) {
  auto self_tensor_desc = TensorDesc({10, 5}, ACL_UINT64, ACL_FORMAT_ND);
...
TEST_F(l2_nonzero_v2_test, Ascend910B_case_ScalarTensor) {
  auto self_tensor_desc = TensorDesc({}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(1, 10);
  auto out_tensor_desc = TensorDesc({}, ACL_INT64, ACL_FORMAT_ND).ValueRange(1, 10);
