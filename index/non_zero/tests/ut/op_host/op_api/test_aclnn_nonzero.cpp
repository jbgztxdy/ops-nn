...
#include "level2/aclnn_nonzero.h"
...
TEST_F(l2_nonzero_test, aclnnNonzero_04_float64_ndhwc) {
  auto selfDesc = TensorDesc({2, 3}, ACL_DOUBLE, ACL_FORMAT_NDHWC);
  auto outDesc = TensorDesc({6, 2}, ACL_INT64, ACL_FORMAT_NDHWC).Precision(0.0001, 0.0001);
...
TEST_F(l2_nonzero_test, aclnnNonzero_05_int32_ncdhw) {
  auto selfDesc = TensorDesc({2, 3}, ACL_INT32, ACL_FORMAT_NCDHW);
  auto outDesc = TensorDesc({6, 2}, ACL_INT64, ACL_FORMAT_NCDHW).Precision(0.0001, 0.0001);
...
TEST_F(l2_nonzero_test, aclnnNonzero_06_int64_hwcn) {
  auto selfDesc = TensorDesc({2, 3}, ACL_INT64, ACL_FORMAT_HWCN);
...
TEST_F(l2_nonzero_test, aclnnNonzero_07_int16_hwcn) {
  auto selfDesc = TensorDesc({2, 3}, ACL_INT16, ACL_FORMAT_HWCN);
  auto outDesc = TensorDesc({6, 2}, ACL_INT64, ACL_FORMAT_HWCN).Precision(0.0001, 0.0001);
...
TEST_F(l2_nonzero_test, aclnnNonzero_17_910_bf16) {
  auto selfDesc = TensorDesc({2, 3}, ACL_BF16, ACL_FORMAT_NCHW);
  auto outDesc = TensorDesc({6, 2}, ACL_INT64, ACL_FORMAT_NCHW).Precision(0.001, 0.001);
