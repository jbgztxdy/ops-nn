...
protected:
    static void SetUpTestCase() { std::cout << "nonzero_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "nonzero_test TearDown" << std::endl; }
};
...
{
    auto tensorDesc9 = TensorDesc(
                           {
                               2147484638,
                           },
                           ACL_INT32, ACL_FORMAT_ND)
                           .ValueRange(-2, 2);
    auto outDesc = TensorDesc(
        {
            2147483638,
        },
