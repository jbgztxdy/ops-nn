...
namespace ge {
/**
* @brief Perform topk-topp-sample sampling calculations based on input word frequency logits, top-k/top-p sampling
...
* @li q: An optional tensor in [batch, voc_size], Defaults to "None". A Required tensor in [batch, ] on default. Acts as
