...
/* !
 * \file scatter_nd_max_tiling_key.h
 * \brief
 */
#ifndef SCATTER_ND_MAX_TILING_KEY_H_
#define SCATTER_ND_MAX_TILING_KEY_H_
...
ASCENDC_TPL_ARGS_DECL(
    ScatterNdMax,
    ASCENDC_TPL_UINT_DECL(TEMPLATE_MODE, 2, ASCENDC_TPL_UI_LIST, TPL_MODE_TEMPLATE_SIMD_SORT, TPL_MODE_TEMPLATE_SIMT),
    ASCENDC_TPL_UINT_DECL(CAST_MODE, 3, ASCENDC_TPL_UI_LIST, CAST_0, CAST_1, CAST_2, CAST_3, CAST_4, CAST_5),
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(CAST_MODE, ASCENDC_TPL_UI_LIST, CAST_0, CAST_1, CAST_2, CAST_3, CAST_4, CAST_5),
...
#endif // SCATTER_ND_MAX_TILING_KEY_H_