...
// 调用aclnn_scatter接口时，部分场景下可能会使用到算子scatter_add_with_sorted与linear_index加速计算，所以运行scatter_elements_v2的example时，需要编译并安装scatter_elements_v2，scatter_add_with_sorted与linear_index三个算子。
