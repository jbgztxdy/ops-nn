...
#define BATCH_TILING_SPLIT_REPEATS_SHAPE 201
    ...
    GM_ADDR x, GM_ADDR repeats, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    if (TILING_KEY_IS(BATCH_TILING_SPLIT_REPEATS_SHAPE)) {
        ...
        RepeatInterleaveSmall<DTYPE_X, DTYPE_REPEATS> op(pipe, tilingInfo);
