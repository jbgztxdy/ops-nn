...
{
    test_run(
        {3, 4, 5}, ACL_UINT8, ACL_FORMAT_ND, {-10, 10}, {4}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 8, {3, 8, 5},
...
{
    test_run(
        {3, 4, 5}, ACL_INT8, ACL_FORMAT_ND, {-10, 10}, {4}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 8, {3, 8, 5}, ACL_INT8,
        ACL_FORMAT_ND);
}
...
{
    test_run(
        {3, 4, 5}, ACL_INT16, ACL_FORMAT_ND, {-10, 10}, {4}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 8, {3, 8, 5},
...
{
    test_run(
        {3, 4, 5}, ACL_INT32, ACL_FORMAT_ND, {-10, 10}, {4}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 8, {3, 8, 5},
...
{
    test_run(
        {3, 4, 5}, ACL_INT64, ACL_FORMAT_ND, {-10, 10}, {4}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 8, {3, 8, 5},
...
{
    test_run(
        {3, 4, 5}, ACL_BOOL, ACL_FORMAT_ND, {-10, 10}, {4}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 8, {3, 8, 5}, ACL_BOOL,
        ACL_FORMAT_ND);
}
...
{
    test_run(
        {3, 4, 5}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {4}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 8, {3, 8, 5},
...
{
    test_run(
        {3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND, {-10, 10}, {4}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 8, {3, 8, 5},
...
{
    test_run_invalid(
        {2, 3, 3}, ACL_DOUBLE, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 6, {2, 6, 3},
        ACL_DOUBLE, ACL_FORMAT_ND);
    test_run_invalid(
        {2, 3, 3}, ACL_COMPLEX64, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 6, {2, 6, 3},
        ACL_COMPLEX64, ACL_FORMAT_ND);
    test_run_invalid(
        {2, 3, 3}, ACL_COMPLEX128, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 6, {2, 6, 3},
        ACL_COMPLEX128, ACL_FORMAT_ND);
}
...
{
    test_run(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 6, {2, 6, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
    test_run(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_INT32, ACL_FORMAT_ND, {2, 2}, 1, 6, {2, 6, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
    test_run_invalid(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_INT16, ACL_FORMAT_ND, {2, 2}, 1, 6, {2, 6, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
}
...
TEST_F(l2_repeat_interleave_dim_test, l2_repeat_interleave_dim_test_14)
{
    test_run(
        ...
        ACL_FLOAT16, ACL_FORMAT_ND);
    test_run(
        {2, 2, 1, 2}, ACL_FLOAT16, ACL_FORMAT_NCHW, {-10, 10}, {2}, ACL_INT64, ACL_FORMAT_NCHW, {2, 2}, 1, 4,
        {2, 4, 1, 2}, ACL_FLOAT16, ACL_FORMAT_NCHW);
    test_run(
        {2, 2, 1, 2}, ACL_FLOAT16, ACL_FORMAT_NHWC, {-10, 10}, {2}, ACL_INT64, ACL_FORMAT_NHWC, {2, 2}, 1, 4,
        {2, 4, 1, 2}, ACL_FLOAT16, ACL_FORMAT_NHWC);
    test_run(
        {2, 2, 1, 2}, ACL_FLOAT16, ACL_FORMAT_HWCN, {-10, 10}, {2}, ACL_INT64, ACL_FORMAT_HWCN, {2, 2}, 1, 4,
        {2, 4, 1, 2}, ACL_FLOAT16, ACL_FORMAT_HWCN);
    test_run(
        {2, 1, 1, 2, 2}, ACL_FLOAT16, ACL_FORMAT_NDHWC, {-10, 10}, {1}, ACL_INT64, ACL_FORMAT_NDHWC, {2, 2}, 1, 2,
        {2, 2, 1, 2, 2}, ACL_FLOAT16, ACL_FORMAT_NDHWC);
    test_run(
        {2, 1, 1, 2, 2}, ACL_FLOAT16, ACL_FORMAT_NCDHW, {-10, 10}, {1}, ACL_INT64, ACL_FORMAT_NCDHW, {2, 2}, 1, 2,
...
TEST_F(l2_repeat_interleave_dim_test, l2_repeat_interleave_dim_test_15)
{
    // self + repeats empty
    test_run(
        {2, 0, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {0}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 4, {2, 0, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
    // self empty, repeats not emtpy
    test_run(
        {2, 0, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {2}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 0, 4, {4, 0, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);

    // self not empty, repeats empty
    test_run_invalid(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {0}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 0, 4, {0, 3, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
}
...
TEST_F(l2_repeat_interleave_dim_test, l2_repeat_interleave_dim_test_17)
{
    ...
    test_run(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {1}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 6, {2, 6, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
    ...
    test_run_invalid(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {1, 4}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 6, {2, 6, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
    // repeats为1D tensor, 但size不为1或者元素数
    // 不为1
    test_run_invalid(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {2}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 6, {2, 6, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
    // 不为元素数： 元素数+1
    test_run_invalid(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {4}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 6, {2, 6, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
}
...
TEST_F(l2_repeat_interleave_dim_test, l2_repeat_interleave_dim_test_18)
{
    ...
    test_run_invalid(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 36, {35},
        ACL_FLOAT16, ACL_FORMAT_ND);
}
...
TEST_F(l2_repeat_interleave_dim_test, l2_repeat_interleave_dim_test_19)
{
    ...
    // 1维
    test_run(
        {5}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {5}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 0, 10, {10}, ACL_FLOAT16,
        ACL_FORMAT_ND);
    // 8维
    test_run(
        {1, 2, 1, 2, 1, 1, 1, 2}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {2}, ACL_INT64, ACL_FORMAT_ND, {3, 3}, 1, 6,
        {1, 6, 1, 2, 1, 1, 1, 2}, ACL_FLOAT16, ACL_FORMAT_ND);
    // 9维
    test_run_invalid(
        {1, 2, 1, 2, 1, 1, 1, 2, 1}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {2}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 1, 4,
...
TEST_F(l2_repeat_interleave_dim_test, l2_repeat_interleave_dim_test_20)
{
    // dim为 -N
    test_run(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {2}, ACL_INT64, ACL_FORMAT_ND, {3, 3}, -3, 6, {6, 3, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
    // dim为 0
    test_run(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {2}, ACL_INT64, ACL_FORMAT_ND, {3, 3}, 0, 6, {6, 3, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
    // dim为 N - 1
    test_run(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 2, 6, {2, 3, 6},
        ACL_FLOAT16, ACL_FORMAT_ND);

    // dim为 -N - 1
    test_run_invalid(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, -4, 12, {2, 6, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
    // dim为 N
    test_run_invalid(
        {2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_INT64, ACL_FORMAT_ND, {2, 2}, 3, 6, {2, 6, 3},
        ACL_FLOAT16, ACL_FORMAT_ND);
}
