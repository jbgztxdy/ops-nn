...
{
    test_run({2, 3, 3}, ACL_UINT8, ACL_FORMAT_ND, {-10, 10}, 2, 1, 6, {2, 6, 3}, ACL_UINT8, ACL_FORMAT_ND);
}

// self + out: int8
TEST_F(l2_repeat_interleave_dim_int_test, l2_repeat_interleave_dim_int_test_02)
{
    test_run({2, 3, 3}, ACL_INT8, ACL_FORMAT_ND, {-10, 10}, 2, 1, 6, {2, 6, 3}, ACL_INT8, ACL_FORMAT_ND);
}

// self + out: int16
TEST_F(l2_repeat_interleave_dim_int_test, l2_repeat_interleave_dim_int_test_03)
{
    test_run({2, 3, 3}, ACL_INT16, ACL_FORMAT_ND, {-10, 10}, 2, 1, 6, {2, 6, 3}, ACL_INT16, ACL_FORMAT_ND);
}

// self + out: int32
TEST_F(l2_repeat_interleave_dim_int_test, l2_repeat_interleave_dim_int_test_04)
{
    test_run({2, 3, 3}, ACL_INT32, ACL_FORMAT_ND, {-10, 10}, 2, 1, 6, {2, 6, 3}, ACL_INT32, ACL_FORMAT_ND);
}

// self + out: int64
TEST_F(l2_repeat_interleave_dim_int_test, l2_repeat_interleave_dim_int_test_05)
{
    test_run({2, 3, 3}, ACL_INT64, ACL_FORMAT_ND, {-10, 10}, 2, 1, 6, {2, 6, 3}, ACL_INT64, ACL_FORMAT_ND);
}

// self + out: bool
TEST_F(l2_repeat_interleave_dim_int_test, l2_repeat_interleave_dim_int_test_06)
{
    test_run({2, 3, 3}, ACL_BOOL, ACL_FORMAT_ND, {-10, 10}, 2, 1, 6, {2, 6, 3}, ACL_BOOL, ACL_FORMAT_ND);
}
...
{
    test_run({2, 3, 3}, ACL_FLOAT, ACL_FORMAT_ND, {-10, 10}, 2, 1, 6, {2, 6, 3}, ACL_FLOAT, ACL_FORMAT_ND);
}
...
{
    test_run({2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, 2, 1, 6, {2, 6, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    test_run_invalid({2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, 2, 1, 6, {2, 6, 3}, ACL_FLOAT, ACL_FORMAT_ND);
}
...
{
    // self empty
    test_run({2, 3, 0}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, 2, 1, 0, {2, 6, 0}, ACL_FLOAT16, ACL_FORMAT_ND);
}
...
{
    // repeats为0
    test_run({2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, 0, 1, 0, {2, 0, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    // repeats为5
    test_run({2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, 5, 1, 15, {2, 15, 3}, ACL_FLOAT16, ACL_FORMAT_ND);

    // repeats为负数
    test_run_invalid({2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, -2, 1, 6, {2, 6, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
}
...
TEST_F(l2_repeat_interleave_dim_int_test, l2_repeat_interleave_dim_int_test_17)
{
    ...
    test_run_invalid({2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, 2, 1, 36, {2, 5, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
}
...
{
    // dim为 -N
    test_run({2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, 2, -3, 4, {4, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    // dim为 0
    test_run({2, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, 2, 0, 4, {4, 3, 3}, ACL_FLOAT16, ACL_FORMAT_ND);
    // dim为 N - 1
