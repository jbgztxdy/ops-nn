...
/*!
 * \file test_repeat_interleave_infershape.cpp
 * \brief
 */

#include <iostream>
#include <gtest/gtest.h>
#include "../../../op_graph/repeat_interleave_proto.h"
...
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("RepeatInterleave")->infer_shape;
