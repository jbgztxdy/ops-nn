...
protected:
    static void SetUpTestCase() { cout << "embedding_test SetUp" << endl; }
...
TEST_F(l2_embedding_test, case_15)
{
    auto tensorWeightDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto
        tensorIndicesDesc = TensorDesc({4}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 5).Value(vector<int>{1, 2, 3, 4});
    auto tensorOutDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
{
    auto tensorWeightDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4, 4, 4, 4, 4, 4, 4, 4, 4}, ACL_INT32, ACL_FORMAT_ND)
                                 .ValueRange(0, 5)
                                 .Value(vector<int>{1, 2, 3, 4});
    auto tensorOutDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
{
    auto tensorWeightDesc = TensorDesc({2, 4}, ACL_FLOAT, ACL_FORMAT_ND, {1, 2}, 0, {4, 2})
