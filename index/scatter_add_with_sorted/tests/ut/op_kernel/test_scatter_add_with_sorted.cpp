...
TEST_F(scatter_add_with_sorted_test, test_case_fp32)
{
    ...
    system(
        "cp -r "
        "../../../../../../../ops/built-in/tests/ut/fast_op_test/scatter_add_with_sorted/scatter_add_with_sorted_data "
        "./");
...
TEST_F(scatter_add_with_sorted_test, test_case_fp16)
{
    // inputs
    size_t var_size = 65 * 4096 * sizeof(half);
    size_t src_size = 63 * 4096 * sizeof(half);
    size_t ind_size = 63 * sizeof(int);
    size_t pos_size = 63 * sizeof(int);
    size_t output_size = 65 * 4096 * sizeof(half);
    size_t tiling_data_size = sizeof(ScatterAddWithSortedTilingDataDef);
    ...
    system("chmod -R 755 ./scatter_add_with_sorted_data/");
    system("cd ./scatter_add_with_sorted_data/ && rm -rf ./*bin");
    system("cd ./scatter_add_with_sorted_data/ && python3 gen_data.py float16");
    system("cd ./scatter_add_with_sorted_data/ && python3 gen_tiling.py");
...
TEST_F(scatter_add_with_sorted_test, test_case_int32)
{
    // inputs
    size_t var_size = 65 * 4096 * sizeof(int);
    size_t src_size = 63 * 4096 * sizeof(int);
    size_t ind_size = 63 * sizeof(int);
    size_t pos_size = 63 * sizeof(int);
    size_t output_size = 65 * 4096 * sizeof(int);
    size_t tiling_data_size = sizeof(ScatterAddWithSortedTilingDataDef);
    ...
    system("chmod -R 755 ./scatter_add_with_sorted_data/");
    system("cd ./scatter_add_with_sorted_data/ && rm -rf ./*bin");
    system("cd ./scatter_add_with_sorted_data/ && python3 gen_data.py int32");
    system("cd ./scatter_add_with_sorted_data/ && python3 gen_tiling.py");
...
TEST_F(scatter_add_with_sorted_test, test_case_uint8)
{
    // inputs
    size_t var_size = 65 * 4096 * sizeof(uint8_t);
    size_t src_size = 63 * 4096 * sizeof(uint8_t);
    size_t ind_size = 63 * sizeof(int);
    size_t pos_size = 63 * sizeof(int);
    size_t output_size = 65 * 4096 * sizeof(uint8_t);
    size_t tiling_data_size = sizeof(ScatterAddWithSortedTilingDataDef);
    ...
    system("chmod -R 755 ./scatter_add_with_sorted_data/");
    system("cd ./scatter_add_with_sorted_data/ && rm -rf ./*bin");
    system("cd ./scatter_add_with_sorted_data/ && python3 gen_data.py uint8");
    system("cd ./scatter_add_with_sorted_data/ && python3 gen_tiling.py");
...
TEST_F(scatter_add_with_sorted_test, test_case_int8)
{
    // inputs
    size_t var_size = 65 * 4096 * sizeof(int8_t);
    size_t src_size = 63 * 4096 * sizeof(int8_t);
    size_t ind_size = 63 * sizeof(int);
    size_t pos_size = 63 * sizeof(int);
    size_t output_size = 65 * 4096 * sizeof(int8_t);
    size_t tiling_data_size = sizeof(ScatterAddWithSortedTilingDataDef);
    ...
    system("chmod -R 755 ./scatter_add_with_sorted_data/");
    system("cd ./scatter_add_with_sorted_data/ && rm -rf ./*bin");
    system("cd ./scatter_add_with_sorted_data/ && python3 gen_data.py int8");
    system("cd ./scatter_add_with_sorted_data/ && python3 gen_tiling.py");
...
TEST_F(scatter_add_with_sorted_test, test_case_bf16)
{
    // inputs
    size_t var_size = 65 * 4096 * sizeof(half);
    size_t src_size = 63 * 4096 * sizeof(half);
    ...
    system("chmod -R 755 ./scatter_add_with_sorted_data/");
    system("cd ./scatter_add_with_sorted_data/ && rm -rf ./*bin");
    system("cd ./scatter_add_with_sorted_data/ && python3 gen_data.py bfloat16");
    system("cd ./scatter_add_with_sorted_data/ && python3 gen_tiling.py");
