...
#ifndef SCATTER_ADD_WITH_SORTED_TILING_DEF_H
#define SCATTER_ADD_WITH_SORTED_TILING_DEF_H

#include "kernel_tiling/kernel_tiling.h"

struct ScatterAddWithSortedTilingData {
...
#define GET_TILING_DATA_WITH_STRUCT(tilingStruct, tilingData, tilingArg) \
    ...
    INIT_TILING_DATA(tilingStruct, tilingData##_ptr, tilingArg);

#endif // SCATTER_ADD_WITH_SORTED_TILING_DEF_H
