    ...
    __gm__ T* sumWorkspace, __gm__ U* indexWorkspace)
{
    ...
    for (ADDR_T i = updatesBlockOffset + threadIdx.x; i < updatesBlockEnd; i += blockDim.x) {
        ...
        if constexpr (!isStartRowCore) {
            if (isCoreFirstIndices &&
                varRow == sortedIndices[startIndices - 1]) { // 判断头索引与前一个核的尾索引是否相同
                flag1 = 1;
            }
        }
...
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_NUM_DETERM) inline void ScatterAddWithSortedSimtDetermStep2(
    ...
    __gm__ T* sumWorkspace, __gm__ U* indexWorkspace)
{
    if (indexWorkspace[blockIdx * TWO + 1] ==
        indexWorkspace[blockIdx * TWO]) { // 当前核对应的2个workspace索引相等则跳过
        return;
    }
...
template <typename T, typename U, typename ADDR_T, bool withPos>
__aicore__ inline void ScatterAddWithSortedDetermSIMT<T, U, ADDR_T, withPos>::Init(GM_ADDR var, GM_ADDR updates,
                                                                                   GM_ADDR indices, GM_ADDR pos,
                                                                                   GM_ADDR workspace)
{
...
__aicore__ inline void ScatterAddWithSortedDetermSIMT<T, U, ADDR_T, withPos>::ProcessSimtStep1()
{
    ...
    if (isStartRowCore_ && isEndRowCore_) {
        asc_vf_call<ScatterAddWithSortedSimtDetermStep1<T, U, ADDR_T, true, true, withPos>>(
            dim3(THREAD_NUM_DETERM), totalCol, indicesBlockOffset, indicesBlockNum, varFirstDimSize, magic, shift,
            blockIdx, (__gm__ T*)(varGm_.GetPhyAddr()), (__gm__ U*)(indicesGm_.GetPhyAddr()),
        ...
        asc_vf_call<ScatterAddWithSortedSimtDetermStep1<T, U, ADDR_T, true, false, withPos>>(
            dim3(THREAD_NUM_DETERM), totalCol, indicesBlockOffset, indicesBlockNum, varFirstDimSize, magic, shift,
            blockIdx, (__gm__ T*)(varGm_.GetPhyAddr()), (__gm__ U*)(indicesGm_.GetPhyAddr()),
            (__gm__ U*)(posGm_.GetPhyAddr()), (__gm__ T*)(updatesGm_.GetPhyAddr()),
            (__gm__ T*)(sumWorkspace_.GetPhyAddr()), (__gm__ U*)(indexWorkspace_.GetPhyAddr()));
    } else if (!isStartRowCore_ && isEndRowCore_) {
        asc_vf_call<ScatterAddWithSortedSimtDetermStep1<T, U, ADDR_T, false, true, withPos>>(
            dim3(THREAD_NUM_DETERM), totalCol, indicesBlockOffset, indicesBlockNum, varFirstDimSize, magic, shift,
            blockIdx, (__gm__ T*)(varGm_.GetPhyAddr()), (__gm__ U*)(indicesGm_.GetPhyAddr()),
            (__gm__ U*)(posGm_.GetPhyAddr()), (__gm__ T*)(updatesGm_.GetPhyAddr()),
            (__gm__ T*)(sumWorkspace_.GetPhyAddr()), (__gm__ U*)(indexWorkspace_.GetPhyAddr()));
    } else {
        asc_vf_call<ScatterAddWithSortedSimtDetermStep1<T, U, ADDR_T, false, false, withPos>>(
            dim3(THREAD_NUM_DETERM), totalCol, indicesBlockOffset, indicesBlockNum, varFirstDimSize, magic, shift,
            blockIdx, (__gm__ T*)(varGm_.GetPhyAddr()), (__gm__ U*)(indicesGm_.GetPhyAddr()),
            (__gm__ U*)(posGm_.GetPhyAddr()), (__gm__ T*)(updatesGm_.GetPhyAddr()),
            (__gm__ T*)(sumWorkspace_.GetPhyAddr()), (__gm__ U*)(indexWorkspace_.GetPhyAddr()));
...
__aicore__ inline void ScatterAddWithSortedDetermSIMT<T, U, ADDR_T, withPos>::ProcessSimtStep2()
{
    ...
    asc_vf_call<ScatterAddWithSortedSimtDetermStep2<T, U, ADDR_T>>(
        dim3(totalCol), totalCol, blockIdx, sumWorkspaceEnd, magic, shift, (__gm__ T*)(varGm_.GetPhyAddr()),
        (__gm__ T*)(sumWorkspace_.GetPhyAddr()), (__gm__ U*)(indexWorkspace_.GetPhyAddr()));
}
