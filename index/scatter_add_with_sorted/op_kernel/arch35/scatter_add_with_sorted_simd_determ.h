...
public:
    ...
    __aicore__ inline void CopyOutToWorkspace(LocalTensor<T>& dataLocal, int32_t burstLen, int64_t colOffset,
    ...
    __aicore__ inline void ComputeSumAndCopyOut(LocalTensor<T>& yLocal, int32_t curLoopRows, int32_t curLoopCols,
                                                int32_t curLoopColsAlign, int64_t colOffset, U& curId, int64_t row,
...
template <typename T, typename U, bool withPos>
__aicore__ inline void ScatterAddWithSortedSimdDterm<T, U, withPos>::CopyIn(LocalTensor<T> dstLocal,
...
template <typename T, typename U, bool withPos>
__aicore__ inline void ScatterAddWithSortedSimdDterm<T, U, withPos>::CopyInIndices(LocalTensor<U> dstLocal,
                                                                                   GlobalTensor<U> srcGm,
                                                                                   uint64_t offset, uint32_t nBurst,
                                                                                   uint32_t copyLen, uint32_t srcStride,
                                                                                   uint32_t dstStride)
{
...
template <typename T, typename U, bool withPos>
__aicore__ inline void ScatterAddWithSortedSimdDterm<T, U, withPos>::CopyOut(GlobalTensor<T> dstGm,
...
template <typename T, typename U, bool withPos>
__aicore__ inline void ScatterAddWithSortedSimdDterm<T, U, withPos>::CopyOutToWorkspace(LocalTensor<T>& dataLocal,
                                                                                        int32_t burstLen,
                                                                                        int64_t colOffset,
                                                                                        int32_t writePosition)
{
