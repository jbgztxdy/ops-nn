...
/* !
 * \file inplace_index_add_simd_tiling.cpp
 * \brief
 */
...
bool InplaceIndexAddSimdTiling::IsCapable()
{
    if (isSimdNoSort_ == 1) {
        return true;
    }
...
int64_t InplaceIndexAddSimdTiling::GetIndicesAlignBlockSize(int64_t indicesFactor)
{
...
void InplaceIndexAddSimdTiling::DoOpTilingSplitPre()
{
...
void InplaceIndexAddSimdTiling::DoOpTilingSplitIndices()
{
...
void InplaceIndexAddSimdTiling::DoOpTilingSplitAfter()
{
    int64_t halfUbSize = (ubSize_ - RESERVE_SIZE) / SIMD_DB_BUFFER;
    int64_t alignNum = ALIGN_SIZE / varTypeSize_;
...
ge::graphStatus InplaceIndexAddSimdTiling::DoOpTiling()
{
...
ge::graphStatus InplaceIndexAddSimdTiling::GetWorkspaceSize()
{
...
ge::graphStatus InplaceIndexAddSimdTiling::PostTiling()
{
...
void InplaceIndexAddSimdTiling::DumpTilingInfo()
{
...
void InplaceIndexAddSimdTiling::SetTilingData()
{
