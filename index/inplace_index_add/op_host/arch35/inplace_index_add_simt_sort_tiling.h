...
/* !
 * \file inplace_index_add_simt_sort_tiling.h
 * \brief
 */

#ifndef INPLACE_INDEX_ADD_SIMT_SORT_TILING_H_
#define INPLACE_INDEX_ADD_SIMT_SORT_TILING_H_

#include "inplace_index_add_tiling_arch35.h"

namespace optiling
{
BEGIN_TILING_DATA_DEF(InplaceIndexAddSimtSortTilingData)
...
REGISTER_TILING_DATA_CLASS(InplaceIndexAdd_500000, InplaceIndexAddSimtSortTilingData)
REGISTER_TILING_DATA_CLASS(InplaceIndexAdd_500001, InplaceIndexAddSimtSortTilingData)
REGISTER_TILING_DATA_CLASS(InplaceIndexAdd_500010, InplaceIndexAddSimtSortTilingData)
REGISTER_TILING_DATA_CLASS(InplaceIndexAdd_500011, InplaceIndexAddSimtSortTilingData)

class InplaceIndexAddSimtSortTiling : public InplaceIndexAddTiling
{
public:
    explicit InplaceIndexAddSimtSortTiling(gert::TilingContext* context) : InplaceIndexAddTiling(context)
    {}
    ~InplaceIndexAddSimtSortTiling() override = default;
...
protected:
    ...
    void SetTilingData();
    InplaceIndexAddSimtSortTilingData tilingData_;
};
}  // namespace optiling
