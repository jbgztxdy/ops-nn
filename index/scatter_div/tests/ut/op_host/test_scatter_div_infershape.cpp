...
class scatter_div : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "scatter_div SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "scatter_div TearDown" << std::endl; }
};

TEST_F(scatter_div, scatter_div_infershape_static)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("ScatterDiv")->infer_shape;
...
TEST_F(scatter_div, scatter_div_infershape_dynamic)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("ScatterDiv")->infer_shape;
...
TEST_F(scatter_div, scatter_div_infer_datatype)
{
    auto opImpl = gert::OpImplRegistry::GetInstance().GetOpImpl("ScatterDiv");
