...
static const std::initializer_list<op::DataType> AICORE_DTYPE_SUPPORT_LIST_SELF = {
    op::DataType::DT_BF16,   op::DataType::DT_FLOAT16, op::DataType::DT_FLOAT,  op::DataType::DT_INT8,
...
static bool IsAiCoreSupport(const aclTensor* self, const aclTensor* indices)
{
                           ...
                           aclTensor* gatherV3Out, int batchDims, bool negativeIndexSupport, aclOpExecutor* executor)
{
    ...
    ADD_TO_LAUNCHER_LIST_AICORE(GatherV3, OP_INPUT(self, indices, axis), OP_OUTPUT(gatherV3Out),
