...
static const std::initializer_list<op::DataType> AICORE_DTYPE_SUPPORT_LIST_WITH_BF16 = {
    ...
    DataType::DT_BF16,  DataType::DT_INT16,       DataType::DT_UINT16,      DataType::DT_INT8,
    DataType::DT_UINT8, DataType::DT_BOOL,        DataType::DT_DOUBLE,      DataType::DT_COMPLEX64,
    DataType::DT_BF16,  DataType::DT_FLOAT8_E5M2, DataType::DT_FLOAT8_E8M0, DataType::DT_FLOAT8_E4M3FN};

static const std::initializer_list<op::DataType> AICORE_DTYPE_SUPPORT_LIST_INDICES = {op::DataType::DT_INT32,
                                                                                      op::DataType::DT_INT64};

static const std::initializer_list<op::DataType> AICORE_DTYPE_SUPPORT_LIST_AXIS = {op::DataType::DT_INT32,
                                                                                   op::DataType::DT_INT64};

static bool IsAiCoreSupport(const aclTensor* self, const aclTensor* indices, const aclTensor* axis)
{
                                ...
                                aclOpExecutor* executor)
{
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICORE(GatherV2, OP_INPUT(self, indices, axis), OP_OUTPUT(gatherV2Out),
                                           OP_ATTR(batchDims, negativeIndexSupport));
    OP_CHECK(ret == ACLNN_SUCCESS,
             OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "GatherV2AiCore ADD_TO_LAUNCHER_LIST_AICORE failed."), return nullptr);
    return gatherV2Out;
}
                                       ...
                                       int64_t implMode, aclOpExecutor* executor)
{
    ...
    auto retAicore = ADD_TO_LAUNCHER_LIST_AICORE(GatherV2, OP_INPUT(self, indices, axis), OP_OUTPUT(gatherV2Out),
                                                 OP_ATTR(batchDims, negativeIndexSupport),
                               ...
                               aclOpExecutor* executor)
{
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICPU(GatherV2, OP_ATTR_NAMES({"batch_dims", "negative_index_support"}),
                                          OP_INPUT(self, indices, axis), OP_OUTPUT(gatherV2Out),
                                          OP_ATTR(batchDims, negativeIndexSupport));
    OP_CHECK(ret == ACLNN_SUCCESS, OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "GatherV2AiCPU ADD_TO_LAUNCHER_LIST_AICPU failed."),
             return nullptr);
    return gatherV2Out;
}

const aclTensor* GatherV2WithImplMode(const aclTensor* self, int64_t axis, const aclTensor* indices, int64_t implMode,
                                      aclOpExecutor* executor, int batchDims, bool negativeIndexSupport)
{
