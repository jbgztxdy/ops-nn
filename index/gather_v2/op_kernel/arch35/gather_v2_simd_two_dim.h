...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR indices, GM_ADDR axis, GM_ADDR y,
                                const GatherV2TilingDataSimdTwoDim* tilingData);
...
template <typename INDICES_T>
__aicore__ inline void Gatherv2SimdTwoDim<INDICES_T>::Init(GM_ADDR x, GM_ADDR indices, GM_ADDR axis, GM_ADDR y,
                                                           const GatherV2TilingDataSimdTwoDim* tilingData)
{
