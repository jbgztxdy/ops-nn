...
template <typename INDICES_T>
__aicore__ inline void Gatherv2Simd<INDICES_T>::Init(GM_ADDR x, GM_ADDR indices, GM_ADDR axis, GM_ADDR y,
                                                     const GatherV2TilingData* tilingData)
{
...
template <typename INDICES_T>
template <typename T>
__aicore__ inline void Gatherv2Simd<INDICES_T>::CopyIn(LocalTensor<T> xLocal, GlobalTensor<T> xGm, int64_t offset,
