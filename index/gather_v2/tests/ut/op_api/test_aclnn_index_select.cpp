...
#include "../../../op_api/aclnn_index_select.h"
...
protected:
    static void SetUpTestCase() { cout << "index_select_test SetUp" << endl; }
...
TEST_F(l2IndexSelectTest, l2_index_select_test_nullptr)
{
    ...
    auto outputDesc = TensorDesc(outputDims, ACL_INT16, ACL_FORMAT_ND);
    auto ut = OP_API_UT(aclnnIndexSelect, INPUT(nullptr, dim, nullptr), OUTPUT(outputDesc));
