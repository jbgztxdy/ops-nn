...
TEST_F(l2_take_test, dtype_3_uint64)
{
    auto selfDesc = TensorDesc({1, 16, 1, 1}, ACL_UINT64, ACL_FORMAT_ND)
                        .Value(vector<uint64_t>{0, 10, 200, 3000, 40000, 501000, 6501000, 7650999, 87650999, 987650999,
                                                1088881111, 11088481111, 120188489958, 1301288489958, 14012388489958,
                                                150123488489958});
...
TEST_F(l2_take_test, dtype_4_int64)
{
    auto selfDesc = TensorDesc({1, 16, 1, 1}, ACL_INT64, ACL_FORMAT_ND)
                        .Value(vector<int64_t>{0, 10, 200, 3000, -40000, 501000, 6501000, -7650999, -87650999,
                                               -987650999, -1088881111, -11088481111, 120188489958, 1301288489958,
                                               14012388489958, -150123488489958});
...
TEST_F(l2_take_test, dtype_5_uint32)
{
    auto selfDesc = TensorDesc({1, 2, 4, 2}, ACL_UINT32, ACL_FORMAT_ND)
                        .Value(vector<uint32_t>{0, 10, 200, 3000, 40000, 501000, 6501000, 7650999, 87650999, 987650999,
                                                1088881111, 4188489958, 1201, 130121, 140123, 1501234});
...
TEST_F(l2_take_test, dtype_6_int32)
{
    auto selfDesc = TensorDesc({1, 4, 4, 1}, ACL_INT32, ACL_FORMAT_ND)
                        .Value(vector<int32_t>{0, 10, 200, 3000, 40000, 501000, -6501000, -7650999, 87650999, 987650999,
                                               -1088881111, 2088489958, -2088489958, -130121, 140123, -1501234});
...
TEST_F(l2_take_test, dtype_7_uint16)
{
    auto selfDesc = TensorDesc({1, 4, 4, 1}, ACL_UINT16, ACL_FORMAT_NCHW)
                        .Value(vector<uint16_t>{0, 10, 200, 3000, 40000, 50100, 65010, 7650, 8765, 9876, 10888, 11888,
                                                12884, 13012, 14012, 65535});
...
TEST_F(l2_take_test, dtype_8_int16)
{
    auto selfDesc = TensorDesc({1, 4, 4, 1}, ACL_INT16, ACL_FORMAT_NHWC)
                        .Value(vector<int16_t>{0, 10, 200, 3000, -4000, -5100, 6501, 7650, 8765, 9876, 10888, -11888,
                                               12884, 13012, -32768, 32767});
    auto indexDesc = TensorDesc(vector<int64_t>{2, 2, 2, 1}, ACL_INT64, ACL_FORMAT_NHWC)
                         .Value(vector<int64_t>{1, 14, 8, 15, 0, 1, 10, 7});
