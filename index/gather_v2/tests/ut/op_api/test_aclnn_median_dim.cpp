...
protected:
    static void SetUpTestCase() { cout << "l2_median_dim_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "l2_median_dim_test TearDown" << endl; }
};
...
TEST_F(l2_median_dim_test, aclnnMedianDim_3_9_2_complex64_nd_1_nd)
{
    ...
    auto ut = OP_API_UT(aclnnMedianDim, INPUT(self_tensor_desc, dim, keepdim),
