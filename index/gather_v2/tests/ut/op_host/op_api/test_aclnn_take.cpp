...
// dtype_11_double
TEST_F(l2_take_test, dtype_11_double)
{
    auto selfDesc = TensorDesc({1, 16, 1, 1}, ACL_DOUBLE, ACL_FORMAT_ND)
        .Value(vector<double>{0, 10, 200, 3000, 40000, 501000, 6501000, 7650999, 87650999, 987650999, 1088881111,
               11088481111, 120188489958, 1301288489958, 14012388489958, 150123488489958});
    auto indexDesc = TensorDesc(vector<int64_t>{3, 2}, ACL_INT64, ACL_FORMAT_ND)
        .Value(vector<int64_t>{0, 3, 11, 7, 10, 5});
    auto outDesc = TensorDesc({3, 2}, ACL_DOUBLE, ACL_FORMAT_ND);
...
// dtype_12_complex64
TEST_F(l2_take_test, dtype_12_complex64)
{
    auto selfDesc = TensorDesc({3, 2, 2}, ACL_COMPLEX64, ACL_FORMAT_ND)
        .Value(vector<float>{0, 10, 200, 3012, 40123, 501234, 6018848, 70128848, 801238848.123, 9012348848.998,
               10088489959.123, 110188489959.32});
    auto indexDesc = TensorDesc(vector<int64_t>{2, 2, 1}, ACL_INT64, ACL_FORMAT_NHWC)
        .Value(vector<int64_t>{1, 11, 8, 5});
    auto outDesc = TensorDesc({2, 2, 1}, ACL_COMPLEX64, ACL_FORMAT_ND);
...
// dtype_13_complex128
TEST_F(l2_take_test, dtype_13_complex128)
{
    auto selfDesc = TensorDesc({3, 2, 2}, ACL_COMPLEX128, ACL_FORMAT_ND)
        .Value(vector<float>{0, 10, 200, 3012, 40123, 501234, 60188489958.0, 70128848, 8388607.123, 9012348848.998,
               10088489959.123, 110188489959.32});
    auto indexDesc = TensorDesc(vector<int64_t>{2, 2, 1}, ACL_INT64, ACL_FORMAT_NHWC)
        .Value(vector<int64_t>{1, 11, 8, 5});
    auto outDesc = TensorDesc({2, 2, 1}, ACL_COMPLEX128, ACL_FORMAT_ND);
