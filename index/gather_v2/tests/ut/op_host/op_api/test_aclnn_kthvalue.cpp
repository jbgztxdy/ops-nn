...
// 正常路径，int32
TEST_F(l2_kthvalue_test, l2_kthvalue_test_int32) {
  auto selfDesc = TensorDesc({2, 4, 5}, ACL_INT32, ACL_FORMAT_ND);
  auto valDesc = TensorDesc({2, 1, 5}, ACL_INT32, ACL_FORMAT_ND);
  auto indDesc = TensorDesc({2, 1, 5}, ACL_INT64, ACL_FORMAT_ND);
...
// 正常路径，int64
TEST_F(l2_kthvalue_test, l2_kthvalue_test_int64) {
  auto selfDesc = TensorDesc({2, 4, 5}, ACL_INT64, ACL_FORMAT_ND);
  auto valDesc = TensorDesc({2, 1, 5}, ACL_INT64, ACL_FORMAT_ND);
  auto indDesc = TensorDesc({2, 1, 5}, ACL_INT64, ACL_FORMAT_ND);
...
// 用例不支持，bool
TEST_F(l2_kthvalue_test, l2_kthvalue_test_bool) {
...
// 用例不支持，bfloat16
TEST_F(l2_kthvalue_test, l2_kthvalue_test_bf16) {
...
// 正常路径，bfloat16
TEST_F(l2_kthvalue_test, Ascend910_9589_l2_kthvalue_test_bf16) {
  auto selfDesc = TensorDesc({2, 4, 5}, ACL_BF16, ACL_FORMAT_ND);
  auto valDesc = TensorDesc({2, 1, 5}, ACL_BF16, ACL_FORMAT_ND);
  auto indDesc = TensorDesc({2, 1, 5}, ACL_INT64, ACL_FORMAT_ND);
...
TEST_F(l2_kthvalue_test, Ascend910_9589_l2_kthvalue_test_int8) {
  auto selfDesc = TensorDesc({2, 2}, ACL_INT8, ACL_FORMAT_ND);
  auto valDesc = TensorDesc({2}, ACL_INT8, ACL_FORMAT_ND);
  auto indDesc = TensorDesc({2}, ACL_INT64, ACL_FORMAT_ND);

  auto ut = OP_API_UT(aclnnKthvalue, INPUT(selfDesc, 2, -1, 0), OUTPUT(valDesc, indDesc));
...
// 正常用例，keepdim=false
TEST_F(l2_kthvalue_test, l2_kthvalue_test_fp32_keepdim_false) {
  auto selfDesc = TensorDesc({2, 2, 2}, ACL_FLOAT, ACL_FORMAT_ND);
  auto valDesc = TensorDesc({2, 2}, ACL_FLOAT, ACL_FORMAT_ND);
  auto indDesc = TensorDesc({2, 2}, ACL_INT64, ACL_FORMAT_ND);

  auto ut = OP_API_UT(aclnnKthvalue, INPUT(selfDesc, 1, 2, 0), OUTPUT(valDesc, indDesc));
