...
// indices not support bfloat16
TEST_F(l2_embedding_test, case_18) {
  auto tensorWeightDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
  auto tensorIndicesDesc = TensorDesc({4}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 5).Value(vector<int>{1,2,3,4});
  auto tensorOutDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND);
