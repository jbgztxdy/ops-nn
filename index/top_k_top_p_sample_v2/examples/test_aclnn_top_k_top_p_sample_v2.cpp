...
/*!
 * \file test_aclnn_top_k_top_p_sample_v2.cpp
 * \brief
 */
#include <iostream>
#include <vector>
...
int main()
{
    ...
    ret = CreateAclTensor(logitsSortMaskedHostData, logitsShape, &logitsSortMaskedDeviceAddr, aclDataType::ACL_FLOAT,
                          &logitsSortMasked);
    CHECK_RET(ret == ACL_SUCCESS, return ret);
    ...
    ret = aclnnTopKTopPSampleV2GetWorkspaceSize(logits, topK, topP, q, minPs, eps, isNeedLogits, topKGuess, ks_max,
                                                inputIsLogits, isNeedSampleResult, logitsSelectedIdx, logitsTopKPSelect,
                                                logitsIdx, logitsSortMasked, &workspaceSize, &executor);
