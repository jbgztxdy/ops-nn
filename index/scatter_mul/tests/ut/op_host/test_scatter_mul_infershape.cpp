...
class scatter_mul : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "scatter_mul SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "scatter_mul TearDown" << std::endl; }
};

TEST_F(scatter_mul, scatter_mul_infershape_static)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("ScatterMul")->infer_shape;
...
TEST_F(scatter_mul, scatter_mul_infershape_dynamic)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("ScatterMul")->infer_shape;
...
TEST_F(scatter_mul, scatter_mul_infer_datatype)
{
    auto opImpl = gert::OpImplRegistry::GetInstance().GetOpImpl("ScatterMul");
