...
#ifndef SCATTERMUL_PROTO_H_
#define SCATTERMUL_PROTO_H_

#include "graph/operator_reg.h"

namespace ge {
/**
* @brief Multiplies a variable reference by sparse "updates". \n
...
* @li updates: The source tensor multiplied into "var". An ND tensor. Support 1D ~ 8D. The shape should be equal to the
