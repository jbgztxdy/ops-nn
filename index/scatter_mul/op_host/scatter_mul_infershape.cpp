...
/*!
 * \file scatter_mul_infershape.cpp
 * \brief ScatterMul infershape: output var has the same shape/dtype as input var (in-place).
 */
...
static ge::graphStatus InferShape4ScatterMul(gert::InferShapeContext* context)
{
...
static ge::graphStatus InferDataType4ScatterMul(gert::InferDataTypeContext* context)
{
