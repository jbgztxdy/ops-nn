...
#include "level2/aclnn_index_copy.h"
...
TEST_F(l2_inplace_index_copy_test, Ascend910_9598_aclnnInplaceIndexCopy_1_2_3_4_int8_nchw) {
  // self input
  const vector<int64_t>& selfShape = {1, 2, 3, 4};
...
TEST_F(l2_inplace_index_copy_test, Ascend910_9598_aclnnInplaceIndexCopy_1_2_3_4_uint8_nhwc) {
  // self input
  const vector<int64_t>& selfShape = {1, 2, 3, 4};
...
TEST_F(l2_inplace_index_copy_test, Ascend910_9598_aclnnInplaceIndexCopy_1_2_3_4_bool_nhwc) {
  // self input
  const vector<int64_t>& selfShape = {1, 2, 3, 4};
  aclDataType selfDtype = ACL_UINT8;
  aclFormat selfFormat = ACL_FORMAT_NHWC;
...
TEST_F(l2_inplace_index_copy_test, Ascend910_9598_aclnnInplaceIndexCopy_1_2_3_4_5_6_int8_nd) {
  // self input
  const vector<int64_t>& selfShape = {1, 2, 3, 4, 5, 6};
  aclDataType selfDtype = ACL_INT8;
  aclFormat selfFormat = ACL_FORMAT_ND;
  // index input
  const vector<int64_t>& indexShape = {6};
  aclDataType indexDtype = ACL_INT64;
  aclFormat indexFormat = ACL_FORMAT_ND;
  // source input
  const vector<int64_t>& sourceShape = selfShape;
  ...
  auto selfTensorDesc = TensorDesc(selfShape, selfDtype, selfFormat);
  auto indexTensorDesc = TensorDesc(indexShape, indexDtype, indexFormat).Value(vector<int32_t>{5, 4, 3, 2, 1, 0});
  auto sourceTensorDesc = TensorDesc(sourceShape, sourceDtype, sourceFormat);

  auto ut = OP_API_UT(aclnnInplaceIndexCopy, INPUT(selfTensorDesc, 5, indexTensorDesc, sourceTensorDesc), OUTPUT());
...
TEST_F(l2_inplace_index_copy_test, Ascend910_9598_aclnnInplaceIndexCopy_1_2_3_4_5_6_7_int16_nd) {
  // self input
  const vector<int64_t>& selfShape = {1, 2, 3, 4, 5, 6, 7};
  aclDataType selfDtype = ACL_INT8;
  aclFormat selfFormat = ACL_FORMAT_ND;
...
TEST_F(l2_inplace_index_copy_test, Ascend910_9598_aclnnInplaceIndexCopy_2_uint8_nd) {
  // self input
...
TEST_F(l2_inplace_index_copy_test, aclnnInplaceIndexCopy_4_4_complex64_nd) {
  // self input
  const vector<int64_t>& selfShape = {4, 4};
...
TEST_F(l2_inplace_index_copy_test, aclnnInplaceIndexCopy_2_complex128_nd) {
  // self input
  const vector<int64_t>& selfShape = {4, 4};
