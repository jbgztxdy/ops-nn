...
public:
    ...
    __aicore__ inline EmbeddingDenseGradV2SmallDimKernel(GM_ADDR grad, GM_ADDR indices, GM_ADDR backProps,
                                                         GM_ADDR workSpace,
...
private:
    ...
    __aicore__ inline void CopyIn(const uint32_t progress, bool formerFlag)
    {
        ...
        DataCopyExtParams gradCopyParams{static_cast<uint16_t>(copyRow),
                                         static_cast<uint32_t>(embeddingDim_ * sizeof(MT)), 0, 0, 0};
        DataCopyPadExtParams idxpadParams{true, 0, 0, 0};
        DataCopyPadExtParams gradPadParams{true, 0, static_cast<uint8_t>(embeddingDimAlign_ - embeddingDim_),
                                           (MT)(0.0f)};
    ...
    __aicore__ inline void ResetScaleCount() { scaleCount_ = 0; }
