...
protected:
    static void SetUpTestCase() { cout << "embedding_dense_backward_test SetUp" << endl; }
...
TEST_F(l2_embedding_dense_backward_test, case_3)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
...
TEST_F(l2_embedding_dense_backward_test, case_5)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_6)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_BF16, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_7)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_DOUBLE, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_8)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_INT32, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_9)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_INT64, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_10)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_INT16, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_11)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_INT8, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_12)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_UINT8, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_13)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_BOOL, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_14)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_COMPLEX64, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_15)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_COMPLEX128, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_16)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_17)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_18)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_19)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_DOUBLE, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_20)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT64, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_21)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT16, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_22)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_INT8, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_23)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_UINT8, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_24)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_BOOL, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_25)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_COMPLEX64, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_26)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4}, ACL_COMPLEX128, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_31)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({4, 3}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
...
TEST_F(l2_embedding_dense_backward_test, case_32)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto tensorIndicesDesc = TensorDesc({2}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_UNDEFINED);
...
TEST_F(l2_embedding_dense_backward_test, case_33)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3, 3, 3, 3}, ACL_FLOAT, ACL_FORMAT_NCDHW).ValueRange(0, 2);
    auto tensorIndicesDesc = TensorDesc({4, 3, 3, 3}, ACL_INT32, ACL_FORMAT_NCHW).ValueRange(0, 9);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_34)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3, 3, 3, 3}, ACL_FLOAT, ACL_FORMAT_NDHWC).ValueRange(0, 2);
    auto tensorIndicesDesc = TensorDesc({4, 3, 3, 3}, ACL_INT32, ACL_FORMAT_NHWC).ValueRange(0, 9);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_35)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3, 3, 3, 3}, ACL_FLOAT, ACL_FORMAT_NDHWC).ValueRange(0, 2);
    auto tensorIndicesDesc = TensorDesc({4, 3, 3, 3}, ACL_INT32, ACL_FORMAT_HWCN).ValueRange(0, 9);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_36)
{
    ...
    int64_t paddingIdx = 0;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({4, 3, 3, 3, 0}, ACL_FLOAT, ACL_FORMAT_NDHWC).ValueRange(0, 2);
    auto tensorIndicesDesc = TensorDesc({4, 3, 3, 3}, ACL_INT32, ACL_FORMAT_HWCN).ValueRange(0, 9);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, ascend910B2_case_40)
{
    ...
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({1, 3}, ACL_FLOAT, ACL_FORMAT_NDHWC).ValueRange(0, 2);
    auto tensorIndicesDesc = TensorDesc({1}, ACL_INT32, ACL_FORMAT_HWCN).ValueRange(0, 9);
    auto tensorOutDesc = TensorDesc({10, 3}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_embedding_dense_backward_test, case_44)
{
    ...
    int64_t paddingIdx = -1;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({0, 4096}, ACL_FLOAT, ACL_FORMAT_NDHWC).ValueRange(0, 2);
    auto tensorIndicesDesc = TensorDesc({0}, ACL_INT32, ACL_FORMAT_HWCN).ValueRange(0, 9);
...
TEST_F(l2_embedding_dense_backward_test, ascend950PR_9589_case)
{
    ...
    int64_t paddingIdx = -1;
    bool scaleGradByFreq = false;
    auto tensorGradDesc = TensorDesc({10, 5}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(1, 3);
    auto tensorIndicesDesc = TensorDesc({10}, ACL_INT32, ACL_FORMAT_ND).ValueRange(0, 5);
