...
protected:
    static void SetUpTestCase() { std::cout << "ScatterTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ScatterTiling TearDown" << std::endl; }
};
...
TEST_F(ScatterTiling, scatter_axis_2)
{
    ...
    auto kernel_holder = gert::KernelRunContextFaker()
                             .KernelIONum(2, 1)
                             .Inputs({const_cast<char*>(platform_info_string.c_str()),
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({{"reduction", ge::AnyValue::CreateFrom<string>(reduction)},
