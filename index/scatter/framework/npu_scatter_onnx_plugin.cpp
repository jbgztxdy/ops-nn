...
/*!
 * \file npu_scatter_onnx_plugin.cpp
 * \brief
 */
...
REGISTER_CUSTOM_OP("ArgMaxGrad")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("npu::1::NPUScatter"), ge::AscendString("ai.onnx::11::NPUScatter"),
                   ge::AscendString("ai.onnx::12::NPUScatter"), ge::AscendString("ai.onnx::13::NPUScatter"),
                   ge::AscendString("ai.onnx::14::NPUScatter"), ge::AscendString("ai.onnx::15::NPUScatter"),
                   ge::AscendString("ai.onnx::16::NPUScatter"), ge::AscendString("ai.onnx::17::NPUScatter"),
