...
protected:
    static void SetUpTestCase() { cout << "multi_scale_deformable_attn_function_test SetUp\n" << endl; }
    static void TearDownTestCase()
    {
        cout << "multi_scale_deformable_attn_function_test TearDown\n" << endl;
        kernel_ut::CleanGeneratedBinFiles("./multi_scale_deformable_attn_function_data");
    }
};
...
TEST_F(multi_scale_deformable_attn_function_test, msda_test_high_perf)
{
    ...
    kernel_ut::SetupTestEnvironment(
        "vfusion/multi_scale_deformable_attn_function/tests/ut/op_kernel/multi_scale_deformable_attn_function_data",
        "multi_scale_deformable_attn_function_data");
    kernel_ut::RunGenData("./multi_scale_deformable_attn_function_data", {"1", "8", "64", "1", "2", "100"});
    kernel_ut::RunGenTiling("./multi_scale_deformable_attn_function_data", "1 8 64 1 2 100");
