...
int main()
{
    ...
    ret = aclnnApplyAdamaxGetWorkspaceSize(var, m, v, beta1Power, lr, beta1, beta2, epsilon, grad, varOut, mOut, vOut,
                                           &workspaceSize, &executor);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnApplyAdamaxGetWorkspaceSize failed. ERROR: %d\n", ret); return ret);
