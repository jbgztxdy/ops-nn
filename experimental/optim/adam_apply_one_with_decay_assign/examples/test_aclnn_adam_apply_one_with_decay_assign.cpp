...
#include <vector>
#include "acl/acl.h"
#include "aclnnop/aclnn_adam_apply_one_with_decay_assign.h"
...
int main()
{
    ...
    ret = aclnnAdamApplyOneWithDecayAssignGetWorkspaceSize(input0, input1, input2, input3, input4, mul0_x, mul1_x,
                                                           mul2_x, mul3_x, mul4_x, add2_y, output0, output1, output2,
                                                           &workspaceSize, &executor);
    CHECK_RET(ret == ACL_SUCCESS,
              LOG_PRINT("aclnnAdamApplyOneWithDecayAssignGetWorkspaceSize failed. ERROR: %d\n", ret);
              return ret);
    ...
    ret = aclnnAdamApplyOneWithDecayAssign(workspaceAddr, workspaceSize, executor, stream);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnAdamApplyOneWithDecayAssign failed. ERROR: %d\n", ret); return ret);
