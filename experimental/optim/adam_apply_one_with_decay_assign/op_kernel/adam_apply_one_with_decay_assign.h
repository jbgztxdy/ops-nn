...
public:
    ...
    __aicore__ inline void Init(GM_ADDR input0, GM_ADDR input1, GM_ADDR input2, GM_ADDR input3, GM_ADDR input4,
                                ...
                                const AdamApplyOneWithDecayAssignTilingData* tilingData);
...
template <typename T>
__aicore__ inline void AdamApplyOneWithDecayAssign<T>::Init(GM_ADDR input0, GM_ADDR input1, GM_ADDR input2,
