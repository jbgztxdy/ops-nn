...
| 调用方式      | 调用样例                                                                                    | 说明                                            |
| ------------- | ------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| aclnn模式调用 | [test_aclnn_adam_apply_one_with_decay](./examples/test_aclnn_adam_apply_one_with_decay.cpp) | 通过对应算子接口调用AdamApplyOneWithDecay算子。 |

## 贡献说明

| 贡献者 | 贡献方 | 贡献算子 | 贡献时间 | 贡献内容 |
| ---- | ---- | ---- | ---- | ---- |
| CyndiZ | 个人开发者 | AdamApplyOneWithDecay | 2026/04/27 | AdamApplyOneWithDecay算子适配开源仓 |
