...
class AdamApplyOneWithDecayTiling : public testing::Test {
protected:
...
TEST_F(AdamApplyOneWithDecayTiling, AdamApplyOneWithDecayTiling_01)
{
    // input
    ...
    // compile info
    struct AdamApplyOneWithDecayTilingCompileInfo {};
    AdamApplyOneWithDecayTilingCompileInfo compile_info;

    std::string op_type("AdamApplyOneWithDecay");
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("AdamApplyOneWithDecay")
                      .NodeIoNum(11, 3)
                      //   .IrInstanceNum({1, 1})
