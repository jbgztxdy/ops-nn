...
#include "../../../op_kernel/adam_apply_one_with_decay.cpp"
...
TEST_F(adam_apply_one_with_decay_test, test_adam_apply_one_with_decay_dynamic)
{
    ...
    size_t tiling_data_size = sizeof(AdamApplyOneWithDecayTilingData);
    uint32_t blockDim = 1;
    ...
    auto AdamApplyOneWithDecayKernel = [](GM_ADDR input0, GM_ADDR input1, GM_ADDR input2, GM_ADDR input3,
