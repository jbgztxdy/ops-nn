...
#ifndef ADAM_APPLY_ONE_WITH_DECAY_STRUCT_H
#define ADAM_APPLY_ONE_WITH_DECAY_STRUCT_H
...
ASCENDC_TPL_ARGS_DECL(AdamApplyOneWithDecay,
...
#endif // ADAM_APPLY_ONE_WITH_DECAY_STRUCT_H
