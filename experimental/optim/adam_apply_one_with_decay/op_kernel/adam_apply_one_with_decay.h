...
/*!
 * \file adam_apply_one_with_decay.h
 * \brief
 * */
#ifndef ADAM_APPLY_ONE_WITH_DECAY_H
#define ADAM_APPLY_ONE_WITH_DECAY_H

#include <type_traits>
#include "kernel_operator.h"
#include "kernel_tiling/kernel_tiling.h"
#include "adam_apply_one_with_decay_tiling_key.h"
#include "adam_apply_one_with_decay_tiling_data.h"
#include "kernel_operator.h"
namespace NsAdamApplyOneWithDecay {

using namespace AscendC;

constexpr int32_t BUFFER_NUM = 1;
template <typename T>
class AdamApplyOneWithDecay {
public:
...
template <typename T>
__aicore__ inline void AdamApplyOneWithDecay<T>::CopyIn(int32_t progress)
{
...
template <typename T>
__aicore__ inline void AdamApplyOneWithDecay<T>::CopyOut(int32_t progress)
{
...
template <typename T>
__aicore__ inline void AdamApplyOneWithDecay<T>::Compute(int32_t progress)
{
...
template <typename T>
__aicore__ inline void AdamApplyOneWithDecay<T>::Process()
{
...
#endif // ADAM_APPLY_ONE_WITH_DECAY_H
