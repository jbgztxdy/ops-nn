...
/*!
 * \file apply_adagrad_d_graph_infer.cpp
 * \brief InferDataType for ApplyAdagradD
 *   Both outputs have the same dtype as input[0] (var).
 */
...
static ge::graphStatus InferDataTypeApplyAdagradD(gert::InferDataTypeContext* context)
{
...
IMPL_OP(ApplyAdagradD).InferDataType(InferDataTypeApplyAdagradD);
