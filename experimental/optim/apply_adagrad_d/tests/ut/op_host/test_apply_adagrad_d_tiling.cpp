...
TEST_F(ApplyAdagradDTiling, apply_adagrad_d_float32_success) { RunTilingTest(ge::DT_FLOAT); }

TEST_F(ApplyAdagradDTiling, apply_adagrad_d_float16_success) { RunTilingTest(ge::DT_FLOAT16); }

TEST_F(ApplyAdagradDTiling, apply_adagrad_d_bf16_success) { RunTilingTest(ge::DT_BF16); }
