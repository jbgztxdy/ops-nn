...
protected:
    static void SetUpTestCase() { cout << "apply_adagrad_d_test SetUp\n" << endl; }
    static void TearDownTestCase() { cout << "apply_adagrad_d_test TearDown\n" << endl; }
};
...
TEST_F(apply_adagrad_d_test, test_case_0)
{
    ...
    auto ApplyAdagradDKernel = [](GM_ADDR var, GM_ADDR accum, GM_ADDR lr, GM_ADDR grad, GM_ADDR var_out,
    ...
    ICPU_RUN_KF(ApplyAdagradDKernel, blockDim, var, accum, lr, grad, var_out, accum_out, workspace,
