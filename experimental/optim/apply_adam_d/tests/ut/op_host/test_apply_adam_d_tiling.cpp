...
protected:
    static void SetUpTestCase() { std::cout << "ApplyAdamDTilingTest SetUp." << std::endl; }
    static void TearDownTestCase() { std::cout << "ApplyAdamDTilingTest TearDown." << std::endl; }
};
...
static gert::TilingContextPara MakeTilingPara(const std::initializer_list<int64_t>& varShape, ge::DataType dtype,
                                              bool useLocking, bool useNesterov, void* compileInfo)
{
...
static std::vector<TilingContextPara::TensorDescription> BuildLegalInputs(const gert::StorageShape& tensorShape,
                                                                          const gert::StorageShape& scalarShape,
                                                                          ge::DataType dtype)
{
...
static gert::TilingContextPara MakeParaFromInputs(const std::vector<TilingContextPara::TensorDescription>& inputs,
                                                  const gert::StorageShape& outShape, ge::DataType outDtype,
                                                  bool useNesterov, void* compileInfo)
{
    std::vector<TilingContextPara::TensorDescription> outputs({
...
static void CheckTilingSuccess(const gert::TilingContextPara& para, int64_t expectKey, int64_t expectTotalNum,
                               int64_t expectBlockFactor, int64_t expectUbFactor, size_t expectBlockNum)
{
    TilingInfo info;
    bool ok = ExecuteTiling(para, info);
    ...
    ASSERT_GE(info.tilingDataSize, sizeof(ApplyAdamDTilingData)) << "TilingData size insufficient";
