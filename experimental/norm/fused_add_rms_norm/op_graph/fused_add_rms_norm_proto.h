...
/*!
 * \file fused_add_rms_norm_proto.h
 * \brief
 */
#ifndef OPS_NORM_FUSED_ADD_RMS_NORM_PROTO_H_
#define OPS_NORM_FUSED_ADD_RMS_NORM_PROTO_H_

#include "graph/operator_reg.h"

namespace ge {
/**
* @brief FusedAddRmsNorm operator interface implementation. \n
...
* scale: Scale factor for x1 in the ScaledAdd formula.
* A optional attribute, the type is float. Defaults to 1.0.
...
REG_OP(FusedAddRmsNorm)
    ...
    .OP_END_FACTORY_REG(FusedAddRmsNorm)

}  // namespace ge

#endif  // OPS_NORM_FUSED_ADD_RMS_NORM_PROTO_H_
