...
/*!
 * \file fused_add_rms_norm_infershape.cpp
 * \brief
 */
#include "log/log.h"
...
static ge::graphStatus InferShape4FusedAddRmsNorm(gert::InferShapeContext* context)
{
    OP_LOGD(context, "Begin to do InferShape4FusedAddRmsNorm");
    ...
    *xShape = *x1Shape;
    ...
    OP_LOGD(context, "End to do InferShape4FusedAddRmsNorm");
    return GRAPH_SUCCESS;
}

static graphStatus InferDataType4FusedAddRmsNorm(gert::InferDataTypeContext* context)
{
    OP_LOGD(context, "Begin to do InferDataType4FusedAddRmsNorm");
    ...
    OP_LOGD(context, "End to do InferDataType4FusedAddRmsNorm");
    return GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(FusedAddRmsNorm).InferShape(InferShape4FusedAddRmsNorm).InferDataType(InferDataType4FusedAddRmsNorm);
}  // namespace ops
