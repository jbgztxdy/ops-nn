...
#ifndef OPS_BUILT_IN_OP_TILING_RUNTIME_FUSED_ADD_RMS_NORM_H_
#define OPS_BUILT_IN_OP_TILING_RUNTIME_FUSED_ADD_RMS_NORM_H_
...
BEGIN_TILING_DATA_DEF(FusedAddRMSNormRegbaseTilingData)
...
REGISTER_TILING_DATA_CLASS(FusedAddRmsNorm_1, FusedAddRMSNormRegbaseTilingData)
REGISTER_TILING_DATA_CLASS(FusedAddRmsNorm_2, FusedAddRMSNormRegbaseTilingData)
REGISTER_TILING_DATA_CLASS(FusedAddRmsNorm_3, FusedAddRMSNormRegbaseTilingData)
REGISTER_TILING_DATA_CLASS(FusedAddRmsNorm_1001, FusedAddRMSNormRegbaseTilingData)
REGISTER_TILING_DATA_CLASS(FusedAddRmsNorm_1002, FusedAddRMSNormRegbaseTilingData)
REGISTER_TILING_DATA_CLASS(FusedAddRmsNorm_1003, FusedAddRMSNormRegbaseTilingData)
}  // namespace optiling

#endif  // OPS_BUILT_IN_OP_TILING_RUNTIME_FUSED_ADD_RMS_NORM_H_
