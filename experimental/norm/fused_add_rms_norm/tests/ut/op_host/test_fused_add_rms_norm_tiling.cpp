...
#include "test_fused_add_rms_norm_tiling.h"
...
class test_fused_add_rms_norm_tiling : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "FusedAddRmsNormTiling SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "FusedAddRmsNormTiling TearDown" << std::endl;
    }
};

// TEST_F(test_fused_add_rms_norm_tiling, fused_add_rms_norm_tiling_001) {
//   // dlog_setlevel(0,0,0);
...
//   platform_info.Init();
//     // compile info
//   struct FusedAddRmsNormCompileInfo
//   {
//       uint32_t totalCoreNum = 40;
//       uint64_t totalUbSize = 196608;
//       platform_ascendc::SocVersion socVersion = platform_ascendc::SocVersion::ASCEND910B;
//   };
//   FusedAddRmsNormCompileInfo compile_info;

//   std::string op_type("FusedAddRmsNorm");
...
// TEST_F(test_fused_add_rms_norm_tiling, fused_add_rms_norm_tiling_002) {
//   // dlog_setlevel(0,0,0);
...
// TEST_F(test_fused_add_rms_norm_tiling, fused_add_rms_norm_tiling_003) {
//   // dlog_setlevel(0,0,0);
...
TEST_F(test_fused_add_rms_norm_tiling, fused_add_rms_norm_tiling_001)
{
    ...
    platform_info.Init();
    // compile info
    optiling::FusedAddRmsNormCompileInfo compile_info;
...
TEST_F(test_fused_add_rms_norm_tiling, fused_add_rms_norm_tiling_004)
{
    // dlog_setlevel(0, 0, 0);
...
TEST_F(test_fused_add_rms_norm_tiling, fused_add_rms_norm_tiling_005)
{
    // dlog_setlevel(0, 0, 0);
...
TEST_F(test_fused_add_rms_norm_tiling, fused_add_rms_norm_tiling_006)
{
    // dlog_setlevel(0, 0, 0);
