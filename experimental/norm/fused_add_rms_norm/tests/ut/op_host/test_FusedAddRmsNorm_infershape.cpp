...
#include "../../../op_graph/fused_add_rms_norm_proto.h"

class test_FusedAddRmsNorm_infershape : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "FusedAddRmsNorm Proto Test SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "FusedAddRmsNorm Proto Test TearDown" << std::endl;
    }
};

TEST_F(test_FusedAddRmsNorm_infershape, FusedAddRmsNorm_infershape_case_0)
{
    ge::op::FusedAddRmsNorm op;
...
TEST_F(test_FusedAddRmsNorm_infershape, FusedAddRmsNorm_InferDtype_case_0)
{
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("FusedAddRmsNorm"), nullptr);
    auto data_type_func = gert::OpImplRegistry::GetInstance().GetOpImpl("FusedAddRmsNorm")->infer_datatype;
