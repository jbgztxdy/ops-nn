...
#include "fused_add_rms_norm_tiling_def.h"
...
class test_fused_add_rms_norm : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        cout << "test_fused_add_rms_norm SetUp\n" << endl;
    }
    static void TearDownTestCase()
    {
        cout << "test_fused_add_rms_norm TearDown\n" << endl;
    }
};

TEST_F(test_fused_add_rms_norm, test_case_10)
{
    ...
    size_t tiling_data_size = sizeof(FusedAddRMSNormTilingData);
    ...
    FusedAddRMSNormTilingData* tilingDatafromBin = reinterpret_cast<FusedAddRMSNormTilingData*>(tiling);
    ...
    ICPU_RUN_KF(fused_add_rms_norm, blockDim, x1, x2, gamma, y, rstd, x, workspace, (uint8_t*)(tilingDatafromBin));
...
TEST_F(test_fused_add_rms_norm, test_case_20)
{
...
TEST_F(test_fused_add_rms_norm, test_case_30)
{
    size_t inputByteSize = 2 * 256 * sizeof(int16_t);
    size_t gammaByteSize = 256 * sizeof(int16_t);
    size_t outputByteSize = 2 * 256 * sizeof(int16_t);
...
TEST_F(test_fused_add_rms_norm, test_case_11)
{
...
TEST_F(test_fused_add_rms_norm, test_case_21)
{
...
// TEST_F(test_fused_add_rms_norm, test_case_31)
// {
//     size_t inputByteSize = 2 * 25600 * sizeof(int16_t);
//     size_t gammaByteSize = 25600 * sizeof(int16_t);
//     size_t outputByteSize = 2 * 25600 * sizeof(int16_t);
...
// TEST_F(test_fused_add_rms_norm, test_case_14)
// {
...
// TEST_F(test_fused_add_rms_norm, test_case_34)
// {
//     size_t inputByteSize = 48 * 2016 * sizeof(int16_t);
//     size_t gammaByteSize = 48 * sizeof(int16_t);
//     size_t outputByteSize = 48 * 2016 * sizeof(int16_t);
...
// TEST_F(test_fused_add_rms_norm, test_case_22)
// {
...
// TEST_F(test_fused_add_rms_norm, test_case_32)
// {
...
// TEST_F(test_fused_add_rms_norm, test_case_13)
// {
//     size_t inputByteSize = 2 * 256 * sizeof(int16_t);
//     size_t gammaByteSize = 256 * sizeof(int16_t);
//     size_t outputByteSize = 2 * 256 * sizeof(int16_t);
...
// TEST_F(test_fused_add_rms_norm, test_case_23)
// {
//     size_t inputByteSize = 2 * 256 * sizeof(float);
//     size_t gammaByteSize = 256 * sizeof(float);
//     size_t outputByteSize = 2 * 256 * sizeof(float);
...
TEST_F(test_fused_add_rms_norm, test_case_33)
{
    size_t inputByteSize = 2 * 256 * sizeof(int16_t);
    size_t gammaByteSize = 256 * sizeof(int16_t);
    size_t outputByteSize = 2 * 256 * sizeof(int16_t);
...
TEST_F(test_fused_add_rms_norm, test_case_12)
{
...
// TEST_F(test_fused_add_rms_norm, test_case_12_2)
// {
