 ...
 */
#ifndef FUSED_ADD_RMS_NORM_TILING_H_
#define FUSED_ADD_RMS_NORM_TILING_H_
...
struct FusedAddRMSNormTilingData {
    uint32_t num_row;
    uint32_t num_col;
...
#define GET_TILING_DATA(tilingData, tilingPointer)                            \
    ...
    INIT_TILING_DATA(FusedAddRMSNormTilingData, tilingDataPointer, tilingPointer); \
