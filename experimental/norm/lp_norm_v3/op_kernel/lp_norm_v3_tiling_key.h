...
/* 模板参数 */
ASCENDC_TPL_ARGS_DECL(LpNormV3, ASCENDC_TPL_UINT_DECL(schMode, 2, ASCENDC_TPL_UI_LIST, LP_NORM_AXIS_NONE,
                                                      LP_NORM_AXIS_0, LP_NORM_AXIS_1));

/* 模板参数组合 */
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, LP_NORM_AXIS_NONE,
                                                          LP_NORM_AXIS_0, LP_NORM_AXIS_1)));
