...
ASCENDC_TPL_ARGS_DECL(Prelu, ASCENDC_TPL_UINT_DECL(schMode, 3, ASCENDC_TPL_UI_LIST, PRELU_TPL_SCALAR_MODE,
                                                   PRELU_TPL_CHANNEL_FULL_L_MODE, PRELU_TPL_CHANNEL_SPLIT_L_MODE,
                                                   PRELU_TPL_CHANNEL_SPLIT_L_PARALLEL_MODE,
                                                   PRELU_TPL_CHANNEL_NC_WEIGHT_REUSE_MODE,
                                                   PRELU_TPL_CHANNEL_NC_SPLIT_C_WEIGHT_REUSE_MODE,
                                                   PRELU_TPL_CHANNEL_NC_RESIDENT_WEIGHT_MODE));

ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(
    schMode, ASCENDC_TPL_UI_LIST, PRELU_TPL_SCALAR_MODE, PRELU_TPL_CHANNEL_FULL_L_MODE, PRELU_TPL_CHANNEL_SPLIT_L_MODE,
