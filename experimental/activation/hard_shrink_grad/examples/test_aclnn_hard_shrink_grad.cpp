...
int main()
{
    ...
    std::vector<float> gradOutputHostData = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f};
    std::vector<float> selfHostData = {1.0f, 0.3f, -0.8f, 0.5f, -1.0f, 0.0f};
    ...
    ret = aclnnHardShrinkGradGetWorkspaceSize(gradOutputTensor, selfTensor, lambd, outputTensor, &workspaceSize,
                                              &executor);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnHardShrinkGradGetWorkspaceSize failed. ERROR: %d\n", ret);
              return ret);
