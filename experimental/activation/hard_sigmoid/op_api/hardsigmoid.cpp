...
/**
 * @file hardsigmoid.cpp
 * @brief ACLNN L0 API implementation - HardSigmoid
 *
 * L0 API: InferShape -> IsAiCoreSupport -> AllocTensor -> HardSigmoidAiCore
 * alpha/beta are compile-time constants (1/6, 0.5), passed as OP_ATTR to match
 * the reference implementation signature.
 */
