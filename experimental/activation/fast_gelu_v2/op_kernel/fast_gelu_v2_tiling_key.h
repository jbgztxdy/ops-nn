...
/*!
 * \file fast_gelu_v2_tiling_key.h
 * \brief FastGeluV2 TilingKey template parameter definition
 *
 * Template parameters:
 *   - D_T_X: Data type (C_DT_FLOAT, C_DT_FLOAT16, C_DT_BF16)
 *   - BUFFER_MODE: Buffer mode (0=single buffer, 1=double buffer)
 *
 * Total TilingKey combinations: 3 dtype x 2 buffer modes = 6
 */

#ifndef __FAST_GELU_V2_TILING_KEY_H__
#define __FAST_GELU_V2_TILING_KEY_H__

#include "ascendc/host_api/tiling/template_argument.h"

ASCENDC_TPL_ARGS_DECL(FastGeluV2,
