...
ASCENDC_TPL_ARGS_DECL(Selu,
    ASCENDC_TPL_DATATYPE_DECL(D_T_X, C_DT_FLOAT, C_DT_FLOAT16, C_DT_BF16,
                              C_DT_INT32, C_DT_INT8, ASCENDC_TPL_INPUT(0))
);
