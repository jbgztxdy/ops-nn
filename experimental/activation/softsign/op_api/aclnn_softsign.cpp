...
/**
 * @file aclnn_softsign.cpp
 * @brief ACLNN L2 API implementation for Softsign operator
 *
 * Two-phase API:
 *   1. aclnnSoftsignGetWorkspaceSize - compute workspace, create executor
 *   2. aclnnSoftsign - execute computation
 */
    ...
    aclOpExecutor** executor)
{
    ...
    const aclTensor* opResult = l0op::Softsign(selfContiguous, uniqueExecutor.get());
