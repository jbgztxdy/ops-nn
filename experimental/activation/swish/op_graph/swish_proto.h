...
namespace ge {
/**
*@brief Computes the Swish activation function for input tensor x .
...
*@par Outputs:
* y: A tensor of the same type, shape and format as "x", and y = x / (1 + exp(-scale * x)). \n

*@par Attributes:
* scale: scalar parameter, the multiplier of x. Must be of type float. Default value = 1.0. \n
