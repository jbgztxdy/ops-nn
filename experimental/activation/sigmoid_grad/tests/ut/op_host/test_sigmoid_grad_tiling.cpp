...
TEST_F(SigmoidGradTiling, sigmoid_grad_float32_success) {
    // input
    ...
    // compile info
    struct SigmoidGradTilingCompileInfo {};
    SigmoidGradTilingCompileInfo compile_info;

    std::string op_type("SigmoidGrad");
...
TEST_F(SigmoidGradTiling, sigmoid_grad_float16_success) {
    // input
    gert::StorageShape x1_shape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
    gert::StorageShape x2_shape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
    gert::StorageShape x3_shape = {};
...
TEST_F(SigmoidGradTiling, sigmoid_grad_bfloat16_success) {
    // input
    gert::StorageShape x1_shape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
    gert::StorageShape x2_shape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
    gert::StorageShape x3_shape = {};
