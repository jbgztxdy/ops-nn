...
#include <string>
#endif
#include "../../../op_kernel/sigmoid_grad.cpp"
...
TEST_F(sigmoid_grad_test, test_case_0)
{
    ...
    auto KernelSigmoidGrad = [](GM_ADDR x, GM_ADDR y, GM_ADDR z, GM_ADDR workspace, GM_ADDR tiling) {
        ::sigmoid_grad<0>(x, y, z, workspace, tiling);
    };
