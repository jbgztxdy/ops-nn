...
ge::graphStatus EluTilingArch35::SetTilingData()
{
    ...
    tiling->baseTiling.scheMode = ELU_TPL_SCH_MODE_0;
    this->schMode = ELU_TPL_SCH_MODE_0;
    uint64_t tilingKey = 0;
    if (dType == static_cast<uint64_t>(ELU_TPL_FP16)) {
        tilingKey = ELU_TPL_KEY_FP16_SCH0;
    } else if (dType == static_cast<uint64_t>(ELU_TPL_BF16)) {
        tilingKey = ELU_TPL_KEY_BF16_SCH0;
    } else if (dType == static_cast<uint64_t>(ELU_TPL_FP32)) {
        tilingKey = ELU_TPL_KEY_FP32_SCH0;
    }
...
ge::graphStatus EluTilingArch35::CalcOutputDtype()
{
...
ge::graphStatus EluTilingArch35::CheckShape()
{
...
ge::graphStatus EluTilingArch35::RunTiling()
{
...
static ge::graphStatus TilingForElu(gert::TilingContext* context)
{
    ...
    EluTilingArch35 eluTiling(context);
