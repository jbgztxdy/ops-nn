...
#include "../../../op_api/aclnn_inplace_elu.h"
#include <vector>
#include <array>
#include <complex>
...
// 正常场景_FLOAT_ND
TEST_F(TestAclnnElu, l2_elu_normal_FLOAT_ND)
{
...
TEST_F(TestAclnnElu, l2_elu_inf_FLOAT_ND)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
...
// 非法dtype场景_DOUBLE_ND
TEST_F(TestAclnnElu, l2_elu_inf_DOUBLE_ND)
{
...
TEST_F(TestAclnnElu, l2_elu_normal_FLOAT_NCHW_INPLACE)
{
...
// 正常场景_FLOAT16_NHWC
TEST_F(TestAclnnElu, l2_elu_normal_FLOAT16_NHWC)
{
...
TEST_F(TestAclnnElu, l2_elu_normal_ratio_uint8_NDHWC)
{
...
TEST_F(TestAclnnElu, l2_elu_normal_alpha_half_NCHW_NHWC)
{
    auto selfDesc = TensorDesc({2, 2, 2, 2}, ACL_FLOAT, ACL_FORMAT_NCHW);
    float alpha = 0.5;
    auto alphaDesc = ScalarDesc(alpha);
...
// 正常场景_alpha_2_ND
TEST_F(TestAclnnElu, l2_elu_normal_alpha_2_ND)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
    float alpha = 2.0;
    auto alphaDesc = ScalarDesc(alpha);
...
// 正常场景_scale_1/2_ND
TEST_F(TestAclnnElu, l2_elu_normal_scale_half_ND)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
    float alpha = 1.0;
    auto alphaDesc = ScalarDesc(alpha);
...
// 正常场景_scale_2_ND
TEST_F(TestAclnnElu, l2_elu_normal_scale_2_ND)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
    float alpha = 1.0;
    auto alphaDesc = ScalarDesc(alpha);
...
TEST_F(TestAclnnElu, l2_elu_normal_input_scale_half_ND)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
    float alpha = 1.0;
    auto alphaDesc = ScalarDesc(alpha);
...
TEST_F(TestAclnnElu, l2_elu_normal_input_scale_2_ND)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
    float alpha = 1.0;
    auto alphaDesc = ScalarDesc(alpha);
...
// 空tensor场景
TEST_F(TestAclnnElu, l2_elu_normal_empty_tensor)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_self_nullptr)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_alpha_nullptr)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(TestAclnnElu, l2_elu_abnormal_scale_nullptr)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
    float alpha = 1.0;
    auto alphaDesc = ScalarDesc(alpha);
...
TEST_F(TestAclnnElu, l2_elu_abnormal_inputScale_nullptr)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
    float alpha = 1.0;
    auto alphaDesc = ScalarDesc(alpha);
...
TEST_F(TestAclnnElu, l2_elu_abnormal_out_nullptr)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
    float alpha = 1.0;
    auto alphaDesc = ScalarDesc(alpha);
...
TEST_F(TestAclnnElu, l2_elu_abnormal_self_INT32)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_self_INT64)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_self_INT16)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_self_INT8)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_self_UINT8)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_self_BOOL)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_self_COMPLEX64)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_self_COMPLEX128)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_self_UNDEFINED)
{
...
TEST_F(TestAclnnElu, l2_elu_abnormal_out_INT32)
{
    auto selfDesc = TensorDesc({2}, ACL_FLOAT, ACL_FORMAT_ND);
    float alpha = 1.0;
    auto alphaDesc = ScalarDesc(alpha);
...
// CheckShape_unequal
TEST_F(TestAclnnElu, l2_elu_abnormal_shape_unequal)
{
...
// CheckShape_10D
TEST_F(TestAclnnElu, l2_elu_abnormal_shape_10D)
{
...
// CheckShape_shape_size_over_int32_max
TEST_F(TestAclnnElu, l2_elu_abnormal_shape_size_over_int32_max)
{
    auto selfDesc = TensorDesc({2147483648LL}, ACL_FLOAT, ACL_FORMAT_ND);
    float alpha = 1.0;
    auto alphaDesc = ScalarDesc(alpha);
    float scale = 1.0;
    auto scaleDesc = ScalarDesc(scale);
    float inputScale = 1.0;
    auto inputScaleDesc = ScalarDesc(inputScale);
    auto outDesc = TensorDesc({2147483648LL}, ACL_FLOAT, ACL_FORMAT_ND);
...
// 数据范围[-1，1]
TEST_F(TestAclnnElu, l2_elu_normal_valuerange)
{
...
// 非连续
TEST_F(TestAclnnElu, l2_elu_normal_uncontiguous)
{
...
// 正常场景_BF16_ND
TEST_F(TestAclnnElu, ascend950_l2_elu_normal_BF16_ND)
{
