...
class TestEluTiling : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "EluTilingTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "EluTilingTest TearDown" << std::endl; }
};

TEST_F(TestEluTiling, test_tiling_fp16_001)
{
...
TEST_F(TestEluTiling, test_tiling_fp32_002)
{
    std::map<std::string, std::string> soc_version_infos = {{"Short_SoC_version", "Ascend950"}, {"NpuArch", "3510"}};
    string compile_info_string = R"({
                                    "hardware_info": {
...
TEST_F(TestEluTiling, test_tiling_bf16_007)
{
    std::map<std::string, std::string> soc_version_infos = {{"Short_SoC_version", "Ascend950"}, {"NpuArch", "3510"}};
    string compile_info_string = R"({
                                    "hardware_info": {
...
TEST_F(TestEluTiling, test_tiling_failed_bf16_fp32_008)
{
    std::map<std::string, std::string> soc_version_infos = {{"Short_SoC_version", "Ascend950"}, {"NpuArch", "3510"}};
    string compile_info_string = R"({
                                    "hardware_info": {
...
TEST_F(TestEluTiling, test_tiling_failed_empty_tensor_009)
{
    std::map<std::string, std::string> soc_version_infos = {{"Short_SoC_version", "Ascend950"}, {"NpuArch", "3510"}};
    string compile_info_string = R"({
                                    "hardware_info": {
...
TEST_F(TestEluTiling, test_tiling_failed_unsupport_type_010)
{
    std::map<std::string, std::string> soc_version_infos = {{"Short_SoC_version", "Ascend950"}, {"NpuArch", "3510"}};
    string compile_info_string = R"({
                                    "hardware_info": {
...
TEST_F(TestEluTiling, test_tiling_failed_diff_shape_010)
{
    std::map<std::string, std::string> soc_version_infos = {{"Short_SoC_version", "Ascend950"}, {"NpuArch", "3510"}};
    string compile_info_string = R"({
                                    "hardware_info": {
