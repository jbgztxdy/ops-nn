...
/*!
 * \file log_softmax_v2_tiling_key.h
 * \brief log_softmax_v2 tiling key declare
 */
...
ASCENDC_TPL_ARGS_DECL(LogSoftmaxV2, ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, ELEMENTWISE_TPL_SCH_MODE_0,
