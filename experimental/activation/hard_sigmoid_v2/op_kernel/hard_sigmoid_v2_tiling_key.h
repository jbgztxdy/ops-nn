...
#ifndef __HARD_SIGMOID_V2_TILING_KEY_H__
#define __HARD_SIGMOID_V2_TILING_KEY_H__

#include "ascendc/host_api/tiling/template_argument.h"

ASCENDC_TPL_ARGS_DECL(HardSigmoidV2, ASCENDC_TPL_DATATYPE_DECL(D_T_X, C_DT_FLOAT, C_DT_FLOAT16, C_DT_BF16, C_DT_INT32,
                                                               ASCENDC_TPL_INPUT(0)));
