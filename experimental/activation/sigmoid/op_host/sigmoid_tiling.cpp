...
{
    OP_CHECK_IF(context == nullptr, OP_LOGE(context, "context is nullptr"), return ge::GRAPH_FAILED);
    OP_CHECK_IF(context->GetInputShape(0) == nullptr, OP_LOGE(context, "InputShape is nullptr"),
...
static ge::graphStatus SigmoidTilingFunc(gert::TilingContext* context)
{
    ...
    ret = CalculateCoreBlockNums(context, inputLengthAlgin32, coreNum, tileBlockNum, inputBytes, tileDataNum,
