...
static ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, uint64_t ubSize, uint64_t coreNum,
                                         uint64_t& haveTanh, uint64_t& bufferOpen, uint64_t& inputNum,
...
static ge::graphStatus GeluGradV2TilingFunc(gert::TilingContext* context)
{
    ...
    ret = GetShapeAttrsInfo(context, ubSize, coreNum, haveTanh, bufferOpen, inputNum, inputBytes, tileBlockNum,
    ...
    OP_CHECK_IF(memset_s(tiling, sizeof(GeluGradV2TilingData), 0, sizeof(GeluGradV2TilingData)) != EOK,
