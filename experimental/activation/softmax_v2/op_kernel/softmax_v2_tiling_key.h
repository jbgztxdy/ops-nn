...
/*!
 * \file softmax_v2_tiling_key.h
 * \brief softmax_v2 tiling key declare
*/
#ifndef __SOFTMAXV2_TILING_KEY_H__
#define __SOFTMAXV2_TILING_KEY_H__
...
ASCENDC_TPL_ARGS_DECL(SoftmaxV2,
