...
protected:
    static void SetUpTestCase() { std::cout << "hardsigmoid_backward_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "hardsigmoid_backward_test TearDown" << std::endl; }
};
