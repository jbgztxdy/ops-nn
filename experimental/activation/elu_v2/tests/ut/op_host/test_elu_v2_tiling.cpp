...
class EluV2Tiling : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "EluV2Tiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "EluV2Tiling TearDown" << std::endl; }
};

TEST_F(EluV2Tiling, elu_v2_tiling_float32_success)
{
...
TEST_F(EluV2Tiling, elu_v2_tiling_float16_success)
{
    gert::StorageShape xShape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
    gert::StorageShape yShape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
...
TEST_F(EluV2Tiling, elu_v2_tiling_bfloat16_success)
{
    gert::StorageShape xShape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
    gert::StorageShape yShape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
