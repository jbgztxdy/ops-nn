...
static ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    OP_CHECK_IF(!shapeMatch,
                OP_LOGE(context, "LogsigmoidV2: inputx,outputz shape not match! dim num: x=%zu,  z=%zu",
...
// tiling注册入口.
IMPL_OP_OPTILING(LogsigmoidV2)
    .Tiling(LogsigmoidV2TilingFunc)
    .TilingParse<LogsigmoidV2CompileInfo>(TilingParseForLogsigmoidV2);
} // namespace optiling