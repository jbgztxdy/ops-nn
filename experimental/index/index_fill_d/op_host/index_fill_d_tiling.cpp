...
static ge::graphStatus IndexFillDTilingFunc(gert::TilingContext* context)
{
    ...
    OP_CHECK_IF(memset_s(tiling, sizeof(IndexFillDTilingData), 0, sizeof(IndexFillDTilingData)) != EOK,
    ...
    ret = GetShapeAttrsInfo(context, ubSize, coreNum, inputNum, inputBytes, tileBlockNum, tileDataNum, inputLengthAlgin,
                            bufferNum);
