...
/*!
 * \file index_fill_d_tiling_key.h
 * \brief index_fill_d tiling key declare
 */
...
ASCENDC_TPL_ARGS_DECL(IndexFillD, ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, ELEMENTWISE_TPL_SCH_MODE_0,
