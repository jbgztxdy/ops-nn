...
/* !
 * \file tilelet_matmul_fp32_base_block.h
 * \brief
 */
#ifndef __OP_TILELET_MATMUL_FP32_BASE_BLOCK_H__
#define __OP_TILELET_MATMUL_FP32_BASE_BLOCK_H__

#include "tilelet_matmul_fp32_common.h"
#include "tilelet_matmul_fp32_tiling_data.h"
...
class TileletMatmulFp32BaseBlock {
public:
    __aicore__ inline TileletMatmulFp32BaseBlock() {}
...
public:
    ...
    const TileletMatmulFp32TilingData* matmulFp32TilingData_;
};

template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE>
__aicore__ inline void TileletMatmulFp32BaseBlock::Init(const void* tilingData)
{
    matmulFp32TilingData_ = static_cast<const TileletMatmulFp32TilingData*>(tilingData);
...
__aicore__ inline void TileletMatmulFp32BaseBlock::UpdateBasicIndex(uint64_t roundIdx, uint64_t blockIdx)
{
...
__aicore__ inline void TileletMatmulFp32BaseBlock::UpdateBlockParams()
{
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE>
__aicore__ inline void TileletMatmulFp32BaseBlock::CalcGMOffset()
{
...
#endif // __OP_TILELET_MATMUL_FP32_BASE_BLOCK_H__