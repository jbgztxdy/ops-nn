...
static ge::graphStatus BinaryCrossEntropyGradV2TilingFunc(gert::TilingContext* context)
{
    ...
    OP_CHECK_IF(memset_s(tiling, sizeof(BinaryCrossEntropyGradV2TilingData), 0,
                         sizeof(BinaryCrossEntropyGradV2TilingData)) != EOK,
...
// tiling注册入口.
IMPL_OP_OPTILING(BinaryCrossEntropyGradV2)
    .Tiling(BinaryCrossEntropyGradV2TilingFunc)
    .TilingParse<BinaryCrossEntropyGradV2CompileInfo>(TilingParseForBinaryCrossEntropyGradV2);
} // namespace optiling
