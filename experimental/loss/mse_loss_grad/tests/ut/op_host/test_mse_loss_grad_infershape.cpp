...
class MseLossGrad : public testing::Test
{
protected:
...
std::vector<int64_t> ToVectorForMseLossGrad(const gert::Shape& shape) {
...
TEST_F(MseLossGrad, MseLossGrad_infershape_none_fp16_case_0)
{
...
TEST_F(MseLossGrad, MseLossGrad_infershape_none_fp16_case_1)
{
    ...
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("MseLossGrad")->infer_shape;
    ...
    EXPECT_EQ(ToVectorForMseLossGrad(*yGradShape), expectedyGradShape);
}

TEST_F(MseLossGrad, MseLossGrad_infershape_none_bf16_case_0)
{
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("MseLossGrad"), nullptr);
    auto data_type_func = gert::OpImplRegistry::GetInstance().GetOpImpl("MseLossGrad")->infer_datatype;
...
TEST_F(MseLossGrad, MseLossGrad_infershape_none_bp16_case_1)
{
    gert::StorageShape predictShape = {{32, 64}, {32, 64}};
    gert::StorageShape labelShape = {{32, 64}, {32, 64}};
    gert::StorageShape doutShape = {{32, 64}, {32, 64}};
