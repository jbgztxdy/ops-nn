...
static ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    OP_CHECK_IF(
        !shapeMatch,
        OP_LOGE(context, "BinaryCrossEntropyV2: inputx,inputy,outputz shape not match! dim num: x=%zu, y=%zu,  z=%zu",
...
static ge::graphStatus BinaryCrossEntropyV2TilingFunc(gert::TilingContext* context)
{
    ...
    OP_CHECK_IF(
        memset_s(tiling, sizeof(BinaryCrossEntropyV2TilingData), 0, sizeof(BinaryCrossEntropyV2TilingData)) != EOK,
...
// tiling注册入口.
IMPL_OP_OPTILING(BinaryCrossEntropyV2)
    .Tiling(BinaryCrossEntropyV2TilingFunc)
    .TilingParse<BinaryCrossEntropyV2CompileInfo>(TilingParseForBinaryCrossEntropyV2);
} // namespace optiling
