...
{
    OP_CHECK_IF(context == nullptr || context->GetInputShape(0) == nullptr || context->GetInputDesc(0) == nullptr,
                OP_LOGE(context, "context or input is nullptr"), return ge::GRAPH_FAILED);
...
static ge::graphStatus L2LossTilingFunc(gert::TilingContext* context)
{
    ...
    OP_CHECK_IF(memset_s(tiling, sizeof(L2LossTilingData), 0, sizeof(L2LossTilingData)) != EOK,
    ...
    OP_CHECK_IF(shapeInfo.bigCoreDataNum > UINT32_MAX || shapeInfo.smallCoreDataNum > UINT32_MAX ||
                ...
                OP_LOGE(context, "tiling data overflow: shape too large for uint32_t"), return ge::GRAPH_FAILED);
