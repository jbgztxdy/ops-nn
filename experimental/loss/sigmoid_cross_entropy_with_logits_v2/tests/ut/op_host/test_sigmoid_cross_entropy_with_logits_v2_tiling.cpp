...
{
    std::string op_type("SigmoidCrossEntropyWithLogitsV2");
    ...
    gert::StorageShape targetShape = {{32, 64}, {32, 64}};
    gert::StorageShape weightShape = {{32, 64}, {32, 64}};
    gert::StorageShape posWeightShape = {{32, 64}, {32, 64}};
    gert::StorageShape lossShape = {{32, 64}, {32, 64}};

    auto holder = gert::TilingContextFaker()
                      .SetOpType("SigmoidCrossEntropyWithLogitsV2")
                      .NodeIoNum(4, 1)
                      .IrInstanceNum({1, 1, 1, 1})
                      .InputShapes({&predictShape, &targetShape, &weightShape, &posWeightShape})
