...
class KlDivLossGradTiling : public testing::Test {
protected:
    static void SetUpTestCase() { cout << "KlDivLossGradTiling SetUp" << endl; }

    static void TearDownTestCase() { cout << "KlDivLossGradTiling TearDown " << endl; }
};

TEST_F(KlDivLossGradTiling, kl_div_loss_grad_float32_success)
{
    ...
    struct KlDivLossGradTilingCompileInfo {};
    KlDivLossGradTilingCompileInfo compileInfo;
...
TEST_F(KlDivLossGradTiling, kl_div_loss_grad_float16_success)
{
    gert::StorageShape x1Shape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
    gert::StorageShape x2Shape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
    gert::StorageShape x3Shape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
...
TEST_F(KlDivLossGradTiling, kl_div_loss_grad_bf16_success)
{
    gert::StorageShape x1Shape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
    gert::StorageShape x2Shape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
    gert::StorageShape x3Shape = {{1, 2, 8, 16}, {1, 2, 8, 16}};
