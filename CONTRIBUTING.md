...
## 一、贡献新算子
  ...
  若需求被接纳，sig成员将为您分配合适的算子分类路径（如：`experimental/activation`），以便您将贡献的算子提交至对应目录。
  ...
  - 代码编译
  - 静态检查（如涉及codecheck误报，请提交给[sig成员](https://gitcode.com/cann/community/blob/master/CANN/sigs/ops-nn/sig-info.yaml)屏蔽）
  - UT测试
  - 冒烟测试
