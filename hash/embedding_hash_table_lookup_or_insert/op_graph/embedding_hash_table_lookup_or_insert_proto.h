 ...
 * @li filter_mode: Optional, string, set to "no_filter" or "counter", set "counter" to enable the counter-based filter
 *mode, set "no_filter" to disable the filter function. default is "no_filter".
 * @li filter_freq: Optional, int, filter threshold. default is 0.
 * @li default_key_or_value: Optional, bool, set true will return the value of default_key, set false will return
 *default_value. default is false.
 ...
 * @li filter_key_flag: Optional, bool, set true to enable filter_key, set false to disable the function of filter key.
 *default is false.
