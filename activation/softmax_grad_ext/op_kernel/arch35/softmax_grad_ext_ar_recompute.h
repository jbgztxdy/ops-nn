...
// 从UB搬到寄存器的同时转换数据类型
template <typename T>
__aicore__ inline void SoftmaxGradExtARRecompute<T>::LoadTensorForDtypeT(__local_mem__ T* src,
...
template <typename T>
__aicore__ inline void SoftmaxGradExtARRecompute<T>::StoreTensorForDtypeTOut(__local_mem__ T* dst,
