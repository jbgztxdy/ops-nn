...
static const std::initializer_list<op::DataType> DTYPE_SUPPORT_LIST_FP = {op::DataType::DT_FLOAT,
...
static bool CheckNotNull(const aclTensor* gradOutput, const aclTensor* self, const aclScalar* min, const aclScalar* max,
                         const aclTensor* out)
{
                                                  ...
                                                  uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    auto hardtanhBackwardOpOut = l0op::HardtanhGrad(gradOutputContiguous, selfContiguous, minValue, maxValue,
