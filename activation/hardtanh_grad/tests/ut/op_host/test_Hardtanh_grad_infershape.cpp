...
protected:
    static void SetUpTestCase() { std::cout << "HardtanhGradInfershapeTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "HardtanhGradInfershapeTest TearDown" << std::endl; }
};

TEST_F(HardtanhGradInfershapeTest, hardtanh_grad_infershape_diff_test)
{
    ge::op::HardtanhGrad op;
    auto tensor_desc = create_desc_shape_range({-1, 8, 375}, ge::DT_FLOAT, ge::FORMAT_ND, {16, 8, 375}, ge::FORMAT_ND,
                                               {{16, 16}, {8, 8}, {375, 375}});
...
{
    ge::op::HardtanhGrad op;
    auto tensor_desc1 = create_desc_shape_range({-1, 8, 35}, ge::DT_FLOAT16, ge::FORMAT_ND, {16, 8, 35}, ge::FORMAT_ND,
                                                {{16, 16}, {8, 8}, {35, 35}});
    auto tensor_desc2 = create_desc_shape_range({-1, 8, 35}, ge::DT_FLOAT, ge::FORMAT_ND, {16, 8, 35}, ge::FORMAT_ND,
                                                {{16, 16}, {8, 8}, {35, 35}});
