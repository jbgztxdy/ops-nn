...
protected:
    static void SetUpTestCase() { std::cout << "l2_hardtanh_backward_test SetUp" << std::endl; }
...
TEST_F(l2_hardtanh_backward_test, normal_dtype_float32_format_nd)
{
    ...
    auto ut = OP_API_UT(aclnnHardtanhBackward, INPUT(gradOutputDesc, selfDesc, minvalDesc, maxvalDesc),
                        OUTPUT(outDesc));
