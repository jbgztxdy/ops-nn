...
#include "../../../op_graph/gelu_grad_v2_proto.h"
...
TEST_F(GeluGradV2Test, gelu_grad_v2_infershape_950_test2)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    ...
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("GeluGradV2")->infer_shape;
    ...
    auto holder = gert::InferShapeContextFaker()
                      .NodeIoNum(2, 1)
                      .IrInstanceNum({1, 1})
                      .InputShapes({&input_shape_dy, &input_shape_x})
...
TEST_F(GeluGradV2Test, gelu_grad_v2_infershape_910_93)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(GeluGradV2Test, gelu_grad_v2_infershape_950_float16_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(GeluGradV2Test, gelu_grad_v2_infershape_950_bf16_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(GeluGradV2Test, gelu_grad_v2_infershape_950_4d_nchw_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(GeluGradV2Test, gelu_grad_v2_infershape_950_5d_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(GeluGradV2Test, gelu_grad_v2_infershape_950_empty_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(GeluGradV2Test, gelu_grad_v2_infershape_950_scalar_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(GeluGradV2Test, gelu_grad_v2_infershape_950_large_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
