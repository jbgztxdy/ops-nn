...
@register("aclnn_geglu_backward")
class AscendGeGluBackwardApi(BaseApi):
    ...
    def cdf(x):
        ...
        erf_res = AscendGeGluBackwardApi.erf_compute_with_simplified_formula(erf_input)
    ...
    def gelu_grad_erf(dy, x):
        cdf_res = AscendGeGluBackwardApi.cdf(x)
        pdf_res = AscendGeGluBackwardApi.pdf(x)
