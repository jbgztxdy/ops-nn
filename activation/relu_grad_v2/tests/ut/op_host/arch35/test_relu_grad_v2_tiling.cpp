...
#include "../../../../op_host/arch35/relu_grad_v2_tiling_arch35.h"

using namespace ut_util;
using namespace std;
using namespace ge;

class ReluGradV2TilingTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "ReluGradV2TilingTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ReluGradV2TilingTest TearDown" << std::endl; }
};
...
TEST_F(ReluGradV2TilingTest, test_relu_grad_v2_tiling_fp16_001)
{
...
TEST_F(ReluGradV2TilingTest, test_relu_grad_v2_tiling_bf16_001)
{
    fe::PlatFormInfos platFormInfo;
    map<string, string> socInfos;
    map<string, string> aicoreSpec;
