...
int RunSwigluGroupQuantCase(const SwigluGroupQuantCase& testCase, aclrtStream stream) {
  ...
  ret = aclnnSwigluGroupQuantGetWorkspaceSize(xResource.tensor, nullptr, nullptr, nullptr, dstType, testCase.quantMode,
                                              testCase.blockSize, testCase.roundScale, clampLimit, dstTypeMax,
                                              outputOrigin, yResource.tensor, yScaleResource.tensor,
