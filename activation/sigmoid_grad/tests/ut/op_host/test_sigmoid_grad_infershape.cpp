...
class SigmoidGradTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "SigmoidGradTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "SigmoidGradTest TearDown" << std::endl; }
};

TEST_F(SigmoidGradTest, sigmoid_grad_infershape_test_float16)
{
    ge::op::SigmoidGrad op;
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_test_float32)
{
    ge::op::SigmoidGrad op;
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_test_bf16)
{
    ge::op::SigmoidGrad op;
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_test_3d)
{
    ge::op::SigmoidGrad op;
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_test_4d_nchw)
{
    ge::op::SigmoidGrad op;
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_test_5d)
{
    ge::op::SigmoidGrad op;
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_test_empty)
{
    ge::op::SigmoidGrad op;
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_test_scalar)
{
    ge::op::SigmoidGrad op;
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_test_large)
{
    ge::op::SigmoidGrad op;
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_gert_test_float16)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("SigmoidGrad")->infer_shape;
    gert::Shape input_shape_y = {16, 16};
    gert::Shape input_shape_dy = {16, 16};
    gert::Shape output_shape = {};

    auto holder = gert::InferShapeContextFaker()
                      .NodeIoNum(2, 1)
                      .IrInstanceNum({1, 1})
                      .InputShapes({&input_shape_y, &input_shape_dy})
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_gert_test_float32)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("SigmoidGrad")->infer_shape;
...
TEST_F(SigmoidGradTest, sigmoid_grad_infershape_gert_test_bf16)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("SigmoidGrad")->infer_shape;
    gert::Shape input_shape_y = {64, 64};
    gert::Shape input_shape_dy = {64, 64};
    gert::Shape output_shape = {};
