...
#include "../../../../op_api/aclnn_softplus_backward.h"
...
TEST_F(l2_softplus_backward_test, grad_nullptr)
{
    ...
    auto ut = OP_API_UT(aclnnSoftplusBackward, INPUT((aclTensor*)nullptr, selfDesc, betaDesc, threholdDesc),
                        OUTPUT(outDesc));
...
TEST_F(l2_softplus_backward_test, self_nullptr)
{
    ...
    auto betaDesc = ScalarDesc(0.0f);
    auto threholdDesc = ScalarDesc(0.0f);
    auto ut = OP_API_UT(aclnnSoftplusBackward, INPUT(gradOutputDesc, (aclTensor*)nullptr, betaDesc, threholdDesc),
                        OUTPUT(outDesc));
