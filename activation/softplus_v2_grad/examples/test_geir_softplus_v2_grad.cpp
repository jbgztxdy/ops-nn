...
#define ADD_INPUT(intputIndex, intputName, intputDtype, inputShape)                                                 \
    ...
    softplusV2Grad1.set_input_##intputName(placeholder##intputIndex);                                               \
                     ...
                     std::vector<Operator>& outputs, Graph& graph)
{
    Status ret = SUCCESS;
    // 自定义代码：添加单算子定义到图中
    auto softplusV2Grad1 = op::SoftplusV2Grad("softplusV2Grad1");
    softplusV2Grad1.set_attr_beta(1.0f);
    softplusV2Grad1.set_attr_threshold(20.0f);
    std::vector<int64_t> xShape = {4, 2};
    ADD_INPUT(1, input_gradients, inDtype, xShape);
    ADD_INPUT(2, input_features, inDtype, xShape);

    outputs.push_back(softplusV2Grad1);
    // 添加完毕
    return SUCCESS;
}
