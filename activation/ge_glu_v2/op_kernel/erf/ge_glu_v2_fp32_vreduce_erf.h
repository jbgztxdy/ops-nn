...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduceErf<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR gelu, GM_ADDR workspace,
                                                      const GeGluV2TilingData* tilingData)
{
...
{
    // process core
    for (int64_t idx_4 = 0; idx_4 < this->m_tilingData.loopNum; idx_4++) {
        CopyInX(idx_4, this->m_tilingData.group);
        ComputeGeluAndMul(this->group_ub_num);
        CopyOutGelu(idx_4, this->group_ub_num, this->m_tilingData.group);
        CopyOutMul(idx_4, this->group_ub_num, this->m_tilingData.group);
    }
...
{
    for (int64_t idx_4 = 0; idx_4 < this->m_tilingData.tailLoopNum; idx_4++) {
        CopyInX(idx_4, this->m_tilingData.group);
        ComputeGeluAndMul(this->group_ub_num);
        CopyOutGelu(idx_4, this->group_ub_num, this->m_tilingData.group);
        CopyOutMul(idx_4, this->group_ub_num, this->m_tilingData.group);
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduceErf<T>::CopyOutGelu(const int64_t& index, const int64_t& ub_num,
                                                             const int64_t& group)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduceErf<T>::CopyOutMul(const int64_t& index, const int64_t& ub_num,
                                                            const int64_t& group)
{
