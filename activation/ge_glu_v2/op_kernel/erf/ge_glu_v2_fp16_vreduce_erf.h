...
template <typename T>
__aicore__ inline void GeGluV2Fp16VReduceErf<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR gelu, GM_ADDR workspace,
                                                      const GeGluV2TilingData* tilingData)
{
...
{
    // process core
    for (int64_t idx_2 = 0; idx_2 < this->m_tilingData.loopNum; idx_2++) {
        CopyInX(idx_2, this->m_tilingData.group);
        ComputeGeluAndMul(this->group_ub_num);
        CopyOutGelu(idx_2, this->group_ub_num, this->m_tilingData.group);
        CopyOutMul(idx_2, this->group_ub_num, this->m_tilingData.group);
    }
...
{
    for (int64_t idx_2 = 0; idx_2 < this->m_tilingData.tailLoopNum; idx_2++) {
        CopyInX(idx_2, this->m_tilingData.group);
        ComputeGeluAndMul(this->group_ub_num);
        CopyOutGelu(idx_2, this->group_ub_num, this->m_tilingData.group);
        CopyOutMul(idx_2, this->group_ub_num, this->m_tilingData.group);
...
template <typename T>
__aicore__ inline void GeGluV2Fp16VReduceErf<T>::CopyOutGelu(const int64_t& index, const int64_t& ub_num,
                                                             const int64_t& group)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp16VReduceErf<T>::CopyOutMul(const int64_t& index, const int64_t& ub_num,
                                                            const int64_t& group)
{
