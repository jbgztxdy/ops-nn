...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR gelu, GM_ADDR workspace,
                                                   const GeGluV2TilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::CopyOutGelu(const int64_t& index, const int64_t& ub_num,
                                                          const int64_t& group)
{
...
template <typename T>
__aicore__ inline void GeGluV2Fp32VReduce<T>::CopyOutMul(const int64_t& index, const int64_t& ub_num,
                                                         const int64_t& group)
{
