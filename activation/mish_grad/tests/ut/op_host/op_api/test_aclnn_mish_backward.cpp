...
#include "../../../../op_api/aclnn_mish_backward.h"
...
// 测试正常路径，8维
TEST_F(l2_mish_backward_test, case_012_8d_shape)
{
...
// 测试正常路径，scalar
TEST_F(l2_mish_backward_test, case_013_scalar)
{
    ...
    auto gradInputDesc = TensorDesc({}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.0001, 0.0001);
...
// 测试正常路径，large shape
TEST_F(l2_mish_backward_test, case_014_large_shape)
{
    ...
    auto gradInputDesc = TensorDesc({1024, 1024}, ACL_FLOAT16, ACL_FORMAT_ND).Precision(0.0001, 0.0001);
...
// 测试正常路径，4d nchw
TEST_F(l2_mish_backward_test, case_015_nchw_format)
{
    ...
    auto gradInputDesc = TensorDesc({2, 64, 112, 112}, ACL_FLOAT16, ACL_FORMAT_NCHW).Precision(0.0001, 0.0001);
...
// 测试正常路径，value range
TEST_F(l2_mish_backward_test, case_016_value_range)
{
