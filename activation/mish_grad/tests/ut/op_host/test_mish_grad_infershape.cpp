...
#include "../../../op_graph/mish_grad_proto.h"

using namespace ge;

class MishGradTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "MishGradTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "MishGradTest TearDown" << std::endl; }
};

TEST_F(MishGradTest, mish_grad_infershape_test_float16)
{
    ge::op::MishGrad op;
...
TEST_F(MishGradTest, mish_grad_infershape_test_float32)
{
    ge::op::MishGrad op;
...
TEST_F(MishGradTest, mish_grad_infershape_test_bf16)
{
    ge::op::MishGrad op;
...
TEST_F(MishGradTest, mish_grad_infershape_test_3d)
{
    ge::op::MishGrad op;
...
TEST_F(MishGradTest, mish_grad_infershape_test_4d_nchw)
{
    ge::op::MishGrad op;
...
TEST_F(MishGradTest, mish_grad_infershape_test_5d)
{
    ge::op::MishGrad op;
...
TEST_F(MishGradTest, mish_grad_infershape_test_empty)
{
    ge::op::MishGrad op;
...
TEST_F(MishGradTest, mish_grad_infershape_test_scalar)
{
    ge::op::MishGrad op;
...
TEST_F(MishGradTest, mish_grad_infershape_test_large)
{
    ge::op::MishGrad op;
...
TEST_F(MishGradTest, mish_grad_infershape_gert_test_float16)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("MishGrad")->infer_shape;
    gert::Shape input_shape_grad = {16, 16};
    ...
    auto holder = gert::InferShapeContextFaker()
                      .NodeIoNum(2, 1)
                      .IrInstanceNum({1, 1})
                      .InputShapes({&input_shape_grad, &input_shape_x})
...
TEST_F(MishGradTest, mish_grad_infershape_gert_test_float32)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("MishGrad")->infer_shape;
    gert::Shape input_shape_grad = {32, 64, 128};
...
TEST_F(MishGradTest, mish_grad_infershape_gert_test_bf16)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("MishGrad")->infer_shape;
    gert::Shape input_shape_grad = {64, 64};
    gert::Shape input_shape_x = {64, 64};
    gert::Shape output_shape = {};
...
TEST_F(MishGradTest, mish_grad_infershape_gert_test_with_tanhx)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("MishGrad")->infer_shape;
    gert::Shape input_shape_grad = {16, 16};
    gert::Shape input_shape_x = {16, 16};
    gert::Shape input_shape_tanhx = {16, 16};
    gert::Shape output_shape = {};

    auto holder = gert::InferShapeContextFaker()
                      .NodeIoNum(3, 1)
                      .IrInstanceNum({1, 1, 1})
                      .InputShapes({&input_shape_grad, &input_shape_x, &input_shape_tanhx})
                      .OutputShapes({&output_shape})
                      .NodeInputTd(0, ge::DT_FLOAT16, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeInputTd(1, ge::DT_FLOAT16, ge::FORMAT_ND, ge::FORMAT_ND)
