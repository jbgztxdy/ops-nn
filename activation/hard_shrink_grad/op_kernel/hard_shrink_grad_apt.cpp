...
/*!
 * \file hard_shrink_grad_apt.cpp
 * \brief HardShrinkGrad kernel entry (arch35)
 *
 * Template parameters (matching hard_shrink_grad_tiling_key.h):
    ...
    GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    NsHardShrinkGrad::HardShrinkGrad<D_T_X, BUFFER_MODE> op;
    op.Init(selfGrad, self, out, &tilingData);
    op.Process();
}
