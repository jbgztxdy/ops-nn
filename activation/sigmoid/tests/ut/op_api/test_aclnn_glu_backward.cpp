...
protected:
    static void SetUpTestCase() { std::cout << "glu_backward_tensor_test SetUp" << std::endl; }
...
TEST_F(l2_glu_backward_test, test_glu_backward_normal_self_double_8dim_tensor)
{
    ...
    int64_t dim = 0;
    auto out_tensor_desc = TensorDesc({12, 6, 12, 6, 15, 5, 8, 12}, ACL_DOUBLE, ACL_FORMAT_ND)
