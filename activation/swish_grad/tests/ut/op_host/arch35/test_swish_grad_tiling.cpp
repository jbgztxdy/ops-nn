...
#include "../../../../op_host/arch35/swish_grad_tiling_arch35.h"
...
TEST_F(SwishGradTiling, test0_swish_grad_tiling)
{
    ...
    // 定义操作符和输入性状
    gert::StorageShape gradShape = {{2, 9}, {2, 9}};
    gert::StorageShape xShape = {{2, 9}, {2, 9}};
    gert::StorageShape yShape = {{2, 9}, {2, 9}};
    gert::StorageShape gradXShape = {{}, {}};
    ...
    EXPECT_EQ(tiling_func(tiling_context), 4294967295);
}