...
# Please refer to the License for details. You may not use this file in in the License.
...
def gen_golden_data_simple(shape_str, dtype):
    ...
    sigmoid = 1 / (1 + torch.exp(-scale * x_torch))
    golden = grad_torch * sigmoid * (1 + x_torch * scale * (1 - sigmoid))
