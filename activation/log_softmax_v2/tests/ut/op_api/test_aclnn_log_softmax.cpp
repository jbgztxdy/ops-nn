...
#include "../../../op_api/aclnn_logsoftmax.h"
...
class l2_log_softmax_test : public testing::Test {
  protected:
...
TEST_F(l2_log_softmax_test, case_000_workspace) {
...
TEST_F(l2_log_softmax_test, case_001_float32_normal) {
...
TEST_F(l2_log_softmax_test, case_002_float16_normal) {
...
TEST_F(l2_log_softmax_test, case_003_double_normal) {
...
TEST_F(l2_log_softmax_test, case_008_1_dim_input_tensor) {
...
TEST_F(l2_log_softmax_test, case_009_3_dim_input_tensor) {
...
TEST_F(l2_log_softmax_test, case_010_5_dim_input_tensor) {
...
TEST_F(l2_log_softmax_test, case_011_8_dim_input_tensor) {
...
TEST_F(l2_log_softmax_test, case_012_dim_coverage1) {
  auto selfTensor = TensorDesc({1, 2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND);
  auto outTensor = TensorDesc({1, 2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
  int64_t dim = 4;
  auto ut = OP_API_UT(aclnnLogSoftmax, INPUT(selfTensor, dim), OUTPUT(outTensor));
...
TEST_F(l2_log_softmax_test, case_013_dim_coverage2) {
  auto selfTensor = TensorDesc({1, 2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND);
  auto outTensor = TensorDesc({1, 2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
  int64_t dim = -5;
  auto ut = OP_API_UT(aclnnLogSoftmax, INPUT(selfTensor, dim), OUTPUT(outTensor));
...
TEST_F(l2_log_softmax_test, case_014_NHWC) {
...
TEST_F(l2_log_softmax_test, case_015_NCHW) {
...
TEST_F(l2_log_softmax_test, case_016_HWCN) {
...
TEST_F(l2_log_softmax_test, case_017_NDHWC) {
...
TEST_F(l2_log_softmax_test, case_018_NCDHW) {
...
TEST_F(l2_log_softmax_test, case_019_invalid_dtype) {
...
TEST_F(l2_log_softmax_test, case_020_invalid_shape) {
  auto selfTensor = TensorDesc({1, 2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_log_softmax_test, case_021_invalid_dim) {
  auto selfTensor = TensorDesc({1, 2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND);
  auto outTensor = TensorDesc({1, 2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
  int64_t dim = 9;
  auto ut = OP_API_UT(aclnnLogSoftmax, INPUT(selfTensor, dim), OUTPUT(outTensor));
...
TEST_F(l2_log_softmax_test, case_023_empty_tensor) {
...
TEST_F(l2_log_softmax_test, case_024_uncontiguous) {
...
TEST_F(l2_log_softmax_test, case_025_nullptr) {
  auto selfTensor = TensorDesc({1, 2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND);
...
TEST_F(l2_log_softmax_test, case_026_9_dim_input_tensor) {
...
TEST_F(l2_log_softmax_test, case_027_0_dim_input_tensor) {
...
TEST_F(l2_log_softmax_test, ascend910B2_case_BF16_910b) {
