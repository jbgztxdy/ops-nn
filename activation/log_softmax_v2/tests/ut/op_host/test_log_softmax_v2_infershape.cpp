...
TEST_F(log_softmax_v2, infer_axis_type_test_01) {
    ...
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("LogSoftmaxV2")->infer_shape;
    gert::Shape xShape = {6, 7, 8, 9};
    gert::Shape outputShape = {6, 7, 8, 9};
    ...
    gert::Shape expectedOutputShape = {6, 7, 8, 9};
