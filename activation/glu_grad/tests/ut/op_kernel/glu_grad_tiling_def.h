 ...
 */
#ifndef _GLU_GRAD_TILING_DEF_H_
#define _GLU_GRAD_TILING_DEF_H_
...
#define DTYPE_Y_GRAD DT_FP32
#define ORIG_DTYPE_START DT_BF16
#define __CCE_UT_TEST__

#pragma pack(1)

struct GluGradTilingData {
    int64_t group;
    int64_t loopNum;
    int64_t tailLoopNum;
...
#define GET_TILING_DATA(tilingData, tilingPointer)                         \
    ...
    INIT_TILING_DATA(GluGradTilingData, tilingDataPointer, tilingPointer); \
