...
TEST_F(SiluGrad, siluGrad_fp16_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(SiluGrad, siluGrad_4d_nchw_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
    ...
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("SiluGrad")->infer_shape;
    gert::Shape dyShape = {2, 64, 112, 112};
...
TEST_F(SiluGrad, siluGrad_8d_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
    ...
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("SiluGrad")->infer_shape;
    gert::Shape dyShape = {1, 2, 3, 4, 5, 6, 7, 8};
...
TEST_F(SiluGrad, siluGrad_empty_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(SiluGrad, siluGrad_scalar_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(SiluGrad, siluGrad_large_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
