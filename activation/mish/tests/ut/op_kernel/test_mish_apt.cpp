...
protected:
    static void SetUpTestCase() { cout << "mish_test SetUp\n" << endl; }
    static void TearDownTestCase()
    {
        cout << "mish TearDown\n" << endl;
        kernel_ut::CleanGeneratedBinFiles("./mish_data");
    }
};
...
TEST_F(mish_test, test_case_fp32_1)
{
    ...
    uint32_t blockDim = 1;
    kernel_ut::SetupTestEnvironment("activation/mish/tests/ut/op_kernel/mish_data", "mish_data");
    kernel_ut::RunGenData("./mish_data", {"'(256)'", "float32"});
