...
public:
    ...
    __aicore__ inline void Init(GM_ADDR gradOutput, GM_ADDR self,
        GM_ADDR gradInput, const HardSwishGradV2Arch35TilingData* tilingData);
...
template <typename T, int BUFFER_MODE>
__aicore__ inline void HardSwishGradV2<T, BUFFER_MODE>::Init(
...
template <typename T, int BUFFER_MODE>
__aicore__ inline void HardSwishGradV2<T, BUFFER_MODE>::CopyIn(
...
template <typename T, int BUFFER_MODE>
__aicore__ inline void HardSwishGradV2<T, BUFFER_MODE>::Compute(
    int64_t currentNum)
{
...
template <typename T, int BUFFER_MODE>
__aicore__ inline void HardSwishGradV2<T, BUFFER_MODE>::CopyOut(
    int64_t progress, int64_t currentNum)
{
