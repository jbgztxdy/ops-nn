...
// 正常路径，8维
TEST_F(swish_test, test_swish_8d_shape)
{
    auto inputDesc = TensorDesc({1, 2, 3, 4, 5, 6, 7, 8}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto betaDesc = ScalarDesc(1.1f, ACL_FLOAT);
...
// 正常路径，scalar
TEST_F(swish_test, test_swish_scalar)
{
    auto inputDesc = TensorDesc({}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto betaDesc = ScalarDesc(1.1f, ACL_FLOAT);
...
// 正常路径，large shape
TEST_F(swish_test, test_swish_large_shape)
{
    auto inputDesc = TensorDesc({1024, 1024}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto betaDesc = ScalarDesc(1.1f, ACL_FLOAT);
...
// 正常路径，nchw
TEST_F(swish_test, test_swish_nchw_format)
{
    auto inputDesc = TensorDesc({2, 64, 112, 112}, ACL_FLOAT16, ACL_FORMAT_NCHW).ValueRange(-1, 1);
...
// 正常路径，value range
TEST_F(swish_test, test_swish_value_range)
{
    auto inputDesc = TensorDesc({2, 4, 6, 8}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-100, 100);
    auto betaDesc = ScalarDesc(1.1f, ACL_FLOAT);
