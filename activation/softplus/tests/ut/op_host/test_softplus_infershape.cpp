...
protected:
    static void SetUpTestCase() { std::cout << "SoftplusInfershapeTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "SoftplusInfershapeTest TearDown" << std::endl; }
};
