...
ASCENDC_TPL_ARGS_DECL(HardSwish, ASCENDC_TPL_UINT_DECL(schMode, 2, ASCENDC_TPL_UI_LIST, HARDSWISH_TPL_SCH_MODE_FP32,
                                                       HARDSWISH_TPL_SCH_MODE_FP16, HARDSWISH_TPL_SCH_MODE_BF16));

ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, HARDSWISH_TPL_SCH_MODE_FP32,
                                                          HARDSWISH_TPL_SCH_MODE_FP16, HARDSWISH_TPL_SCH_MODE_BF16)));
