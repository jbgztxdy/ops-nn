...
TEST_F(TEST_ELU_UT, TestElu_double_comparewith_tf)
{
    ...
    double input[6] = {-4.951530312134153,  0.6762052328103874,  5.362240961653322,
                       -1.3938825500140126, -3.1986461909792396, 4.301564834639343};
    double output[6] = {0};
    ...
    double output_exp[6] = {-0.9929274226076533, 0.6762052328103874,  5.362240961653322,
                            -0.7518898678182324, -0.9591825744108585, 4.301564834639343};
