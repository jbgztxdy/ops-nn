...
// 算子自定义的tiling key字段
ASCENDC_TPL_ARGS_DECL(ReluGrad, BRC_TEMP_SCH_MODE_KEY_DECL(schMode),
                      ASCENDC_TPL_DTYPE_DECL(dType, RELU_GRAD_TPL_FP16, RELU_GRAD_TPL_BF16, RELU_GRAD_TPL_FP32,
                                             RELU_GRAD_TPL_INT8, RELU_GRAD_TPL_UINT8, RELU_GRAD_TPL_INT32,
                                             RELU_GRAD_TPL_INT64));

ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(BRC_TEMP_SCH_MODE_KEY_SEL(schMode),
                                     ASCENDC_TPL_DTYPE_SEL(dType, RELU_GRAD_TPL_FP16, RELU_GRAD_TPL_BF16,
                                                           RELU_GRAD_TPL_FP32, RELU_GRAD_TPL_INT8, RELU_GRAD_TPL_UINT8,
