...
TEST_F(relu_grad_test, test_case_fp32_1)
{
    ...
    uint32_t blockDim = 1;
    system("cp -r ../../../../activation/relu_grad/tests/ut/op_kernel/relu_grad_data ./");
    system("chmod -R 755 ./relu_grad_data/");
    system("cd ./relu_grad_data/ && rm -rf ./*bin");
    system("cd ./relu_grad_data/ && python3 gen_data.py '(256)' float32");
