 ...
 * FITNESS FOR A PARTICULAR PURPOSE. See LICENSE in the root of the software repository for the full
 * text of the License.
 */

/*!
 * \file glu_apt.cpp
 * \brief Ascend950 (arch35) GLU kernel implementation
 */
#include "arch35/glu_big_shape.h"
#include "arch35/glu_small_shape.h"
#include "arch35/glu_single_shape.h"
