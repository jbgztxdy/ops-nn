...
__aicore__ inline void SoftsignGrad<T, BUFFER_MODE>::CopyIn(int64_t progress, int64_t currentNum)
{
    ...
    AscendC::DataCopyPad(gradLocal, gradientsGm[progress * ubLength_], copyParams, padParams);
    AscendC::DataCopyPad(featLocal, featuresGm[progress * ubLength_], copyParams, padParams);
