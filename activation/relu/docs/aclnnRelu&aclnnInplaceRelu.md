...
- 算子功能：激活函数，返回与输入tensor shape相同的tensor, tensor中value大于等于0时，取值该value，小于0，取0。
- 计算公式：
$$
...
- 每个算子分为[两段式接口](../../../docs/context/两段式接口.md)，必须先调用“aclnnReluGetWorkspaceSize”或者“aclnnInplaceReluGetWorkspaceSize”接口获取入参并根据计算流程计算所需workspace大小，再调用“aclnnRelu”或者“aclnnInplaceRelu”接口执行计算。
