...
class l2_inplace_add_relu_test : public testing::Test {
 protected:
  static void SetUpTestCase() {
    std::cout << "inplace_add_relu_test SetUp" << std::endl;
  }

  static void TearDownTestCase() {
    std::cout << "inplace_add_relu_test TearDown" << std::endl;
  }
};
...
TEST_F(l2_inplace_add_relu_test, case_nullptr) {
  ...
  auto ut = OP_API_UT(aclnnInplaceAddRelu, INPUT((aclTensor*)nullptr, (aclTensor*)nullptr, (aclScalar*)nullptr), OUTPUT());
