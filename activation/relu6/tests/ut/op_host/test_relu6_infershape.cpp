...
#include "../../../op_graph/relu6_proto.h"
...
TEST_F(Relu6ProtoTest, relu6_infershape_float16_test)
{
    ...
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("Relu6")->infer_shape;
...
TEST_F(Relu6ProtoTest, relu6_infershape_float_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(Relu6ProtoTest, relu6_infershape_int32_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(Relu6ProtoTest, relu6_infershape_bf16_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(Relu6ProtoTest, relu6_infershape_scalar_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(Relu6ProtoTest, relu6_infershape_empty_test)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
