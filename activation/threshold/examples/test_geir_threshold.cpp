...
/*!
 * \file test_geir_threshold.cpp
 * \brief GE IR graph mode call example for threshold
 */
...
#include "nn_other.h"
#include "../op_graph/threshold_proto.h"
...
{
    Status ret = SUCCESS;
    // Custom code: add single operator definition to graph
    auto add1 = op::Threshold("add1");
    std::vector<int64_t> xShape = {32, 4, 4, 4};
    ADD_INPUT(1, x, inDtype, xShape);

    // Set threshold attribute
    add1.set_attr("threshold", ge::AttrValue::CreateFrom<AttrValue::FLOAT>(0.0f));
