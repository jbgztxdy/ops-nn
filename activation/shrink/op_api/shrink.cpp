...
// AICORE算子kernel
static inline const aclTensor* ShrinkAiCore(const aclTensor* input, float lambd, float bias, aclTensor* output,
                                            aclOpExecutor* executor)
{
    ...
    OP_CHECK(ret == ACLNN_SUCCESS, OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "ShrinkAiCore ADD_TO_LAUNCHER_LIST_AICORE failed."),
             return nullptr);
    return output;
}
