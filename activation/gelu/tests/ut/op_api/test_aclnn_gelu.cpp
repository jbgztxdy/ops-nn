...
#include "../../../op_api/aclnn_gelu.h"
#include "op_api_ut_common/tensor_desc.h"
#include "op_api_ut_common/op_api_ut.h"

class l2GeluTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "l2GeluTest SetUp" << std::endl; }
...
TEST_F(l2GeluTest, l2_gelu_test_008)
{
    ...
    auto outDesc = TensorDesc({2, 4, 6, 7}, ACL_FLOAT, ACL_FORMAT_NHWC).Precision(0.01, 0.01);
...
TEST_F(l2GeluTest, l2_gelu_test_009)
{
    ...
    auto outDesc = TensorDesc({2, 4, 6, 7, 8}, ACL_FLOAT16, ACL_FORMAT_NCDHW).Precision(0.01, 0.01);
...
TEST_F(l2GeluTest, l2_gelu_test_010)
{
    ...
    auto outDesc = TensorDesc({2, 4, 6, 8}, ACL_FLOAT, ACL_FORMAT_HWCN).Precision(0.01, 0.01);
...
TEST_F(l2GeluTest, l2_gelu_test_013)
{
    ...
    auto outDesc = TensorDesc({2, 4, 6, 8}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.01, 0.01);
...
TEST_F(l2GeluTest, l2_gelu_test_014)
{
    ...
    auto outDesc = TensorDesc({2, 4, 6, 8, 4, 5}, ACL_FLOAT16, ACL_FORMAT_ND).Precision(0.01, 0.01);
...
{
    auto selfDesc = TensorDesc({2, 4, 6, 8, 4, 5}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto outDesc = TensorDesc({2, 4, 6, 8, 4, 5}, ACL_FLOAT16, ACL_FORMAT_ND).Precision(0.01, 0.01);
...
{
    auto selfDesc = TensorDesc({2, 4, 6, 8, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto outDesc = TensorDesc({2, 4, 6, 8, 4, 5}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.01, 0.01);
