...
#include "../../../op_graph/logsigmoid_grad_proto.h"
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_test_float32)
{
    ge::op::LogSigmoidGrad op;
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_test_bf16)
{
    ge::op::LogSigmoidGrad op;
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_test_3d)
{
    ge::op::LogSigmoidGrad op;
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_test_4d_nchw)
{
    ge::op::LogSigmoidGrad op;
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_test_5d)
{
    ge::op::LogSigmoidGrad op;
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_test_empty)
{
    ge::op::LogSigmoidGrad op;
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_test_scalar)
{
    ge::op::LogSigmoidGrad op;
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_test_large)
{
    ge::op::LogSigmoidGrad op;
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_gert_test_float16)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("LogSigmoidGrad")->infer_shape;
    gert::Shape input_shape_grads = {16, 16};
    ...
    auto holder = gert::InferShapeContextFaker()
                      .NodeIoNum(2, 1)
                      .IrInstanceNum({1, 1})
                      .InputShapes({&input_shape_grads, &input_shape_features})
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_gert_test_float32)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("LogSigmoidGrad")->infer_shape;
    gert::Shape input_shape_grads = {32, 64, 128};
...
TEST_F(LogSigmoidGradTest, logsigmoid_grad_infershape_gert_test_bf16)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("LogSigmoidGrad")->infer_shape;
    gert::Shape input_shape_grads = {64, 64};
