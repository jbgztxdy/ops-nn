...
REGISTER_CUSTOM_OP("SoftmaxV2")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::8::Softmax"), ge::AscendString("ai.onnx::9::Softmax"),
                   ge::AscendString("ai.onnx::10::Softmax"), ge::AscendString("ai.onnx::11::Softmax"),
...
REGISTER_CUSTOM_OP("SoftmaxV2")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::13::Softmax"), ge::AscendString("ai.onnx::14::Softmax"),
                   ge::AscendString("ai.onnx::15::Softmax"), ge::AscendString("ai.onnx::16::Softmax"),
                   ge::AscendString("ai.onnx::17::Softmax"), ge::AscendString("ai.onnx::18::Softmax")})
