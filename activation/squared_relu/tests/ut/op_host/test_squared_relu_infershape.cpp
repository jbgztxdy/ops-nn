...
protected:
    static void SetUpTestCase() { std::cout << "SquaredRelu SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "SquaredRelu TearDown" << std::endl; }
};
...
TEST_F(SquaredRelu, SquaredRelu_infershape_case_6_dynamic)
{
    ...
    auto input_tensor = create_desc_shape_range({-1, -1}, ge::DT_FLOAT, ge::FORMAT_ND, {16, 16}, ge::FORMAT_ND,
                                                shape_range);
