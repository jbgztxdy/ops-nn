...
void TestEluGradTilingTest(const ge::DataType Dtype, const int tiling_key_, const string& tiling_data_target)
{
...
{
    TestEluGradTilingTest(ge::DT_FLOAT16, 3, "8192 26388279066626 4096 2 1 1 4096 4096 6144 1 ");
}

TEST_F(EluGradTilingTest, test_tiling_bf16_002)
{
    TestEluGradTilingTest(ge::DT_BF16, 5, "8192 26388279066626 4096 2 1 1 4096 4096 6144 1 ");
}

TEST_F(EluGradTilingTest, test_tiling_fp32_003)
{
    TestEluGradTilingTest(ge::DT_FLOAT, 7, "8192 28587302322178 4096 2 1 1 4096 4096 6656 1 ");
}
...
TEST_F(EluGradTilingTest, test_tiling_failed_inputs_dtype_diff_005)
{
    ...
    TestEluGradTilingTestFailed(shape, shape, shape, InDtype0, InDtype1, OutDtype);
}
...
TEST_F(EluGradTilingTest, test_tiling_fp16_large_shape_010)
{
    std::string op_type("EluGrad");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(EluGradTilingTest, test_tiling_fp32_1d_011)
{
    std::string op_type("EluGrad");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
