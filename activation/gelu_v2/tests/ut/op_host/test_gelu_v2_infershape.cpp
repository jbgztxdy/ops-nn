...
#include "../../../op_graph/gelu_v2_proto.h"

using namespace ge;

class GeluV2Test : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "GeluV2Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "GeluV2Test TearDown" << std::endl; }
};

TEST_F(GeluV2Test, gelu_v2_infershape_test_float16)
{
    ge::op::GeluV2 op;
...
TEST_F(GeluV2Test, gelu_v2_infershape_test_float32)
{
    ge::op::GeluV2 op;
...
TEST_F(GeluV2Test, gelu_v2_infershape_test_bf16)
{
    ge::op::GeluV2 op;
...
TEST_F(GeluV2Test, gelu_v2_infershape_test_3d)
{
    ge::op::GeluV2 op;
...
TEST_F(GeluV2Test, gelu_v2_infershape_test_4d_nchw)
{
    ge::op::GeluV2 op;
...
TEST_F(GeluV2Test, gelu_v2_infershape_test_5d)
{
    ge::op::GeluV2 op;
...
TEST_F(GeluV2Test, gelu_v2_infershape_test_empty)
{
    ge::op::GeluV2 op;
...
TEST_F(GeluV2Test, gelu_v2_infershape_test_scalar)
{
    ge::op::GeluV2 op;
...
TEST_F(GeluV2Test, gelu_v2_infershape_test_large)
{
    ge::op::GeluV2 op;
...
TEST_F(GeluV2Test, gelu_v2_infershape_gert_test_float16)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("GeluV2")->infer_shape;
...
TEST_F(GeluV2Test, gelu_v2_infershape_gert_test_float32)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("GeluV2")->infer_shape;
...
TEST_F(GeluV2Test, gelu_v2_infershape_gert_test_bf16)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("GeluV2")->infer_shape;
