...
int main()
{
    ...
    ret = aclnnRReluWithNoiseGetWorkspaceSize(self, noise, lower, upper, training, seed, offset, out, &workspaceSize,
                                              &executor);
    ...
    ret = aclnnInplaceRReluWithNoiseGetWorkspaceSize(self, noise, lower, upper, training, seed, offset, &workspaceSize,
                                                     &executor);
