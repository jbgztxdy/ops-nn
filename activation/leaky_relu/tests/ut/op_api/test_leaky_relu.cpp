...
TEST_F(l2_leaky_relu_test, case_large_shape)
{
...
TEST_F(l2_leaky_relu_test, case_negative_slope)
{
...
TEST_F(l2_leaky_relu_test, case_scalar_input)
{
...
TEST_F(l2_leaky_relu_test, case_different_negative_slope)
{
    auto tensor_desc = TensorDesc({2, 3, 4}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto scalar_desc = ScalarDesc(0.5f);
...
TEST_F(l2_leaky_relu_test, case_1d_large)
{
    auto tensor_desc = TensorDesc({2048}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto scalar_desc = ScalarDesc(0.01f, ACL_FLOAT16);
...
TEST_F(l2_leaky_relu_test, inplace_case_large_shape)
{
    auto tensor_desc = TensorDesc({1024, 1024}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto scalar_desc = ScalarDesc(0.01f);
...
TEST_F(l2_leaky_relu_test, inplace_case_negative_slope)
{
    auto tensor_desc = TensorDesc({2, 3}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto scalar_desc = ScalarDesc(-0.1f);
...
TEST_F(l2_leaky_relu_test, inplace_case_scalar)
{
    auto tensor_desc = TensorDesc({}, ACL_FLOAT, ACL_FORMAT_ND);
    auto scalar_desc = ScalarDesc(0.01f);
...
TEST_F(l2_leaky_relu_test, inplace_case_bf16)
{
    auto tensor_desc = TensorDesc({2, 3}, ACL_BF16, ACL_FORMAT_ND).ValueRange(-1, 1);
    auto scalar_desc = ScalarDesc(0.01f);
