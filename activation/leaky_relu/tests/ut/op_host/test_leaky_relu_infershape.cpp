...
#include "../../../op_graph/leaky_relu_proto.h"

using namespace ge;

class LeakyReluTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "LeakyReluTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "LeakyReluTest TearDown" << std::endl; }
};

TEST_F(LeakyReluTest, leaky_relu_infershape_test_float16)
{
    ge::op::LeakyRelu op;
...
TEST_F(LeakyReluTest, leaky_relu_infershape_test_float32)
{
    ge::op::LeakyRelu op;
...
TEST_F(LeakyReluTest, leaky_relu_infershape_test_bf16)
{
    ge::op::LeakyRelu op;

    std::vector<std::pair<int64_t, int64_t>> shape_range = {{1, 64}, {1, 64}};
    auto input_tensor = create_desc_shape_range({-1, -1}, ge::DT_BF16, ge::FORMAT_ND, {64, 64}, ge::FORMAT_ND,
                                                shape_range);
    op.UpdateInputDesc("x", input_tensor);
    EXPECT_EQ(InferShapeTest(op), ge::GRAPH_SUCCESS);
...
TEST_F(LeakyReluTest, leaky_relu_infershape_test_3d)
{
    ge::op::LeakyRelu op;
...
TEST_F(LeakyReluTest, leaky_relu_infershape_test_4d_nchw)
{
    ge::op::LeakyRelu op;
...
TEST_F(LeakyReluTest, leaky_relu_infershape_test_5d)
{
    ge::op::LeakyRelu op;
...
TEST_F(LeakyReluTest, leaky_relu_infershape_test_empty)
{
    ge::op::LeakyRelu op;
...
TEST_F(LeakyReluTest, leaky_relu_infershape_test_scalar)
{
    ge::op::LeakyRelu op;
...
TEST_F(LeakyReluTest, leaky_relu_infershape_test_large)
{
    ge::op::LeakyRelu op;
...
TEST_F(LeakyReluTest, leaky_relu_infershape_gert_test_float16)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("LeakyRelu")->infer_shape;
...
TEST_F(LeakyReluTest, leaky_relu_infershape_gert_test_float32)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("LeakyRelu")->infer_shape;
...
TEST_F(LeakyReluTest, leaky_relu_infershape_gert_test_bf16)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("LeakyRelu")->infer_shape;
