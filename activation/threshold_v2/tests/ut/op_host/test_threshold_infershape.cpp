...
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("ThresholdV2")->infer_shape;
    gert::StorageShape Shape = {{3, 5}, {3, 5}};
    ...
    gert::Shape expected_output_shape = {3, 5};
