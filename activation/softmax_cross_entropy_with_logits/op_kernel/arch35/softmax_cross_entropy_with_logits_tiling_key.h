...
// template <uint64_t schId, uint64_t featuresBrc, uint64_t featuresBrcDim, uint64_t labelsBrc, uint64_t labelsBrcDim,
// uint64_t db>
...
#define SOFTMAX_CROSS_ENTROPY_WITH_LOGITS_TPL_KEY_DECL()                                                              \
    ASCENDC_TPL_UINT_DECL(schId, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, 0, 1,                                         \
                          SOFTMAX_CROSS_ENTROPY_WITH_LOGITS_MODE_2),                                                  \
        ...
        ASCENDC_TPL_UINT_DECL(labelsBrc, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST,                                       \
                              SOFTMAX_CROSS_ENTROPY_WITH_LOGITS_MODE_0, 1, SOFTMAX_CROSS_ENTROPY_WITH_LOGITS_MODE_2), \
        ASCENDC_TPL_UINT_DECL(db, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, SOFTMAX_CROSS_ENTROPY_WITH_LOGITS_MODE_0, 1)
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(SOFTMAX_CROSS_ENTROPY_WITH_LOGITS_TPL_FULLLOAD_KEY_SEL()),
