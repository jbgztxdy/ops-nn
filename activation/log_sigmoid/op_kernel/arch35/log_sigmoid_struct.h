...
ASCENDC_TPL_ARGS_DECL(LogSigmoid,
                      ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, LOG_SIGMOID_TPL_SCH_MODE_0,
                                            LOG_SIGMOID_TPL_SCH_MODE_1),
                      ASCENDC_TPL_DTYPE_DECL(dType, TPL_FP16, TPL_BF16, TPL_FP32));

ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, LOG_SIGMOID_TPL_SCH_MODE_0,
                                                          LOG_SIGMOID_TPL_SCH_MODE_1),
