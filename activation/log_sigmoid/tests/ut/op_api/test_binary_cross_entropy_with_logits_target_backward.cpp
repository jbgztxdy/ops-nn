...
protected:
    static void SetUpTestCase() { cout << "binary_cross_entropy_with_logits_target_backward_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "binary_cross_entropy_with_logits_target_backward_test TearDown" << endl; }
};
...
TEST_F(l2_binary_cross_entropy_with_logits_target_backward_test, case_null)
{
    ...
    auto ut4 = OP_API_UT(aclnnBinaryCrossEntropyWithLogitsTargetBackward,
                         INPUT(gradOutput, input, target, (aclTensor*)nullptr, (aclTensor*)nullptr, reduction),
                         OUTPUT(nullptr));
