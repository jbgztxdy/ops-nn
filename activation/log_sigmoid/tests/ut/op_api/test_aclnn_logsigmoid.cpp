...
#include "../../../op_api/aclnn_logsigmoid.h"
...
protected:
    static void SetUpTestCase() { cout << "logsigmoid_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "logsigmoid_test TearDown" << endl; }
};
