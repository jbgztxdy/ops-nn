...
ASCENDC_TPL_ARGS_DECL(Quantize,
                      ASCENDC_TPL_UINT_DECL(perMode, 2, ASCENDC_TPL_UI_LIST, TPL_PER_TENSOR, TPL_PER_CHANNEL,
                                            TPL_PER_HEAD, TPL_PER_CHANNEL_NDDMA),
                      ASCENDC_TPL_DTYPE_DECL(zeroPointsDtype, TPL_NONE, TPL_INT8, TPL_UINT8, TPL_INT32, TPL_FLOAT,
                                             TPL_BF16),
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(perMode, ASCENDC_TPL_UI_LIST, TPL_PER_TENSOR, TPL_PER_CHANNEL,
                                                          TPL_PER_HEAD, TPL_PER_CHANNEL_NDDMA),
                                     ASCENDC_TPL_DTYPE_SEL(zeroPointsDtype, TPL_NONE, TPL_INT8, TPL_UINT8, TPL_INT32,
                                                           TPL_FLOAT, TPL_BF16),
