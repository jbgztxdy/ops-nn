...
/*!
 * \file grouped_quant_max_common.h
 * \brief GroupedQuantMax kernel base
 */

#ifndef GROUPED_QUANT_MAX_COMMON_H
#define GROUPED_QUANT_MAX_COMMON_H

#include "kernel_operator.h"
#include "kernel_operator_intf.h"
#include "op_kernel/platform_util.h"
#include "grouped_quant_max_struct.h"
...
class GroupedQuantMaxBase {
public:
    __aicore__ inline GroupedQuantMaxBase(){};
...
protected:
    ...
    static constexpr AscendC::Reg::CastTrait CAST_TRAIT_FP32_TO_X_DETYPE = []() {
        return AscendC::Reg::CastTrait{
            AscendC::Reg::RegLayout::ZERO, AscendC::Reg::SatMode::SAT, AscendC::Reg::MaskMergeMode::ZEROING,
            RoundMode::CAST_RINT};
    }();
