...
#ifndef OPS_BUILT_IN_OP_PROTO_INC_GROUPED_QUANT_MAX_OPS_H_
#define OPS_BUILT_IN_OP_PROTO_INC_GROUPED_QUANT_MAX_OPS_H_
...
#endif // OPS_BUILT_IN_OP_PROTO_INC_GROUPED_QUANT_MAX_OPS_H_
