...
extern "C" __global__ __aicore__ void grouped_dynamic_block_quant(GM_ADDR x, GM_ADDR groupList, GM_ADDR yOut,
                                                                  GM_ADDR scaleOut, GM_ADDR workspace, GM_ADDR tiling)
{
