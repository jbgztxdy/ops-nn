...
ASCENDC_TPL_ARGS_DECL(SwigluMxQuant,
                      ASCENDC_TPL_UINT_DECL(groupIndexType, 3, ASCENDC_TPL_UI_LIST, TPL_NO_GROUP_INDEX,
                                            TPL_GROUP_INDEX_INT32, TPL_GROUP_INDEX_INT64),
                      ASCENDC_TPL_UINT_DECL(axisLast, 2, ASCENDC_TPL_UI_LIST, TPL_AXIS_NOT_LAST, TPL_AXIS_LAST),
                      ASCENDC_TPL_UINT_DECL(activateDimLast, 2, ASCENDC_TPL_UI_LIST, TPL_ACTIVATE_NOT_LAST,
                                            TPL_ACTIVATE_LAST),
                      ASCENDC_TPL_UINT_DECL(roundMode, 3, ASCENDC_TPL_UI_LIST, TPL_RINT, TPL_ROUND, TPL_FLOOR));

ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
    ASCENDC_TPL_UINT_SEL(groupIndexType, ASCENDC_TPL_UI_LIST, TPL_NO_GROUP_INDEX, TPL_GROUP_INDEX_INT32,
