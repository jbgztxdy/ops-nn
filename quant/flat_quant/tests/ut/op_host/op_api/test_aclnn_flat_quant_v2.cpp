...
protected:
    ...
    {
        cout << "l2_flat_quant_v2_test SetUp" << endl;
    }
    static void TearDownTestCase()
    {
        cout << "l2_flat_quant_v2_test TearDown" << endl;
    }
...
public:
    void CommonTest(
        ...
        const double_t dstTypeMax, aclnnStatus expectRet)
    {
...
TEST_F(l2_flat_quant_v2_test, ascend910B2_param_invalid)
{
    ...
    CommonTest(
        ...
        1.0, 0.0, ACLNN_ERR_PARAM_INVALID);
    CommonTest(
