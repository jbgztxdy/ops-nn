...
#include "../../../../op_host/op_api/aclnn_flat_quant_v2.h"
...
class l2_flat_quant_v2_test : public testing::Test {
protected:
    static void SetUpTestCase() { cout << "l2_flat_quant_v2_test SetUp" << endl; }
    static void TearDownTestCase() { cout << "l2_flat_quant_v2_test TearDown" << endl; }
...
public:
    void CommonTest(const vector<int64_t>& xShape, const vector<int64_t>& p1Shape, const vector<int64_t>& p2Shape,
                    ...
                    const double_t clipRatio, const double_t dstTypeMax, aclnnStatus expectRet)
    {
        ...
        auto ut = OP_API_UT(aclnnFlatQuantV2, INPUT(x, p1, p2, clipRatio, dstTypeMax), OUTPUT(out, quantScale));
...
TEST_F(l2_flat_quant_v2_test, ascend910B2_param_nullptr)
{
    ...
    auto ut1 = OP_API_UT(aclnnFlatQuantV2, INPUT(nullptr, p1, p2, clipRatio, dstTypeMax), OUTPUT(out, quantScale));
    aclnnStatus aclRet = ut1.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);

    auto ut2 = OP_API_UT(aclnnFlatQuantV2, INPUT(x, nullptr, p2, clipRatio, dstTypeMax), OUTPUT(out, quantScale));
    aclRet = ut2.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);

    auto ut3 = OP_API_UT(aclnnFlatQuantV2, INPUT(x, p1, nullptr, clipRatio, dstTypeMax), OUTPUT(out, quantScale));
    aclRet = ut3.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);

    auto ut4 = OP_API_UT(aclnnFlatQuantV2, INPUT(x, p1, p2, clipRatio, dstTypeMax), OUTPUT(nullptr, quantScale));
    aclRet = ut4.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);

    auto ut5 = OP_API_UT(aclnnFlatQuantV2, INPUT(x, p1, p2, clipRatio, dstTypeMax), OUTPUT(out, nullptr));
    aclRet = ut5.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);
}

TEST_F(l2_flat_quant_v2_test, ascend910B2_param_invalid)
{
    // invalid x shape
    // axis is 0
    CommonTest({0, 64, 64}, {64, 64}, {64, 64}, {16, 64, 64}, {16}, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_INT4,
               ACL_FLOAT, 1.0, 0.0, ACLNN_ERR_PARAM_INVALID);
    ...
    CommonTest({262145, 64, 64}, {64, 64}, {64, 64}, {262145, 64, 64}, {262145}, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16,
               ACL_INT4, ACL_FLOAT, 1.0, 0.0, ACLNN_ERR_PARAM_INVALID);
    ...
    CommonTest({16, 64, 64}, {64, 64}, {64, 64}, {16, 64, 64}, {16}, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16,
               ACL_FLOAT, 1.0, 0.0, ACLNN_ERR_PARAM_INVALID);
    CommonTest({16, 64, 64}, {64, 64}, {64, 64}, {16, 64, 64}, {16}, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_INT4,
               ACL_INT32, 1.0, 0.0, ACLNN_ERR_PARAM_INVALID);
    // invalid dim
    ...
    // clipRatio not valid
    CommonTest({16, 64, 64}, {64, 64}, {64, 64}, {16, 64, 64}, {16}, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_INT4,
               ACL_FLOAT, 1.5, 0.0, ACLNN_ERR_PARAM_INVALID);
    CommonTest({16, 64, 64}, {64, 64}, {64, 64}, {16, 64, 64}, {16}, ACL_FLOAT16, ACL_FLOAT16, ACL_FLOAT16, ACL_INT4,
               ACL_FLOAT, 0.0, 0.0, ACLNN_ERR_PARAM_INVALID);
}
