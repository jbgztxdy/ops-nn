...
TEST_F(DynamicMxQuantTiling, DynamicMxQuant_tiling_ascendc_bfloat16_fp4e2m1_tail_axis)
{
    ...
    string expectTilingData = "33 253952 4 32 64 64 64 1 13440 128 2 128 210 210 1528 0 0 0";
...
TEST_F(DynamicMxQuantTiling, DynamicMxQuant_tiling_ascendc_bfloat16_fp4e1m2_tail_axis)
{
    ...
    int64_t axis = 3;
    int64_t blockSize = 32;
    string expectTilingData = "33 253952 4 32 64 64 64 1 33554432 32 2 32 524288 524288 1528 0 0 0";
...
TEST_F(DynamicMxQuantTiling, DynamicMxQuant_tiling_ascendc_bfloat16_fp8e4m3fn_tail_axis)
{
    ...
    int64_t axis = -1;
    int64_t blockSize = 32;
    string expectTilingData = "33 253952 4 32 64 64 64 1 13440 128 2 128 210 210 1280 0 0 0";
...
TEST_F(DynamicMxQuantTiling, DynamicMxQuant_tiling_ascendc_bfloat16_fp8e5m2_tail_axis)
{
    ...
    int64_t axis = -1;
    int64_t blockSize = 32;
    string expectTilingData = "33 253952 4 32 64 64 64 1 14400 128 2 128 225 225 1280 0 0 0";
...
TEST_F(DynamicMxQuantTiling, DynamicMxQuant_tiling_ascendc_float32_fp4e2m1_tail_axis)
{
    ...
    int64_t axis = -1;
    int64_t blockSize = 32;
    string expectTilingData = "33 253952 4 32 64 64 64 1 13440 128 2 128 210 210 856 0 0 0";
...
TEST_F(DynamicMxQuantTiling, DynamicMxQuant_tiling_ascendc_float32_fp8e4m3fn_tail_axis)
{
    ...
    int64_t axis = -1;
    int64_t blockSize = 32;
    string expectTilingData = "33 253952 4 32 64 64 64 1 13440 128 2 128 210 210 768 0 0 0";
