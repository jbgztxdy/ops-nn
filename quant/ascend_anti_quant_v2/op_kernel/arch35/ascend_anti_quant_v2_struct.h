...
ASCENDC_TPL_ARGS_DECL(AscendAntiQuantV2,
                      ASCENDC_TPL_UINT_DECL(perMode, 3, ASCENDC_TPL_UI_LIST, TPL_PER_TENSOR, TPL_PER_CHANNEL,
                                            TPL_PER_HEAD, TPL_PER_CHANNEL_NDDMA, TPL_PER_HEAD_NDDMA),
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(perMode, ASCENDC_TPL_UI_LIST, TPL_PER_TENSOR, TPL_PER_CHANNEL,
                                              TPL_PER_HEAD, TPL_PER_CHANNEL_NDDMA, TPL_PER_HEAD_NDDMA),
