...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::Init(GM_ADDR x,
                                                                                                  GM_ADDR scale,
                                                                                                  GM_ADDR offset,
                                                                                                  GM_ADDR y)
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::ProcessParamOneLoop(
    ...
    TQue<QuePosition::VECIN, bufferNum>& inQueue, GlobalTensor<T1>& inGm, int64_t paramLen, int64_t paramOffset)
{
    ...
    T1 constValue = 0;
    AscendC::MultiCopyParams<T1, AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode>::MULTI_COPY_DIM> paramsMain = {
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaNoOffsetRegbase<T, T1, T2, U, SqrtMode>::CopyInX(int64_t xN,
                                                                                                     int64_t xLen,
                                                                                                     int64_t xInOffset)
{
