...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerTensorNoOffsetRegbase<T, T1, T2, U, SqrtMode>::Init(GM_ADDR x, GM_ADDR scale,
                                                                                               GM_ADDR offset,
                                                                                               GM_ADDR y)
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerTensorNoOffsetRegbase<T, T1, T2, U, SqrtMode>::CopyInX(int64_t xLen,
                                                                                                  int64_t xInOffset)
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerTensorNoOffsetRegbase<T, T1, T2, U, SqrtMode>::CopyOutY(int64_t yLen,
                                                                                                   int64_t yOutOffset)
{
