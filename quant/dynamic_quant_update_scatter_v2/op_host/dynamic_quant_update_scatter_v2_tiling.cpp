...
ge::graphStatus DynamicQuantUpdateScatterV2Tiling::GetCompileInfo(gert::TilingContext* context)
{
    ...
    OP_CHECK_IF(
        ...
        OP_LOGE(context, "RunFusionKernelTiling GetCompileInfo Failed, coreNum:%d, ubSize:%ld.", vectorCoreNum, ubSize),
        return ge::GRAPH_FAILED);
...
static ge::graphStatus TilingPrepareForDynamicQuantUpdateScatterV2(gert::TilingParseContext* context)
{
    ...
    OP_CHECK_IF(
        ...
        OP_LOGE(
            context, "DynamicQuantUpdateScatterV2 GetHardwareInfo Failed, vectorCoreNum:%d, ubSize:%ld.",
