...
public:
    explicit GroupQuant(const char* name) : OpDef(name)
    {
        ...
        this->Input("scale")
            .ParamType(REQUIRED)
            .DataType({ge::DT_FLOAT,   ge::DT_FLOAT,   ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_FLOAT16,
        ...
        this->Input("group_index")
            .ParamType(REQUIRED)
            .DataType({ge::DT_INT32, ge::DT_INT32, ge::DT_INT64, ge::DT_INT64, ge::DT_INT32, ge::DT_INT32,
                       ge::DT_INT64, ge::DT_INT64, ge::DT_INT32, ge::DT_INT32, ge::DT_INT64, ge::DT_INT64,
                       ge::DT_INT32, ge::DT_INT32, ge::DT_INT64, ge::DT_INT64, ge::DT_INT32, ge::DT_INT32,
                       ge::DT_INT64, ge::DT_INT64, ge::DT_INT32, ge::DT_INT32, ge::DT_INT64, ge::DT_INT64,
                       ge::DT_INT32, ge::DT_INT32, ge::DT_INT64, ge::DT_INT64, ge::DT_INT32, ge::DT_INT32,
                       ge::DT_INT64, ge::DT_INT64, ge::DT_INT32, ge::DT_INT32, ge::DT_INT64, ge::DT_INT64})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
        ...
        this->Output("y")
            .ParamType(REQUIRED)
            .DataType({ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                       ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                       ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                       ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                       ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                       ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4})
...
private:
    OpAICoreConfig GetKirinCoreConfig() const
    {
        ...
        config_kirin.Output("y")
            .ParamType(REQUIRED)
            .DataType({ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4, ge::DT_INT8,
                       ge::DT_INT4, ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4, ge::DT_INT8, ge::DT_INT4,
                       ge::DT_INT8, ge::DT_INT4})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                     ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                     ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
