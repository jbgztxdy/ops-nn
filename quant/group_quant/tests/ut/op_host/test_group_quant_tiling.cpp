...
void GroupQuantTilingSimpleTest(const int64_t dimS,
                                const int64_t dimE,
                                const int64_t dimH,
                                const ge::DataType xDtype,
                                const ge::DataType scaleDtype,
                                const ge::DataType groupIndexDtype,
                                const ge::DataType offsetDtype,
                                const ge::DataType yDtype,
                                const int64_t attrDstType,
                                const bool hasOffset,
                                const ge::graphStatus expectStatus,
                                const uint64_t expectTilingKey,
                                const int64_t expectBlockDim,
  ...
  std::initializer_list<int64_t> groupIndexShape = {dimE, };
  std::initializer_list<int64_t> offsetShape = {1, };
  ...
  auto holder = gert::TilingContextFaker()
                    ...
                    .NodeAttrs({
                      {"dst_type", ge::AnyValue::CreateFrom<int64_t>(attrDstType)},
                    })
...
TEST_F(GroupQuantTiling, tiling_demo_case) {
  ...
  GroupQuantTilingSimpleTest(dimS, dimE, dimH,
                             ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_INT32, ge::DT_FLOAT, ge::DT_INT8,
                             attrDstType, hasOffset,
