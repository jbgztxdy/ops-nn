...
class FakeQuantWithMinMaxArgsProto : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "FakeQuantWithMinMaxArgsProto SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "FakeQuantWithMinMaxArgsProto TearDown" << std::endl; }
};

TEST_F(FakeQuantWithMinMaxArgsProto, FakeQuantWithMinMaxArgs_proto_fp32_1d)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("FakeQuantWithMinMaxArgs")->infer_shape;
...
TEST_F(FakeQuantWithMinMaxArgsProto, FakeQuantWithMinMaxArgs_proto_fp32_2d)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("FakeQuantWithMinMaxArgs")->infer_shape;
...
TEST_F(FakeQuantWithMinMaxArgsProto, FakeQuantWithMinMaxArgs_proto_fp32_4d)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("FakeQuantWithMinMaxArgs")->infer_shape;
...
TEST_F(FakeQuantWithMinMaxArgsProto, FakeQuantWithMinMaxArgs_proto_fp32_3d)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("FakeQuantWithMinMaxArgs")->infer_shape;
...
TEST_F(FakeQuantWithMinMaxArgsProto, FakeQuantWithMinMaxArgs_proto_fp32_5d)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("FakeQuantWithMinMaxArgs")->infer_shape;
