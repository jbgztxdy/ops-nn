...
ASCENDC_TPL_ARGS_DECL(FakeQuantAffineCachemask,
    ...
    ASCENDC_TPL_DATATYPE_DECL(ZP_DT, C_DT_INT32, C_DT_FLOAT, C_DT_FLOAT16, C_DT_BF16, ASCENDC_TPL_INPUT(2)),
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_DATATYPE_SEL(ZP_DT, C_DT_INT32),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_DATATYPE_SEL(D_T_X, C_DT_FLOAT),
        ASCENDC_TPL_DATATYPE_SEL(ZP_DT, C_DT_FLOAT),
        ASCENDC_TPL_UINT_SEL(MODE,   ASCENDC_TPL_UI_LIST, 0, 1, 2, 3),
        ASCENDC_TPL_UINT_SEL(HAS_ZP, ASCENDC_TPL_UI_LIST, 0, 1)
    ),
    // x = FLOAT16, zp = INT32
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_DATATYPE_SEL(D_T_X, C_DT_FLOAT16),
        ASCENDC_TPL_DATATYPE_SEL(ZP_DT, C_DT_FLOAT16),
        ASCENDC_TPL_UINT_SEL(MODE,   ASCENDC_TPL_UI_LIST, 0, 1, 2, 3),
        ASCENDC_TPL_UINT_SEL(HAS_ZP, ASCENDC_TPL_UI_LIST, 0, 1)
    ),
    // x = BF16, zp = INT32
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_DATATYPE_SEL(D_T_X, C_DT_BF16),
        ASCENDC_TPL_DATATYPE_SEL(ZP_DT, C_DT_BF16),
        ASCENDC_TPL_UINT_SEL(MODE,   ASCENDC_TPL_UI_LIST, 0, 1, 2, 3),
        ASCENDC_TPL_UINT_SEL(HAS_ZP, ASCENDC_TPL_UI_LIST, 0, 1)
    ),
);
