...
- 算子功能：将调用 `DynamicMxQuant` 量化得到的 FLOAT4/FLOAT8 的 Tensor 反量化为 FLOAT16/BFLOAT16/FLOAT32 格式。
...
<table style="undefined;table-layout: fixed; width: 980px"><colgroup>
  ...
  <tbody>
    <tr>
      <td>x</td>
      <td>输入</td>
      <td>待反量化的数据。由 DynamicMxQuant 量化得到的 FLOAT4/FLOAT8 张量。</td>
    ...
    <tr>
      <td>mxscale</td>
      <td>输入</td>
      <td>调用 DynamicMxQuant 计算得到的量化尺度。</td>
      <td>FLOAT8_E8M0</td>
      <td>ND</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>y</td>
      <td>输出</td>
      <td>输入 x 反量化后的对应结果。shape 与 x 一致。</td>
...
| 调用方式 | 调用样例                                                                   | 说明                                                           |
|--------------|------------------------------------------------------------------------|--------------------------------------------------------------|
| aclnn调用 | [test_aclnn_anti_mx_quant](./examples/arch35/test_aclnn_anti_mx_quant.cpp) | 通过[aclnnAntiMxQuant](./docs/aclnnAntiMxQuant.md)接口方式调用 AntiMxQuant 算子。 |
