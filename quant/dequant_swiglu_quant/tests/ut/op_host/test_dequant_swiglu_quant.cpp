...
TEST_F(DequantSwiGluTiling, dequant_swi_glu_quant_tiling_002)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .InputShapes(
                          {&input_shape, &input0_shape, &input0_shape, &input0_shape, &input0_shape, &input0_shape})
...
TEST_F(DequantSwiGluTiling, dequant_swi_glu_quant_tiling_007)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .IrInstanceNum({1, 1, 1, 1, 1, 1})
                      .InputShapes(
                          {&input_shape, &input1_shape, &input2_shape, &input1_shape, &input0_shape, &input0_shape})
                      .OutputShapes({&out_shape, &out0_shape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeInputTd(0, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
