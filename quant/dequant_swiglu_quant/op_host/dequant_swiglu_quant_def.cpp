...
public:
    explicit DequantSwigluQuant(const char* name) : OpDef(name)
    {
        ...
        this->Attr("dst_type")
            .AttrType(OPTIONAL)
            .Version(DEQUANT_SWIGLU_QUANT_VERSION_TWO)
            .Int(DEQUANT_SWIGLU_QUANT_DEFAULT_VALUE); // default value
        this->Attr("round_mode")
            .AttrType(OPTIONAL)
            .Version(DEQUANT_SWIGLU_QUANT_VERSION_TWO)
            .String("rint"); // default value
        this->Attr("activate_dim")
            .AttrType(OPTIONAL)
            .Version(DEQUANT_SWIGLU_QUANT_VERSION_TWO)
            .Int(-1);                                                                                  // default value
        this->Attr("swiglu_mode").AttrType(OPTIONAL).Version(DEQUANT_SWIGLU_QUANT_VERSION_TWO).Int(0); // default value
        this->Attr("clamp_limit")
            .AttrType(OPTIONAL)
            .Version(DEQUANT_SWIGLU_QUANT_VERSION_TWO)
            .Float(CLAMP_LIMIT_DEFAULT_VALUE); // default value
        this->Attr("glu_alpha")
            .AttrType(OPTIONAL)
            .Version(DEQUANT_SWIGLU_QUANT_VERSION_TWO)
            .Float(GLU_ALPHA_DEFAULT_VALUE);                                                            // default value
        ...
        config_950.Input("x")
            ...
            .DataType({ge::DT_INT32,   ge::DT_INT32, ge::DT_INT32,   ge::DT_INT32,   ge::DT_INT32,   ge::DT_INT32,
                       ...
                       ge::DT_INT32,   ge::DT_INT32, ge::DT_INT32,   ge::DT_INT32,   ge::DT_INT32,   ge::DT_INT32,
                       ge::DT_INT32,   ge::DT_INT32, ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16,
                       ge::DT_FLOAT16, ge::DT_BF16,  ge::DT_BF16,    ge::DT_BF16,    ge::DT_BF16,    ge::DT_BF16,
                       ge::DT_INT32,   ge::DT_INT32, ge::DT_INT32,   ge::DT_INT32,   ge::DT_FLOAT16, ge::DT_BF16,
                       ge::DT_INT32,   ge::DT_INT32, ge::DT_INT32,   ge::DT_INT32,   ge::DT_INT32,   ge::DT_INT32,
                       ge::DT_INT32,   ge::DT_INT32, ge::DT_INT32,   ge::DT_INT32,   ge::DT_INT32,   ge::DT_INT32,
                       ge::DT_INT32,   ge::DT_INT32, ge::DT_INT32,   ge::DT_INT32,   ge::DT_INT32,   ge::DT_INT32,
                       ge::DT_INT32,   ge::DT_INT32, ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16,
        ...
        config_950.Input("bias")
            .ParamType(OPTIONAL)
            .DataType({ge::DT_FLOAT,   ge::DT_FLOAT,   ge::DT_FLOAT,   ge::DT_FLOAT, ge::DT_FLOAT,   ge::DT_BF16,
                       ...
                       ge::DT_FLOAT,   ge::DT_BF16,    ge::DT_FLOAT16, ge::DT_INT32, ge::DT_FLOAT,   ge::DT_FLOAT,
        ...
        config_950.Output("y")
            ...
            .DataType(
                {ge::DT_INT8,        ge::DT_FLOAT8_E4M3FN, ge::DT_FLOAT8_E5M2,   ge::DT_FLOAT4_E2M1, ge::DT_FLOAT4_E1M2,
                 ...
                 ge::DT_HIFLOAT8,    ge::DT_INT8,          ge::DT_FLOAT8_E4M3FN, ge::DT_FLOAT8_E5M2, ge::DT_FLOAT4_E2M1,
                 ge::DT_FLOAT4_E1M2, ge::DT_INT8,          ge::DT_FLOAT8_E4M3FN, ge::DT_FLOAT8_E5M2, ge::DT_FLOAT4_E2M1,
                 ge::DT_FLOAT4_E1M2, ge::DT_INT8,          ge::DT_FLOAT8_E4M3FN, ge::DT_FLOAT8_E5M2, ge::DT_FLOAT4_E2M1,
                 ge::DT_FLOAT4_E1M2, ge::DT_INT8,          ge::DT_FLOAT8_E4M3FN, ge::DT_FLOAT8_E5M2, ge::DT_FLOAT4_E2M1,
                 ge::DT_FLOAT4_E1M2, ge::DT_INT8,          ge::DT_FLOAT8_E4M3FN, ge::DT_FLOAT8_E5M2, ge::DT_FLOAT4_E2M1,
                 ge::DT_FLOAT4_E1M2, ge::DT_INT8,          ge::DT_FLOAT8_E4M3FN, ge::DT_FLOAT8_E5M2, ge::DT_FLOAT4_E2M1,
                 ge::DT_FLOAT4_E1M2, ge::DT_HIFLOAT8,      ge::DT_HIFLOAT8,      ge::DT_HIFLOAT8,    ge::DT_HIFLOAT8,
