 ...
 */
 ...
 extern "C" __global__ __aicore__ void swi_glu_quant(GM_ADDR x, GM_ADDR smooth_scales, GM_ADDR offsets, GM_ADDR group_index,
 ...
 TEST_F(swi_glu_quant_test, test_case_dynamic_bf16) {
     ...
     ICPU_RUN_KF(swi_glu_quant, blockDim, x, smooth_scales, nullptr, group_index, y, scale, workspace, (uint8_t*)(tilingDatafromBin));
