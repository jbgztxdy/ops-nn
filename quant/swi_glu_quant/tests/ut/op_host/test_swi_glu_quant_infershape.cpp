...
protected:
    static void SetUpTestCase() { std::cout << "SwiGluQuantTest Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "SwiGluQuantTest Proto Test TearDown" << std::endl; }
};
