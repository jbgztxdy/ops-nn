                                                   ...
                                                   GM_ADDR bias, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    if (TILING_KEY_IS(10100)) {
        if (tilingData.N <= 8192) {
            ...
            DequantBias::DequantBiasMultiImpl<DTYPE_X, DTYPE_WEIGHT_SCALE, DTYPE_BIAS, DTYPE_Y, false> op;
            op.Init(x, weight_scale, activate_scale, bias, y, &tilingData);
            op.Process();
        }
        ...
        if (tilingData.N <= 8192) {
            ...
            DequantBias::DequantBiasMultiImpl<DTYPE_X, DTYPE_WEIGHT_SCALE, int32_t, DTYPE_Y, true> op;
            op.Init(x, weight_scale, activate_scale, bias, y, &tilingData);
            op.Process();
        }
        ...
        if (tilingData.N <= 8192) {
            ...
            DequantBias::DequantBiasMultiImpl<DTYPE_X, DTYPE_WEIGHT_SCALE, float, DTYPE_Y, true> op;
            op.Init(x, weight_scale, activate_scale, bias, y, &tilingData);
            op.Process();
        }
        ...
        if (tilingData.N <= 8192) {
            ...
            DequantBias::DequantBiasMultiImpl<DTYPE_X, DTYPE_WEIGHT_SCALE, half, DTYPE_Y, true> op;
            op.Init(x, weight_scale, activate_scale, bias, y, &tilingData);
            op.Process();
        }
        ...
        if (tilingData.N <= 8192) {
            ...
            DequantBias::DequantBiasMultiImpl<DTYPE_X, DTYPE_WEIGHT_SCALE, bfloat16_t, DTYPE_Y, true> op;
            op.Init(x, weight_scale, activate_scale, bias, y, &tilingData);
            op.Process();
        }
#endif
