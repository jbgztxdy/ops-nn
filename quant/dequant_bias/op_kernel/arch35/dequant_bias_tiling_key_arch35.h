...
ASCENDC_TPL_ARGS_DECL(
    DequantBias,
    ASCENDC_TPL_UINT_DECL(hasBias, 1, ASCENDC_TPL_UI_LIST, TPL_NO_BIAS, TPL_HAS_BIAS),
    ASCENDC_TPL_UINT_DECL(hasActivate, 1, ASCENDC_TPL_UI_LIST, TPL_NO_ACTIVATE, TPL_HAS_ACTIVATE),
    ASCENDC_TPL_UINT_DECL(dtypeBias, 2, ASCENDC_TPL_UI_LIST, TPL_BIAS_FLOAT, TPL_BIAS_HALF, TPL_BIAS_BFLOAT, TPL_BIAS_INT)
);

ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
    ASCENDC_TPL_UINT_SEL(hasBias, ASCENDC_TPL_UI_LIST, TPL_NO_BIAS, TPL_HAS_BIAS),
    ASCENDC_TPL_UINT_SEL(hasActivate, ASCENDC_TPL_UI_LIST, TPL_NO_ACTIVATE, TPL_HAS_ACTIVATE),
    ASCENDC_TPL_UINT_SEL(dtypeBias, ASCENDC_TPL_UI_LIST, TPL_BIAS_FLOAT, TPL_BIAS_HALF, TPL_BIAS_BFLOAT, TPL_BIAS_INT)
));
