...
protected:
    static void SetUpTestCase() { cout << "dequant_bias SetUp\n" << endl; }
    static void TearDownTestCase() { cout << "dequant_bias TearDown\n" << endl; }
};
...
TEST_F(dequant_bias_test, test_dequant_bias_0)
{
    ...
    ICPU_RUN_KF(dequant_bias, blockDim, x, weight_scale, activate_scale, bias, y, workspace, tiling);
...
TEST_F(dequant_bias_test, test_dequant_bias_4)
{
    ...
    ICPU_SET_TILING_KEY(tilingKey);
    ICPU_RUN_KF(dequant_bias, blockDim, x, weight_scale, activate_scale, bias, y, workspace,
