...
protected:
    static void SetUpTestCase() { std::cout << "AscendQuantV2Tiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AscendQuantV2Tiling TearDown" << std::endl; }
};
...
TEST_F(AscendQuantV2Tiling, ascend_quant_v2_tiling1)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({{"sqrt_mode", Ops::NN::AnyValue::CreateFrom<bool>(false)},
