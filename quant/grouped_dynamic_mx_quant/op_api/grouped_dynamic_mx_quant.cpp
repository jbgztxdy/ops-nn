                                                         ...
                                                         int64_t scaleAlg, float dstTypeMax, aclOpExecutor* executor)
{
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICORE(GroupedDynamicMxQuant, OP_INPUT(x, groupIndex), OP_OUTPUT(yOut, mxScaleOut),
                                           OP_ATTR(roundMode, dstType, blocksize, scaleAlg, dstTypeMax));
