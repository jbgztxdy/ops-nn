...
/*!
 * \file swiglu_backward_mx_quant_with_dual_axis_def.cpp
 * \brief SwigluBackwardMxQuantWithDualAxis operator definition
 */
...
class SwigluBackwardMxQuantWithDualAxis : public OpDef {
public:
    explicit SwigluBackwardMxQuantWithDualAxis(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        this->Attr("dst_dtype").AttrType(OPTIONAL).Int(DEFAULT_DST_TYPE);
        ...
        aicoreConfig.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "swiglu_backward_mx_quant_with_dual_axis");
        this->AICore().AddConfig("ascend950", aicoreConfig);
    }
};

OP_ADD(SwigluBackwardMxQuantWithDualAxis);
} // namespace ops
