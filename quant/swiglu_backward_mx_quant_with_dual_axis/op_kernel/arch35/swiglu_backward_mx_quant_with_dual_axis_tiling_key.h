...
/*!
 * \file swiglu_backward_mx_quant_with_dual_axis_tiling_key.h
 * \brief TPL tiling key template argument declarations for SwigluBackwardMxQuantWithDualAxis
 */

#ifndef _SWIGLU_BACKWARD_MX_QUANT_WITH_DUAL_AXIS_TILING_KEY_H_
#define _SWIGLU_BACKWARD_MX_QUANT_WITH_DUAL_AXIS_TILING_KEY_H_
...
namespace SwigluBackwardMxQuantWithDualAxisOp {
ASCENDC_TPL_ARGS_DECL(SwigluBackwardMxQuantWithDualAxis,
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(mode, ASCENDC_TPL_UI_LIST, TPL_MODE_BLOCK),
                         ASCENDC_TPL_UINT_SEL(roundMode, ASCENDC_TPL_UI_LIST, TPL_RINT, TPL_ROUND, TPL_FLOOR),
                         ASCENDC_TPL_UINT_SEL(scaleAlg, ASCENDC_TPL_UI_LIST, TPL_SCALE_ALG_0, TPL_SCALE_ALG_1),
...
#endif // _SWIGLU_BACKWARD_MX_QUANT_WITH_DUAL_AXIS_TILING_KEY_H_
