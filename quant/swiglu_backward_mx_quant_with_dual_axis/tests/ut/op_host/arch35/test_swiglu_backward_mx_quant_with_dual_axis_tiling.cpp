...
#include "../../../../op_host/arch35/swiglu_backward_mx_quant_with_dual_axis_tiling_arch35.h"
    ...
    ge::graphStatus status = ge::GRAPH_SUCCESS)
{
    ...
    optiling::SwigluBackwardMxQuantWithDualAxisCompileInfo compile_info;

    std::string op_type("SwigluBackwardMxQuantWithDualAxis");
...
TEST_F(SwigluBackwardMxQuantWithDualAxisTilingTest, test_tiling_fp16_to_fp8_e4m3fn)
{
    gert::StorageShape xShape = {{8, 8192}, {8, 8192}};
    gert::StorageShape yGradShape = {{8, 4096}, {8, 4096}};
...
TEST_F(SwigluBackwardMxQuantWithDualAxisTilingTest, test_tiling_bf16_to_fp8_e4m3fn)
{
    ...
    gert::StorageShape yGradShape = {{4, 1024}, {4, 1024}};
...
TEST_F(SwigluBackwardMxQuantWithDualAxisTilingTest, test_tiling_fp16_to_fp8_e4m3fn_scale_alg_1)
{
    ...
    gert::StorageShape yGradShape = {{4, 2048}, {4, 2048}};
...
{
    gert::StorageShape xShape = {{2, 128, 1024}, {2, 128, 1024}};
    gert::StorageShape yGradShape = {{2, 128, 512}, {2, 128, 512}};
    gert::StorageShape y1Shape = {{2, 128, 1024}, {2, 128, 1024}};
