...
#ifndef _FAKE_QUANT_WITH_MIN_MAX_ARGS_GRADIENT_TILING_DEF_H_
#define _FAKE_QUANT_WITH_MIN_MAX_ARGS_GRADIENT_TILING_DEF_H_
...
#define GET_TILING_DATA(tilingData, tilingPointer)                                                  \
    FakeQuantWithMinMaxArgsGradientTilingData tilingData;                                          \
    INIT_TILING_DATA(FakeQuantWithMinMaxArgsGradientTilingData, tilingDataPointer, tilingPointer);             \
