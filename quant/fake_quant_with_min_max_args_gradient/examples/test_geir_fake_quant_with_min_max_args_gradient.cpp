...
/*!
 * \file test_geir_fake_quant_with_min_max_args_gradient.cpp
 * \brief
 */
...
int32_t GenRandomDataFloat32(
    vector<int64_t> shapes, Tensor& input_tensor, TensorDesc& input_tensor_desc, float minVal, float maxVal)
{
...
{
    Status ret = SUCCESS;
    auto fakeQuantGradOp = op::FakeQuantWithMinMaxArgsGradient("fakeQuantWithMinMaxArgsGradient1");
...
int main(int argc, char* argv[])
{
    ...
    for (int i = 0; i < output_num; i++) {
        ...
        LOG_PRINT("\n========== fake_quant_with_min_max_args_gradient result ==========\n");
        LOG_PRINT("gradients    x            y\n");
