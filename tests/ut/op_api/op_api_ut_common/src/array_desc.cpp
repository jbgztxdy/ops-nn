...
static void AclIntArrayReleaseWrapper(aclIntArray* p) { Release(p); }

unique_ptr<aclIntArray, void (*)(aclIntArray*)> IntArrayDesc::ToAclType() const
{
    unique_ptr<aclIntArray, decltype(&AclIntArrayReleaseWrapper)> p(this->ToAclTypeRawPtr(), AclIntArrayReleaseWrapper);
    return move(p);
}

aclIntArray* IntArrayDesc::ToAclTypeRawPtr() const { return new aclIntArray(arr_.data(), arr_.size()); }

////////////////////////////////////

static void AclFloatArrayReleaseWrapper(aclFloatArray* p) { Release(p); }
...
aclFloatArray* FloatArrayDesc::ToAclTypeRawPtr() const { return new aclFloatArray(arr_.data(), arr_.size()); }

////////////////////////////////////

static void AclBoolArrayReleaseWrapper(aclBoolArray* p) { Release(p); }
