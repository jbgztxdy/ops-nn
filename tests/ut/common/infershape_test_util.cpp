...
ge::TensorDesc create_desc(std::initializer_list<int64_t> shape_dims, ge::DataType dt)
{
...
ge::TensorDesc create_desc_with_ori(std::initializer_list<int64_t> shape_dims, ge::DataType dt, ge::Format format,
