...
#ifndef OPS_NN_TESTS_UT_COMMON_INFER_SHAPERANGE_CONTEXT_FAKER_H
#define OPS_NN_TESTS_UT_COMMON_INFER_SHAPERANGE_CONTEXT_FAKER_H
...
#endif // OPS_NN_TESTS_UT_COMMON_INFERSHAPERANGE_CONTEXT_FAKER_H
