...
ASCENDC_TPL_ARGS_DECL(
    ApplyMomentum, ASCENDC_TPL_UINT_DECL(schMode, BIT_WIDTH, ASCENDC_TPL_UI_LIST, TILING_KEY_SEL_0, TILING_KEY_SEL_1),
    ASCENDC_TPL_UINT_DECL(useNesterov, BIT_WIDTH, ASCENDC_TPL_UI_LIST, TILING_KEY_SEL_0, TILING_KEY_SEL_1));

ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, TILING_KEY_SEL_0, TILING_KEY_SEL_1),
