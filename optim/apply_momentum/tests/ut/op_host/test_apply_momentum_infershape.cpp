...
{
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("ApplyMomentum"), nullptr);
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("ApplyMomentum")->infer_shape;
