...
/*!
 * \file lamb_apply_optimizer_assign_tiling_key.h
 * \brief lamb_apply_optimizer_assign_tiling_key head file
 */
...
// 算子自定义的tiling key字段
ASCENDC_TPL_ARGS_DECL(LambApplyOptimizerAssign, BRC_NDDMA_SCH_MODE_KEY_DECL(schMode));
