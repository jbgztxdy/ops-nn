...
/*!
 * \file lamb_update_with_lr_v2_tiling_key.h
 * \brief lamb_update_with_lr_v2_tiling_key head file
 */
...
// 算子自定义的tiling key字段
ASCENDC_TPL_ARGS_DECL(LambUpdateWithLrV2, BRC_NDDMA_SCH_MODE_KEY_DECL(schMode));
