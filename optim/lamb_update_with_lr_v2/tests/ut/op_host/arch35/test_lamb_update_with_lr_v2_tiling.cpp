...
#include "optim/lamb_update_with_lr_v2/op_host/arch35/lamb_update_with_lr_v2_tiling_arch35.h"

using namespace ut_util;
using namespace std;
using namespace ge;

class LambUpdateWithLrV2TilingTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(LambUpdateWithLrV2TilingTest, lamb_update_with_lr_v2_tiling_test_fp32)
{
    ...
    platform_info.Init();
    optiling::LambUpdateWithLrV2CompileInfo compile_info;
    string op_type("LambUpdateWithLrV2");
...
TEST_F(LambUpdateWithLrV2TilingTest, lamb_update_with_lr_v2_tiling_test_fp16)
{
    gert::StorageShape in0_shape = {{1}, {1}};
    gert::StorageShape in1_shape = {{1}, {1}};
    gert::StorageShape in2_shape = {{1}, {1}};
...
TEST_F(LambUpdateWithLrV2TilingTest, lamb_update_with_lr_v2_tiling_test_dtype_mismatch)
{
    gert::StorageShape in0_shape = {{1}, {1}};
    gert::StorageShape in1_shape = {{1}, {1}};
    gert::StorageShape in2_shape = {{1}, {1}};
...
TEST_F(LambUpdateWithLrV2TilingTest, lamb_update_with_lr_v2_tiling_test_invalid_dtype)
{
    gert::StorageShape in0_shape = {{1}, {1}};
    gert::StorageShape in1_shape = {{1}, {1}};
    gert::StorageShape in2_shape = {{1}, {1}};
