...
/*!
 * \file lamb_update_with_lr_tiling_arch35.h
 * \brief lamb_update_with_lr_tiling_arch35 head file
 */
...
#include "../../op_kernel/arch35/lamb_update_with_lr_tiling_key.h"
...
struct LambUpdateWithLrCompileInfo {
    uint64_t coreNum = 0;
    uint64_t ubSize = 0;
};
