...
ge::graphStatus LambUpdateWithLrTiling::GetShapeAttrsInfo()
{
    ...
    static const char* kInputNames[] = {"input_greater1", "input_greater_realdiv", "input_realdiv", "input_mul0",
...
bool LambUpdateWithLrTiling::IsCapable()
{
    return true;
}
...
ge::graphStatus LambUpdateWithLrTiling::DoOpTiling()
{
    ...
    if (input0DType == ge::DT_FLOAT16) {
        ...
        OP_LOGE_FOR_INVALID_DTYPE(
            context_->GetNodeName(), "input_greater1", Ops::Base::ToString(input0DType).c_str(),
            "fp16 or fp32");
        return ge::GRAPH_FAILED;
    }
    return ge::GRAPH_SUCCESS;
...
ge::graphStatus LambUpdateWithLrTiling::DoLibApiTiling()
{
    return ge::GRAPH_SUCCESS;
}

uint64_t LambUpdateWithLrTiling::GetTilingKey() const
{
    return tilingKey;
}

ge::graphStatus LambUpdateWithLrTiling::GetWorkspaceSize()
{
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus LambUpdateWithLrTiling::PostTiling()
{
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus LambUpdateWithLrTiling::GetPlatformInfo()
{
    return ge::GRAPH_SUCCESS;
}
