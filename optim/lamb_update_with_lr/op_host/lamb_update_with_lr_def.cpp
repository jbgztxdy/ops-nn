...
/*!
 * \file lamb_update_with_lr_def.cpp
 * \brief lamb_update_with_lr def
 */

#include "register/op_def_registry.h"

namespace ops {
class LambUpdateWithLr : public OpDef {
public:
    explicit LambUpdateWithLr(const char* name) : OpDef(name)
    {
        ...
        aicoreConfig.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "lamb_update_with_lr");
        this->AICore().AddConfig("ascend950", aicoreConfig);
    }
};

OP_ADD(LambUpdateWithLr);
} // namespace ops
