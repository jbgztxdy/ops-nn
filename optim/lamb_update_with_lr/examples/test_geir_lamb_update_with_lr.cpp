...
/*!
 * \file test_geir_lamb_update_with_lr.cpp
 * \brief
 */
...
{
    auto op0 = op::LambUpdateWithLr("lamb_update_with_lr_0");
    std::vector<int64_t> fullShape = {2, 16};
    std::vector<int64_t> scalarShape = {1};
    ADD_INPUT(1, input_greater1, inDtype, scalarShape);
    ADD_INPUT(2, input_greater_realdiv, inDtype, scalarShape);
    ADD_INPUT(3, input_realdiv, inDtype, scalarShape);
    ADD_INPUT(4, input_mul0, inDtype, scalarShape);
    ADD_INPUT(5, input_mul1, inDtype, fullShape);
    ADD_INPUT(6, input_sub, inDtype, fullShape);
    ADD_INPUT(7, greater_y, inDtype, scalarShape);
    ADD_INPUT(8, select_e, inDtype, scalarShape);
    ADD_INPUT(9, minimum_y, inDtype, scalarShape);
...
{
    Graph graph("test_lamb_update_with_lr");
