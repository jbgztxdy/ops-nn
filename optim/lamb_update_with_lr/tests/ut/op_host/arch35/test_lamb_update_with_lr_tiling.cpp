...
#include "optim/lamb_update_with_lr/op_host/arch35/lamb_update_with_lr_tiling_arch35.h"

using namespace ut_util;
using namespace std;
using namespace ge;

class LambUpdateWithLrTilingTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(LambUpdateWithLrTilingTest, lamb_update_with_lr_tiling_test_fp32)
{
    gert::StorageShape in0_shape = {{1}, {1}};
    gert::StorageShape in1_shape = {{1}, {1}};
    gert::StorageShape in2_shape = {{1}, {1}};
    gert::StorageShape in3_shape = {{1}, {1}};
    gert::StorageShape in4_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in5_shape = {{16, 8, 375}, {16, 8, 375}};
    ...
    platform_info.Init();
    optiling::LambUpdateWithLrCompileInfo compile_info;
    string op_type("LambUpdateWithLr");
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .InputShapes({&in0_shape, &in1_shape, &in2_shape, &in3_shape, &in4_shape, &in5_shape, &in6_shape, &in7_shape, &in8_shape})
                      .OutputShapes({&out0_shape})
...
TEST_F(LambUpdateWithLrTilingTest, lamb_update_with_lr_tiling_test_fp16)
{
    gert::StorageShape in0_shape = {{1}, {1}};
    gert::StorageShape in1_shape = {{1}, {1}};
    gert::StorageShape in2_shape = {{1}, {1}};
...
TEST_F(LambUpdateWithLrTilingTest, lamb_update_with_lr_tiling_test_dtype_mismatch)
{
    gert::StorageShape in0_shape = {{1}, {1}};
    gert::StorageShape in1_shape = {{1}, {1}};
    gert::StorageShape in2_shape = {{1}, {1}};
...
TEST_F(LambUpdateWithLrTilingTest, lamb_update_with_lr_tiling_test_invalid_dtype)
{
    gert::StorageShape in0_shape = {{1}, {1}};
    gert::StorageShape in1_shape = {{1}, {1}};
    gert::StorageShape in2_shape = {{1}, {1}};
