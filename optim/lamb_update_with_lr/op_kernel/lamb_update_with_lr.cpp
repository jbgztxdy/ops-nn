...
__global__ __aicore__ void lamb_update_with_lr(
    GM_ADDR input_greater1, GM_ADDR input_greater_realdiv, GM_ADDR input_realdiv, GM_ADDR input_mul0,
    GM_ADDR input_mul1, GM_ADDR input_sub, GM_ADDR greater_y, GM_ADDR select_e, GM_ADDR minimum_y, GM_ADDR y,
    GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    if constexpr (std::is_same<DTYPE_INPUT_GREATER1, half>::value) {
        ...
        sch.Process(input_greater1, input_greater_realdiv, input_realdiv, input_mul0, input_mul1, input_sub,
