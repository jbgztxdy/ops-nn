...
protected:
    static void SetUpTestCase() { std::cout << "AdamApplyOneWithDecayAssignProtoTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AdamApplyOneWithDecayAssignProtoTest TearDown" << std::endl; }
};
