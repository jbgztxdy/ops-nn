...
ge::graphStatus CopyShapeInput2OutputWithIdxInApply(gert::InferShapeContext* context, int64_t input_idx,
                                                    int64_t output_idx)
{
...
static ge::graphStatus InferShape4ApplyAdamD(gert::InferShapeContext* context)
{
    ...
    OP_CHECK_IF(CopyShapeInput2OutputWithIdxInApply(context, input_m_idx, output_m_idx) != GRAPH_SUCCESS,
