...
#include "nn_other.h"
#include "../op_graph/sparse_apply_adadelta_proto.h"
                     ...
                     std::vector<Operator>& outputs, Graph& graph)
{
    Status ret = SUCCESS;
    // 自定义代码：添加单算子定义到图中
    auto add1 = op::SparseApplyAdadelta("add1");
    ...
    ADD_INPUT(3, accum_update, inDtype, varShape);
    ADD_INPUT(4, lr, inDtype, scalarShape);
    ADD_INPUT(5, rho, inDtype, scalarShape);
    ADD_INPUT(6, epsilon, inDtype, scalarShape);
    ADD_INPUT(7, grad, inDtype, gradShape);
    ADD_INPUT(8, indices, ge::DT_INT32, indicesShape);

    ADD_OUTPUT(1, var, inDtype, varShape);
    ADD_OUTPUT(2, accum, inDtype, varShape);
    ADD_OUTPUT(3, accum_update, inDtype, varShape);
