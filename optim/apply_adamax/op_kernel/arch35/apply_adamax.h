...
public:
    ...
    __aicore__ inline void Init(
        ...
        GM_ADDR beta1Power, GM_ADDR lr, GM_ADDR beta1, GM_ADDR beta2,
...
private:
    __aicore__ inline void LoadScalars(
        GM_ADDR beta1Power, GM_ADDR lr, GM_ADDR beta1, GM_ADDR beta2, GM_ADDR epsilon);
...
template <typename T, int IS_ALIGN>
__aicore__ inline void ApplyAdamax<T, IS_ALIGN>::Init(
    GM_ADDR var, GM_ADDR m, GM_ADDR v,
    GM_ADDR beta1Power, GM_ADDR lr, GM_ADDR beta1, GM_ADDR beta2,
    GM_ADDR epsilon, GM_ADDR grad,
    GM_ADDR varOut, GM_ADDR mOut, GM_ADDR vOut,
...
template <typename T, int IS_ALIGN>
__aicore__ inline void ApplyAdamax<T, IS_ALIGN>::LoadScalars(
    GM_ADDR beta1Power, GM_ADDR lr, GM_ADDR beta1, GM_ADDR beta2, GM_ADDR epsilon)
{
