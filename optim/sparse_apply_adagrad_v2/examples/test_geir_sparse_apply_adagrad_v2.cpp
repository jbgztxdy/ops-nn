...
/*!
 * \file test_geir_sparse_apply_adagrad_v2.cpp
 * \brief GE IR test for SparseApplyAdagradV2 operator
 */
...
#include "../op_graph/sparse_apply_adagrad_v2_proto.h"
...
#define ADD_INPUT(intputIndex, intputName, intputDtype, inputShape)                                             \
    ...
    sparseApplyAdagradV2_1.set_input_##intputName(placeholder##intputIndex);                                    \
...
#define ADD_INPUT_ATTR(attrName, attrValue) sparseApplyAdagradV2_1.set_attr_##attrName(attrValue)

#define ADD_OUTPUT(outputIndex, outputName, outputDtype, outputShape)                                        \
    TensorDesc outputName##outputIndex##_desc_ = TensorDesc(ge::Shape(outputShape), FORMAT_ND, outputDtype); \
    sparseApplyAdagradV2_1.update_output_desc_##outputName(outputName##outputIndex##_desc)
...
{
    Status ret = SUCCESS;
    auto sparseApplyAdagradV2_1 = op::SparseApplyAdagradV2("sparseApplyAdagradV2_1");
    std::vector<int64_t> varShape = {4, 8};
    std::vector<int64_t> gradShape = {2, 8};
    ...
    ADD_INPUT(4, epsilon, inDtype, scalarShape);
    ADD_INPUT(5, grad, inDtype, gradShape);
    ADD_INT_INPUT(6, indices, DT_INT32, indicesShape);
    ADD_INPUT_ATTR(use_locking, false);
    ADD_INPUT_ATTR(update_slots, true);

    outputs.push_back(sparseApplyAdagradV2_1);
    return SUCCESS;
}
