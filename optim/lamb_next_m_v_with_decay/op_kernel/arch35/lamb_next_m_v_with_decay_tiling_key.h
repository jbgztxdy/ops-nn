...
/*!
 * \file lamb_next_m_v_with_decay_tiling_key.h
 * \brief lamb_next_m_v_with_decay_tiling_key head file
 */
...
// 算子自定义的tiling key字段
ASCENDC_TPL_ARGS_DECL(LambNextMVWithDecay, BRC_NDDMA_SCH_MODE_KEY_DECL(schMode));
