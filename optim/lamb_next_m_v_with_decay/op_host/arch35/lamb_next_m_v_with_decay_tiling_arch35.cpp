...
bool LambNextMVWithDecayTiling::IsCapable()
{
    return true;
}
...
ge::graphStatus LambNextMVWithDecayTiling::DoLibApiTiling()
{
    return ge::GRAPH_SUCCESS;
}

uint64_t LambNextMVWithDecayTiling::GetTilingKey() const
{
    return tilingKey;
}

ge::graphStatus LambNextMVWithDecayTiling::GetWorkspaceSize()
{
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus LambNextMVWithDecayTiling::PostTiling()
{
    return ge::GRAPH_SUCCESS;
}
