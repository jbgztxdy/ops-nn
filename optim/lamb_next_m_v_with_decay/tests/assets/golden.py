...
__golden__ = {
    "kernel": {
        "lamb_next_mv_with_decay": "lamb_next_mv_with_decay_golden"
    }
}
...
def lamb_next_mv_with_decay_golden(input_mul3, input_mul2, input_realdiv1, input_mul1, input_mul0, input_realdiv0, input_mul4, mul0_x, mul1_sub, mul2_x, mul3_sub1, mul4_x, add2_y, **kwargs):
    ...
    pw = param * wd
    y1 = pw + m_unb / np.sqrt(v_unb + eps)
    y4 = pw + m_unb / (np.sqrt(v_unb) + eps)
