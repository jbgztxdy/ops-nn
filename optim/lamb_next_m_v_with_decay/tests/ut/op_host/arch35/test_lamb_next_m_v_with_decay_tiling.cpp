...
#include "optim/lamb_next_m_v_with_decay/op_host/arch35/lamb_next_m_v_with_decay_tiling_arch35.h"

using namespace ut_util;
using namespace std;
using namespace ge;

class LambNextMVWithDecayTilingTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(LambNextMVWithDecayTilingTest, lamb_next_mv_with_decay_tiling_test_fp32)
{
    gert::StorageShape in0_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in1_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in2_shape = {{1}, {1}};
    gert::StorageShape in3_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in4_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in5_shape = {{1}, {1}};
    gert::StorageShape in6_shape = {{16, 8, 375}, {16, 8, 375}};
    ...
    gert::StorageShape in12_shape = {{1}, {1}};
    ...
    gert::StorageShape out3_shape = {{16, 8, 375}, {16, 8, 375}};
    ...
    platform_info.Init();
    optiling::LambNextMVWithDecayCompileInfo compile_info;
    string op_type("LambNextMVWithDecay");
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .InputShapes({&in0_shape, &in1_shape, &in2_shape, &in3_shape, &in4_shape, &in5_shape, &in6_shape, &in7_shape, &in8_shape, &in9_shape, &in10_shape, &in11_shape, &in12_shape})
                      .OutputShapes({&out0_shape, &out1_shape, &out2_shape, &out3_shape})
...
TEST_F(LambNextMVWithDecayTilingTest, lamb_next_mv_with_decay_tiling_test_fp16)
{
    gert::StorageShape in0_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in1_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in2_shape = {{1}, {1}};
...
TEST_F(LambNextMVWithDecayTilingTest, lamb_next_mv_with_decay_tiling_test_dtype_mismatch)
{
    gert::StorageShape in0_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in1_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in2_shape = {{1}, {1}};
...
TEST_F(LambNextMVWithDecayTilingTest, lamb_next_mv_with_decay_tiling_test_invalid_dtype)
{
    gert::StorageShape in0_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in1_shape = {{16, 8, 375}, {16, 8, 375}};
    gert::StorageShape in2_shape = {{1}, {1}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeInputTd(12, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
