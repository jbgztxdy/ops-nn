 ...
 *
 * Note: lr / rho / epsilon are no longer carried in TilingData. They are
 * passed as 1-element scalar Tensors (GM addr) and read by Kernel at
 * runtime. TilingData only carries shape-splitting info plus the
