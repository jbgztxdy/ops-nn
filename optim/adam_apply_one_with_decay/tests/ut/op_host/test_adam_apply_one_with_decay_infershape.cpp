...
protected:
    static void SetUpTestCase() { std::cout << "AdamApplyOneWithDecayProtoTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AdamApplyOneWithDecayProtoTest TearDown" << std::endl; }
};
