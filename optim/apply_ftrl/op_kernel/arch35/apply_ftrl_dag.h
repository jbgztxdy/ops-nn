...
struct ApplyFtrlDag {
    ...
    using OpCopyInLrPower = std::conditional_t<
        std::is_same<U, bfloat16_t>::value, Bind<Vec::Duplicate<U>, Placeholder::In7<U, Placeholder::ScalarAttr<true>>>,
    ...
    using OpSignMulL1 = std::conditional_t<std::is_same<U, bfloat16_t>::value, Bind<Vec::Mul<T>, OpSign, OpL1Cast>,
