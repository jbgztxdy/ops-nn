    ...
    Graph& graph)
{
    ...
    if (AddDataInput(idx++, [&](Operator& d) { op0.set_input_accum(d); }, inDtype, tensorShape, 0.5f,
                     graph, input, inputs) != SUCCESS) return FAILED;
...
int main(int argc, char* argv[])
{
    ...
    for (int i = 0; i < output_num; i++) {
        string output_file = "./tc_sparse_apply_proximal_adagrad_ge_irrun_test_npu_output_" + std::to_string(i) + ".bin";
