...
/*!
 * \file lamb_next_right_tiling_arch35.h
 * \brief lamb_next_right_tiling_arch35 head file
 */
...
#include "../../op_kernel/arch35/lamb_next_right_tiling_key.h"
...
struct LambNextRightCompileInfo {
    uint64_t coreNum = 0;
    uint64_t ubSize = 0;
};
