...
extern "C" __global__ __aicore__ void foreach_lerp_list(GM_ADDR x1, GM_ADDR x2, GM_ADDR weight, GM_ADDR y,
                                                        GM_ADDR workspace, GM_ADDR tiling);

class foreach_lerp_list_test : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "foreach_lerp_list_test SetUp\n" << std::endl; }
    static void TearDownTestCase() { std::cout << "foreach_lerp_list_test TearDown\n" << std::endl; }
};
