...
REGISTER_TILING_DATA_CLASS(ForeachMulScalarInplace, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachSubScalarInplace, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachMulListInplace, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachDivListInplace, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddListInplace, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachSubListInplace, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachACosInplace, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachLogInplace, ForeachSoloTilingDataRegbase)
...
REGISTER_TILING_DATA_CLASS(ForeachAddScalarList_10001, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddScalarList_10002, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddScalarList_10003, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddScalarList_10004, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddcdivList, ForeachCommonTilingData)
REGISTER_TILING_DATA_CLASS(ForeachAddcdivList_10001, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddcdivList_10002, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddcdivList_10003, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddcdivList_10004, ForeachSoloTilingDataRegbase)
...
REGISTER_TILING_DATA_CLASS(ForeachAddcmulList_10001, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddcmulList_10002, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddcmulList_10003, ForeachSoloTilingDataRegbase)
REGISTER_TILING_DATA_CLASS(ForeachAddcmulList_10004, ForeachSoloTilingDataRegbase)
...
REGISTER_TILING_DATA_CLASS(ForeachDivScalar_10001, ForeachSoloTilingDataRegbase)
