...
class ForeachSinTilingTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "ForeachSinTilingTest SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "ForeachSinTilingTest TearDown" << std::endl; }
};
...
static void DoCase(std::initializer_list<int64_t> xShape, ge::DataType dt, uint64_t expectKey)
{
    ...
    auto opType = std::string("ForeachSin");
...
TEST_F(ForeachSinTilingTest, foreach_sin_float32)
{
    DoCase({4, 4}, ge::DT_FLOAT, GET_TPL_TILING_KEY(FOREACH_SIN_SCH_MODE_FLOAT));
}

TEST_F(ForeachSinTilingTest, foreach_sin_float16)
{
    DoCase({4, 4}, ge::DT_FLOAT16, GET_TPL_TILING_KEY(FOREACH_SIN_SCH_MODE_FLOAT16));
}

TEST_F(ForeachSinTilingTest, foreach_sin_bfloat16)
{
    DoCase({4, 4}, ge::DT_BF16, GET_TPL_TILING_KEY(FOREACH_SIN_SCH_MODE_BF16));
}
