...
@register("function_aclnnForeachAddScalarList")
class aclnnForeachAddScalarListExecutor(BaseApi):
    ...
    def __call__(self, input_data: InputDataset, with_output: bool = False):
        ...
        output = None
        if self.device == 'cpu':
            output = self.converter(torch._foreach_add, x, scalars)
        else:
            output = torch._foreach_add(x, scalars)

        return output

@register("aclnnfunction_aclnnForeachAddScalarList")
