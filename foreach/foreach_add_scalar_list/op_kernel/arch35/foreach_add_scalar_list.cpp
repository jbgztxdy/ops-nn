 ...
 * \brief
 */
#include "foreach_add_scalar_list_regbase.h"

using namespace ForeachAddScalarList;

template <typename T, typename ScalarT>
__aicore__ inline void ForeachAddScalarListImpl(GM_ADDR tensor1, GM_ADDR scalars, GM_ADDR outputs, GM_ADDR workspace,
...
extern "C" __global__ __aicore__ void foreach_add_scalar_list(GM_ADDR tensor1, GM_ADDR scalars, GM_ADDR outputs,
