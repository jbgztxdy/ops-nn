...
class ForeachTanhTilingTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "ForeachTanhTilingTest SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "ForeachTanhTilingTest TearDown" << std::endl; }
};
...
static void DoCase(std::initializer_list<int64_t> xShape, ge::DataType dt, uint64_t expectKey)
{
    ...
    auto opType = std::string("ForeachTanh");
...
TEST_F(ForeachTanhTilingTest, foreach_tanh_float32)
{
    DoCase({4, 4}, ge::DT_FLOAT, GET_TPL_TILING_KEY(FOREACH_TANH_SCH_MODE_FLOAT));
}

TEST_F(ForeachTanhTilingTest, foreach_tanh_float16)
{
    DoCase({4, 4}, ge::DT_FLOAT16, GET_TPL_TILING_KEY(FOREACH_TANH_SCH_MODE_FLOAT16));
}

TEST_F(ForeachTanhTilingTest, foreach_tanh_bfloat16)
{
    DoCase({4, 4}, ge::DT_BF16, GET_TPL_TILING_KEY(FOREACH_TANH_SCH_MODE_BF16));
}