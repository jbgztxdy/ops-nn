...
protected:
    static void SetUpTestCase() { std::cout << "ForeachAddcdivScalarList SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ForeachAddcdivScalarList TearDown" << std::endl; }
};
...
{
    auto
        infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcdivScalarList")->infer_datatype;
