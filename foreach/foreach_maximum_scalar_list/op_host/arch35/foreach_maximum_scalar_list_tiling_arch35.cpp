...
static ge::graphStatus ForeachMaximumScalarListTilingFunc(gert::TilingContext* context)
{
    ...
    OP_CHECK_IF(
        memset_s(tiling, sizeof(ForeachMaximumScalarListTilingData), 0, sizeof(ForeachMaximumScalarListTilingData)) != EOK,
...
static ge::graphStatus TilingParseForForeachMaximumScalarList(
