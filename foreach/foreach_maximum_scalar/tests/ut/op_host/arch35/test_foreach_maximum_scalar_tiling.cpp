...
protected:
    ...
    {
        std::cout << "ForeachMaximumScalarTilingTest SetUp" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "ForeachMaximumScalarTilingTest TearDown" << std::endl;
    }
};
                   ...
                   ge::DataType inputDt, uint64_t expectKey)
{
    ...
    struct ForeachMaximumScalarCompileInfo {} ci;
