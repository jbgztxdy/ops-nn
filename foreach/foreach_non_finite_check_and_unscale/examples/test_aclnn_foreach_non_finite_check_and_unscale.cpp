...
int main()
{
    ...
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("copy self1 result from device to host failed. ERROR: %d\n", ret);
              return ret);
    ...
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("copy self2 result from device to host failed. ERROR: %d\n", ret);
              return ret);
    for (int64_t i = 0; i < size; i++) {
    ...
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("copy foundInf result from device to host failed. ERROR: %d\n", ret);
              return ret);
