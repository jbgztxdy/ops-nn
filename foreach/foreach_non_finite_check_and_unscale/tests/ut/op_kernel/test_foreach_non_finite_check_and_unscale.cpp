...
#include "f_n_f_c_a_u_tiling_funtion.h"
...
TEST_F(foreach_non_finite_check_and_unscale_test, test_case_half_1)
{
    ...
    size_t tilingSize = sizeof(ForeachNonFiniteCheckAndUnscaleTilingDataUT);
    ...
    tilingFuncObj.FillTilingData(reinterpret_cast<ForeachNonFiniteCheckAndUnscaleTilingDataUT*>(tiling));
