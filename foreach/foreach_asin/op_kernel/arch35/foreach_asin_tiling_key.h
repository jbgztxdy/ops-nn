...
ASCENDC_TPL_ARGS_DECL(
    ForeachAsin,
    ASCENDC_TPL_UINT_DECL(dtype, 2, ASCENDC_TPL_UI_LIST,
        FOREACH_ASIN_TPL_DTYPE_FP32,
        FOREACH_ASIN_TPL_DTYPE_FP16,
        FOREACH_ASIN_TPL_DTYPE_BF16));

/* 模板参数组合 */
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
    ASCENDC_TPL_UINT_SEL(dtype, ASCENDC_TPL_UI_LIST,
        FOREACH_ASIN_TPL_DTYPE_FP32,
        FOREACH_ASIN_TPL_DTYPE_FP16,
        FOREACH_ASIN_TPL_DTYPE_BF16)));
