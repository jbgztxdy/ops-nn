...
/*!
 * \file foreach_addcmul_scalar_list_apt.cpp
 * \brief Kernel entry point for foreach_addcmul_scalar_list operator.
 *        Dispatches to SIMT Process based on TilingKey (dtype).
 *        Formula: y[i] = x1[i] + scalars[i] * x2[i] * x3[i]
 */

#include "foreach_addcmul_scalar_list_simt.h"

using namespace AscendC;
using namespace NsForeachAddcmulScalarList;

enum class ForeachAddcmulScalarListTilingKey : uint32_t {
    TILING_KEY_FP16 = 0,
    TILING_KEY_FP32 = 1,
    TILING_KEY_INT32 = 2,
    TILING_KEY_BF16 = 3,
