...
protected:
    static void SetUpTestCase() { std::cout << "ForeachAddcmulScalarList SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ForeachAddcmulScalarList TearDown" << std::endl; }
};
...
{
    auto
        infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddcmulScalarList")->infer_datatype;
