...
@register("function_aclnnForeachMinimumScalarList")
class aclnnForeachMinimumScalarListExecutor(BaseApi):
...
@register("aclnnfunction_aclnnForeachMinimumScalarList")
