...
/*!
 * \file test_foreach_exp_tiling.cpp
 * \brief arch35 SIMT tiling UT for foreach_exp (Ascend950)
 */
...
class ForeachExpTiling35 : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "ForeachExpTiling35 SetUp" << std::endl; }
