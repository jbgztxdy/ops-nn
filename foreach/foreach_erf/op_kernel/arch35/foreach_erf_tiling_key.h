...
ASCENDC_TPL_ARGS_DECL(ForeachErf,
                      ASCENDC_TPL_UINT_DECL(schMode, 3, ASCENDC_TPL_UI_LIST, FOREACH_ERF_TPL_SCH_MODE_FLOAT,
                                            FOREACH_ERF_TPL_SCH_MODE_FLOAT16, FOREACH_ERF_TPL_SCH_MODE_BF16));

ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, FOREACH_ERF_TPL_SCH_MODE_FLOAT,
