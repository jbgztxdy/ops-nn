 ...
 */
/*!
 * \file foreach_add_list_inplace_regbase.h
 * \brief
 */
#ifndef FOREACH_ADD_LIST_INPLACE_REGBASE_H
#define FOREACH_ADD_LIST_INPLACE_REGBASE_H

#include "../../foreach_utils/arch35/foreach_binary_alpha_cast_inplace.h"

namespace ForeachAddListInplace {
using namespace AscendC;
// In-place foreach add-list: y(=x1) = x1 + alpha * x2. half/bfloat16 compute in float
