...
public:
    explicit ForeachCopy(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(DYNAMIC)
            .DataType({ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_INT32, ge::DT_BF16, ge::DT_INT8, ge::DT_UINT8, ge::DT_INT16,
                       ge::DT_UINT16, ge::DT_UINT32, ge::DT_DOUBLE, ge::DT_BOOL, ge::DT_INT64, ge::DT_BF16,
        ...
        this->Output("y")
            .ParamType(DYNAMIC)
            .DataType({ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_INT32, ge::DT_BF16, ge::DT_INT8, ge::DT_UINT8, ge::DT_INT16,
                       ge::DT_UINT16, ge::DT_UINT32, ge::DT_DOUBLE, ge::DT_BOOL, ge::DT_INT64, ge::DT_FLOAT,
        ...
        aicoreConfig950.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "foreach_copy");
...
private:
    OpAICoreConfig GetKirinCoreConfig() const
    {
        ...
        config_kirin.Input("x")
            .ParamType(DYNAMIC)
            .DataType({ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_INT32, ge::DT_INT8, ge::DT_UINT8, ge::DT_INT16,
