...
public:
    explicit ForeachCopy(const char* name) : OpDef(name)
    {
        this->Input("x")
            ...
            .DataType(
                {ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_INT32, ge::DT_BF16, ge::DT_INT8, ge::DT_UINT8, ge::DT_INT16,
                 ge::DT_UINT16, ge::DT_UINT32, ge::DT_DOUBLE, ge::DT_BOOL, ge::DT_INT64, ge::DT_BF16, ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_FLOAT})
            .Format(
        ...
        this->Output("y")
            ...
            .DataType(
                {ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_INT32, ge::DT_BF16, ge::DT_INT8, ge::DT_UINT8, ge::DT_INT16,
                 ge::DT_UINT16, ge::DT_UINT32, ge::DT_DOUBLE, ge::DT_BOOL, ge::DT_INT64,   ge::DT_FLOAT,  ge::DT_FLOAT,  ge::DT_BF16, ge::DT_FLOAT16})
            .Format(
                {ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND,
                 ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat(
