...
template <typename T>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_NUM) inline void ForeachMaximumListSimtFp32(
...
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_NUM) inline void ForeachMaximumListSimtFp16(
...
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_NUM) inline void ForeachMaximumListSimtBf16(
...
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_NUM) inline void ForeachMaximumListSimtInt32(
...
__aicore__ inline void Process(GM_ADDR x1, GM_ADDR x2, GM_ADDR y,
                                const ForeachMaximumListTilingData* tilingData)
{
    ...
    for (int32_t t = 0; t < tilingData->tensorNum; t++) {
        ...
        if (oS < oE) {
            ...
            if constexpr (schMode == 0) {
                AscendC::Simt::VF_CALL<ForeachMaximumListSimtFp32<T>>(
