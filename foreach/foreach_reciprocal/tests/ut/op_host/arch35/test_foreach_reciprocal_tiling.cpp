 ...
 * \brief arch35 (Ascend950) tiling UT for foreach_reciprocal
 */
...
#include "../../../../op_kernel/arch35/foreach_reciprocal_tiling_data.h"

using namespace ut_util;

class ForeachReciprocalTilingTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "ForeachReciprocalTilingTest SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "ForeachReciprocalTilingTest TearDown" << std::endl; }
};
...
static void DoCase(std::initializer_list<int64_t> xShape, ge::DataType dt, uint64_t expectKey)
{
    ...
    auto opType = std::string("ForeachReciprocal");
...
TEST_F(ForeachReciprocalTilingTest, foreach_reciprocal_float16) { DoCase({4, 4}, ge::DT_FLOAT16, 0); }

TEST_F(ForeachReciprocalTilingTest, foreach_reciprocal_float32) { DoCase({4, 4}, ge::DT_FLOAT, 1); }

TEST_F(ForeachReciprocalTilingTest, foreach_reciprocal_bfloat16) { DoCase({4, 4}, ge::DT_BF16, 2); }