...
protected:
    ...
    {
        std::cout << "ForeachReciprocalTilingTest SetUp" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "ForeachReciprocalTilingTest TearDown" << std::endl;
    }
};
...
static void DoCase(std::initializer_list<int64_t> xShape, ge::DataType dt, uint64_t expectKey)
{
    ...
    struct ForeachReciprocalCompileInfo {} ci;
...
TEST_F(ForeachReciprocalTilingTest, foreach_reciprocal_float16)
{
    DoCase({4, 4}, ge::DT_FLOAT16, 0);
}

TEST_F(ForeachReciprocalTilingTest, foreach_reciprocal_float32)
{
    DoCase({4, 4}, ge::DT_FLOAT, 1);
}

TEST_F(ForeachReciprocalTilingTest, foreach_reciprocal_bfloat16)
{
