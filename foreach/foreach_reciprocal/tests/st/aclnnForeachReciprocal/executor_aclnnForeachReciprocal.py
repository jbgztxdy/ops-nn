...
@register("function_aclnnForeachReciprocal")
class aclnnForeachReciprocalExecutor(BaseApi):

    def __call__(self, input_data: InputDataset, with_output: bool = False):
        x_input = input_data.kwargs["input"]
        
        output = torch._foreach_reciprocal(x_input)
        
        return output

@register("aclnnfunction_aclnnForeachReciprocal")
