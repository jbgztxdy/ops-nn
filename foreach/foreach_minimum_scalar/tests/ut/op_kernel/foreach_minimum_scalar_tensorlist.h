...
template <typename T>
uint8_t* CreateTensorListForeachMinimumScalar(const std::vector<std::vector<uint64_t>>& shapeInfos, char* d_type,
                                              int arg_pos)
{
...
template <typename T>
void FreeTensorListForeachMinimumScalar(uint8_t* addr, const std::vector<std::vector<uint64_t>>& shapeInfos,
