...
@register("function_aclnnForeachAddScalar")
class aclnnForeachAddScalarExecutor(BaseApi):
    ...
    def __call__(self, input_data: InputDataset, with_output: bool = False):
        ...
        output = None
        if self.device == 'cpu':
            output = self.converter(torch._foreach_add, x, scalar)
        else:
            output = torch._foreach_add(x, scalar)

        return output


@register("aclnnfunction_aclnnForeachAddScalar")
