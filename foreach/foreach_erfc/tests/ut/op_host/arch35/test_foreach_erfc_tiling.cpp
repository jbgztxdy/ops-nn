...
#include "../../../../op_kernel/arch35/foreach_erfc_tiling_data.h"
#include "../../../../op_kernel/arch35/foreach_erfc_tiling_key.h"

using namespace ut_util;

class ForeachErfcTilingTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "ForeachErfcTilingTest SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "ForeachErfcTilingTest TearDown" << std::endl; }
};
...
static void DoCase(std::initializer_list<int64_t> xShape, ge::DataType dt, uint64_t expectKey)
{
    ...
    auto opType = std::string("ForeachErfc");
...
TEST_F(ForeachErfcTilingTest, foreach_erfc_float32)
{
    DoCase({4, 4}, ge::DT_FLOAT, GET_TPL_TILING_KEY(FOREACH_ERFC_TPL_SCH_MODE_FP32));
}

TEST_F(ForeachErfcTilingTest, foreach_erfc_float16)
{
    DoCase({4, 4}, ge::DT_FLOAT16, GET_TPL_TILING_KEY(FOREACH_ERFC_TPL_SCH_MODE_FP16));
}

TEST_F(ForeachErfcTilingTest, foreach_erfc_bfloat16)
{
    DoCase({4, 4}, ge::DT_BF16, GET_TPL_TILING_KEY(FOREACH_ERFC_TPL_SCH_MODE_BF16));
}
