...
protected:
    ...
    {
        std::cout << "ForeachErfcTilingTest SetUp" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "ForeachErfcTilingTest TearDown" << std::endl;
    }
};
...
static void DoCase(std::initializer_list<int64_t> xShape, ge::DataType dt, uint64_t expectKey)
{
    ...
    struct ForeachErfcCompileInfo {} ci;
...
TEST_F(ForeachErfcTilingTest, foreach_erfc_float32)
{
    DoCase({4, 4}, ge::DT_FLOAT,
           GET_TPL_TILING_KEY(FOREACH_ERFC_TPL_SCH_MODE_FP32));
}

TEST_F(ForeachErfcTilingTest, foreach_erfc_float16)
{
    DoCase({4, 4}, ge::DT_FLOAT16,
           GET_TPL_TILING_KEY(FOREACH_ERFC_TPL_SCH_MODE_FP16));
}

TEST_F(ForeachErfcTilingTest, foreach_erfc_bfloat16)
{
    DoCase({4, 4}, ge::DT_BF16,
           GET_TPL_TILING_KEY(FOREACH_ERFC_TPL_SCH_MODE_BF16));
}
