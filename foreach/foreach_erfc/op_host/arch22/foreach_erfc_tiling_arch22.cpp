...
/*!
 * \file foreach_erfc_tiling_arch22.cpp
 * \brief Tiling implementation for foreach_erfc operator (arch22 / Ascend910B etc.).
 *        Thin wrapper reusing ForeachCommonTiling from foreach_tiling_class.h.
 */
