...
#include "../../../../op_kernel/arch35/foreach_sinh_tiling_data.h"
#include "../../../../op_kernel/arch35/foreach_sinh_tiling_key.h"

using namespace ut_util;

class ForeachSinhTilingTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "ForeachSinhTilingTest SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "ForeachSinhTilingTest TearDown" << std::endl; }
};
...
static void DoCase(std::initializer_list<int64_t> xShape, ge::DataType dt, uint64_t expectKey)
{
    ...
    auto opType = std::string("ForeachSinh");
...
TEST_F(ForeachSinhTilingTest, foreach_sinh_float32)
{
    DoCase({4, 4}, ge::DT_FLOAT, GET_TPL_TILING_KEY(FOREACH_SINH_SCH_MODE_FLOAT));
}

TEST_F(ForeachSinhTilingTest, foreach_sinh_float16)
{
    DoCase({4, 4}, ge::DT_FLOAT16, GET_TPL_TILING_KEY(FOREACH_SINH_SCH_MODE_FLOAT16));
}

TEST_F(ForeachSinhTilingTest, foreach_sinh_bfloat16)
{
    DoCase({4, 4}, ge::DT_BF16, GET_TPL_TILING_KEY(FOREACH_SINH_SCH_MODE_BF16));
}
