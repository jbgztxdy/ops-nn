...
每个算子分为[两段式接口](../../../docs/context/两段式接口.md)，必须先调用“aclnnForeachDivScalarListGetWorkspaceSize”接口获取入参并根据计算流程计算所需workspace大小，再调用“aclnnForeachDivScalarList”接口执行计算。
...
- **参数说明**：
  ...
  <table style="undefined;table-layout: fixed; width: 1503px"><colgroup>
    ...
    <tr>
      ...
      <td><ul><li>支持空Tensor。</li><li>TensorList支持的长度为1-50个。</li><li>该参数中所有Tensor的数据类型保持一致。</li></ul></td>
    ...
    <tr>
      ...
      <td>ScalarList的长度需要与x的TensorList长度相等。</td>
      <td>FLOAT32</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
