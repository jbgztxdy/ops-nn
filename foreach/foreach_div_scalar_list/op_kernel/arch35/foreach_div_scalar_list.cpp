 ...
 * \brief
 */
#include "foreach_div_scalar_list_regbase.h"

using namespace ForeachDivScalarList;

template <typename T>
__aicore__ inline void ForeachDivScalarListImpl(GM_ADDR tensor1, GM_ADDR scalars, GM_ADDR outputs, GM_ADDR workspace,
...
extern "C" __global__ __aicore__ void foreach_div_scalar_list(GM_ADDR tensor1, GM_ADDR scalars, GM_ADDR outputs,
