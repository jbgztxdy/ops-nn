...
#include "../../../../op_kernel/arch35/foreach_div_list_tiling_data.h"
...
static void RunTilingCase(ge::DataType dtype, uint64_t expectedTilingKey)
{
    ...
    for (auto& kv : soc_version_infos) {
        soc_infos[kv.first] = kv.second;
    }
    ...
    gert::StorageShape inputs1 = {{32, 4, 4, 4}, {32, 4, 4, 4}};
    gert::StorageShape inputs2 = {{32, 4, 4, 4}, {32, 4, 4, 4}};
    gert::StorageShape outputs = {{32, 4, 4, 4}, {32, 4, 4, 4}};
