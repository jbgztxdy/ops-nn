...
#include "conv2d_v2/op_host/op_tiling/arch35/conv2d_base_tiling.h"
...
namespace optiling {
    ...
    CONV_REGISTER_TILING_TEMPLATE(ExtendConv2D, Conv2dBaseTiling, (int32_t)platform_ascendc::SocVersion::ASCEND910_95, 0);
    CONV_REGISTER_TILING_TEMPLATE(ExtendConv2D, Conv2dBaseTiling, (int32_t)platform_ascendc::SocVersion::MC62CM12A, 1);
