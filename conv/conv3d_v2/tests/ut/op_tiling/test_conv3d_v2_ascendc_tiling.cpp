...
INSTANTIATE_TEST_CASE_P(AllConv3dCases, Conv3dParameterizedTest, ::testing::Values(
    ...
    Conv3dTestParams{{1,3,1,300,6}, {3,1,1,3}, {0,0,0,0,1,1}, {1,2,1}, {1,255,1}, ge::DT_FLOAT, 1, 1, 0, 0, 0, 0, false, "SPECIFIC", false, ge::Format::FORMAT_NCDHW, ge::Format::FORMAT_NCDHW, false, false, ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16},  // disabled: coredump issue
    ...
    Conv3dTestParams{{1,1,1,1,256}, {1,1,1,255}, {0,0,0,0,254,254}, {1,1,1}, {1,1,1}, ge::DT_FLOAT, 1, 1, 0, 0, 0, 0, false, "SPECIFIC", false, ge::Format::FORMAT_NCDHW, ge::Format::FORMAT_NCDHW, false, false, ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16},  // disabled: coredump issue
