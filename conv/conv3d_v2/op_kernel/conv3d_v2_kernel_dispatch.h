...
template <conv3d::ConvL0PingPong pingPong_T, conv3d::ConvBL1ByPass bl1BypassFlag_T,
          conv3d::GroupConvType groupConvType_T, conv3d::OutputOrder outputOrder_T, conv3d::QuantType quantType_T>
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, conv3d::ConvL0PingPong ConvL0PingPongT,
          conv3d::ConvBL1ByPass BL1ByPassFlagT, conv3d::GroupConvType GroupConvTypeT, conv3d::OutputOrder OutputOrderT,
          conv3d::QuantType QuantTypeT>
__aicore__ inline void DispatchConv3DV2Kernel(GM_ADDR x, GM_ADDR filter, GM_ADDR bias, GM_ADDR scale, GM_ADDR offset,
                                              ...
                                              const Ops::NN::Conv3dV2::Conv3DV2TilingData* tilingData)
{
    ...
    if constexpr (A_TYPE::format == ConvFormat::NCDHW) {
        // PointWise
        if constexpr (BL1ByPassFlagT == conv3d::ConvBL1ByPass::BYPASS_OFF &&
