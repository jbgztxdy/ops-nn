...
DECLARE_SCHEMA(Conv3DTunerTiling, FIELD(Conv3DTunerTiling, groups), FIELD(Conv3DTunerTiling, singleCoreDo),
               FIELD(Conv3DTunerTiling, singleCoreCo), FIELD(Conv3DTunerTiling, singleCoreM),
               FIELD(Conv3DTunerTiling, orgDo), FIELD(Conv3DTunerTiling, orgCo), FIELD(Conv3DTunerTiling, orgHo),
               FIELD(Conv3DTunerTiling, orgWo), FIELD(Conv3DTunerTiling, orgCi), FIELD(Conv3DTunerTiling, orgDi),
               FIELD(Conv3DTunerTiling, orgHi), FIELD(Conv3DTunerTiling, orgWi), FIELD(Conv3DTunerTiling, kernelD),
               FIELD(Conv3DTunerTiling, kernelH), FIELD(Conv3DTunerTiling, kernelW), FIELD(Conv3DTunerTiling, strideD),
               FIELD(Conv3DTunerTiling, strideH), FIELD(Conv3DTunerTiling, strideW),
               FIELD(Conv3DTunerTiling, dilationD), FIELD(Conv3DTunerTiling, dilationH),
               FIELD(Conv3DTunerTiling, dilationW), FIELD(Conv3DTunerTiling, padHead),
               FIELD(Conv3DTunerTiling, padTail), FIELD(Conv3DTunerTiling, padTop), FIELD(Conv3DTunerTiling, padBottom),
               FIELD(Conv3DTunerTiling, padLeft), FIELD(Conv3DTunerTiling, padRight), FIELD(Conv3DTunerTiling, mL0),
               FIELD(Conv3DTunerTiling, kL0), FIELD(Conv3DTunerTiling, nL0), FIELD(Conv3DTunerTiling, kAL1),
               FIELD(Conv3DTunerTiling, kBL1), FIELD(Conv3DTunerTiling, nBL1), FIELD(Conv3DTunerTiling, mAL1),
               FIELD(Conv3DTunerTiling, pBufferFlag), FIELD(Conv3DTunerTiling, offsetx),
               FIELD(Conv3DTunerTiling, bl1FullLoad), FIELD(Conv3DTunerTiling, al1FullLoad),
               FIELD(Conv3DTunerTiling, bl1BypassFlag), FIELD(Conv3DTunerTiling, iterateMNOrder),
               FIELD(Conv3DTunerTiling, biasFullLoadFlag), FIELD(Conv3DTunerTiling, fixpParamsFullLoadFlag),
               FIELD(Conv3DTunerTiling, hf32Enable), FIELD(Conv3DTunerTiling, hf32TransMode),
               FIELD(Conv3DTunerTiling, batchDim), FIELD(Conv3DTunerTiling, nDim), FIELD(Conv3DTunerTiling, mDim),
               FIELD(Conv3DTunerTiling, doDim), FIELD(Conv3DTunerTiling, groupDim), FIELD(Conv3DTunerTiling, reserved1),
