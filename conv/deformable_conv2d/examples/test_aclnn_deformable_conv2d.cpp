...
int main()
{
    ...
    ret = aclnnDeformableConv2dGetWorkspaceSize(x, weight, offset, bias, kernelSizeArray, strideArray, paddingArray,
                                                dilationArray, groups, deformableGroups, true, out, deformOut,
