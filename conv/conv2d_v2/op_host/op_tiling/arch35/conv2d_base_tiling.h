...
/*!
 * \file conv2d_base_tiling.h
 * \brief
 */

#ifndef OPS_BUILT_IN_OP_TILING_RUNTIME_CONV2D_BASE_TILING_H
#define OPS_BUILT_IN_OP_TILING_RUNTIME_CONV2D_BASE_TILING_H
...
#include "../conv2d_tiling.h"
#include "conv2d_v2_tuning_tiling.h"
#include "conv2d_tiling_utils.h"
#include "common/op_host/op_tiling/arch35/conv_cache_tiling.h"
...
protected:
    ...
    const bool GetConv2DTilingFromRepo();
    const bool GetQuantConv2DTilingFromRepo();
