...
void Conv2dBaseTiling::PrintOpTilingData()
{
    ...
    */
    std::stringstream ss;
    ss << "hin: " << tilingData_.get_hin() << ", win: " << tilingData_.get_win()
       << ", hout: " << tilingData_.get_hout() << ", wout: " << tilingData_.get_wout()
       << ", batch: " << tilingData_.get_batch() << ", cin: " << tilingData_.get_cin()
       << ", cout: " << tilingData_.get_cout() << ", kh: " << tilingData_.get_kh()
       << ", kw: " << tilingData_.get_kw() << ", batchDim: " << tilingData_.get_batchDim()
       << ", hoDim: " << tilingData_.get_hoDim() << ", woDim: " << tilingData_.get_woDim()
       << ", nDim: " << tilingData_.get_nDim()
       << ", strideH: " << tilingData_.get_strideH()
       << ", strideW: " << tilingData_.get_strideW()
       << ", dilationH: " << tilingData_.get_dilationH()
       << ", dilationW: " << tilingData_.get_dilationW()
       << ", padTop: " << tilingData_.get_padTop()
       << ", padLeft: " << tilingData_.get_padLeft()
       << ", groups: " << tilingData_.get_groups()
       << ", cinOpt: " << tilingData_.get_cinOpt()
       << ", coutOpt: " << tilingData_.get_coutOpt()
       << ", groupOpt: " << tilingData_.get_groupOpt()
       << ", enlarge: " << tilingData_.get_enlarge()
...
{
    ss << "singleCoreHo: " << tilingData_.get_singleCoreHo()
    << ", singleCoreWo: " << tilingData_.get_singleCoreWo()
    << ", singleCoreBatch: " << tilingData_.get_singleCoreBatch()
    << ", orgHi: " << tilingData_.get_orgHi()
    << ", orgWi: " << tilingData_.get_orgWi()
    << ", orgHo: " << tilingData_.get_orgHo()
    << ", orgWo: " << tilingData_.get_orgWo()
    << ", groups: " << tilingData_.get_groups()
    << ", orgCi: " << tilingData_.get_orgCi()
    << ", orgCo: " << tilingData_.get_orgCo()
    << ", kernelH: " << tilingData_.get_kernelH()
    << ", kernelW: " << tilingData_.get_kernelW()
    << ", singleCoreCi: " << tilingData_.get_singleCoreCi()
    << ", singleCoreCo: " << tilingData_.get_singleCoreCo()
    << ", hoL1: " << tilingData_.get_hoL1()
    << ", woL1: " << tilingData_.get_woL1()
    << ", kAL1: " << tilingData_.get_kAL1()
    << ", kBL1: " << tilingData_.get_kBL1()
    << ", nBL1: " << tilingData_.get_nBL1()
    << ", hoL0: " << tilingData_.get_hoL0()
    << ", woL0: " << tilingData_.get_woL0()
    << ", kL0: " << tilingData_.get_kL0()
    << ", nL0: " << tilingData_.get_nL0()
    << ", pBufferFlag: " << tilingData_.get_pBufferFlag()
    << ", multiNBL1: " << tilingData_.get_multiNBL1()
    << ", strideH: " << tilingData_.get_strideH()
    << ", strideW: " << tilingData_.get_strideW()
    << ", dilationH: " << tilingData_.get_dilationH()
    << ", dilationW: " << tilingData_.get_dilationW()
    << ", padTop: " << tilingData_.get_padTop()
    << ", padBottom: " << tilingData_.get_padBottom()
    << ", padLeft: " << tilingData_.get_padLeft()
    << ", padRight: " << tilingData_.get_padRight()
    << ", aL1SpaceSize: " << tilingData_.get_aL1SpaceSize()
    << ", singleCoreGroups: " << tilingData_.get_singleCoreGroups()
    << ", singleCoreGroupOpt: " << tilingData_.get_singleCoreGroupOpt()
    << ", enlarge: " << tilingData_.get_enlarge()
...
void Conv2dBaseTiling::PrintLibApiTilingData()
{
    ...
    */
    ...
    ssPartTwo << "bUbKStep: " << tilingData_.get_bUbKStep()
    << ", orgHixWi: " << tilingData_.get_orgHixWi()
    ...
    << ", cinBTailInCore: " << tilingData_.get_cinBTailInCore()
    << ", mStep: " << tilingData_.get_mStep()
    << ", kStep: " << tilingData_.get_kStep()
    << ", nStep: " << tilingData_.get_nStep()
