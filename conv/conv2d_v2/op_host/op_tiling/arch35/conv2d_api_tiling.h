...
/*!
 * \file conv2d_api_tiling.h
 * \brief
 */

#ifndef ASCENDC_TIKCFW_TILING_CONV2D_API_TILING_H
#define ASCENDC_TIKCFW_TILING_CONV2D_API_TILING_H

#include "conv2d_api_tilingdata.h"
