...
static ge::graphStatus Conv2DV2TilingFunc(gert::TilingContext* context) { return ConvTilingFunc(context); }

IMPL_OP_OPTILING(Conv2DV2).Tiling(Conv2DV2TilingFunc).TilingParse<ConvTilingParseInfo>(TilingPrepareForConv);
} // namespace optiling