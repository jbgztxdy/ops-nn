...
protected:
    static void SetUpTestCase() { std::cout << "DynamicRNNV2TilingTestParam SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "DynamicRNNV2TilingTestParam TearDown" << std::endl; }
};
...
void RNNV2Test(DynamicRNNV2TilingTestParam param)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({
                          {"cell_type", Ops::NN::AnyValue::CreateFrom<std::string>(param.cell_type)},
                          ...
                          {"recurrent_activation",
                           Ops::NN::AnyValue::CreateFrom<std::string>(param.recurrent_activation)},
