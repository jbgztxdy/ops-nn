...
ge::graphStatus OpSelectFormatRnnV2(const ge::Operator& op, ge::AscendString& result)
{
    ...
    if (isDynamic) {
        ...
        resJsonStr = "{\"input0\":{\"name\":\"x\", \"dtype\":" + xDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"input1\":{\"name\":\"weight_input\", \"dtype\":" +
                     xDtype + ", \"format\":" + wFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"input2\":{\"name\":\"weight_hidden\", \"dtype\":" +
                     xDtype + ", \"format\":" + wFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"input3\":{\"name\":\"b\", \"dtype\":" +
                     bDtype + ", \"format\":" + bFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"input4\":{\"name\":\"seq_length\", \"dtype\":" +
                     seqDtype + ", \"format\":" + seqFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"input5\":{\"name\":\"init_h\", \"dtype\":" +
                     xDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"input6\":{\"name\":\"init_c\", \"dtype\":" +
                     bDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"input7\":{\"name\":\"wci\", \"dtype\":" +
                     xDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"input8\":{\"name\":\"wcf\", \"dtype\":" +
                     xDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"input9\":{\"name\":\"wco\", \"dtype\":" +
                     xDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"input10\":{\"name\":\"mask\", \"dtype\":" +
                     maskDtype + ", \"format\":" + maskFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"

                     "\"output0\":{\"name\":\"y\", \"dtype\":" +
                     bDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"output1\":{\"name\":\"output_h\", \"dtype\":" +
                     xDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"output2\":{\"name\":\"output_c\", \"dtype\":" +
                     bDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"output3\":{\"name\":\"i\", \"dtype\":" +
                     bDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"output4\":{\"name\":\"j\", \"dtype\":" +
                     bDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"output5\":{\"name\":\"f\", \"dtype\":" +
                     bDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"output6\":{\"name\":\"o\", \"dtype\":" +
                     bDtype + ", \"format\":" + xFormat +
                     ", \"unknownshape_format\":\"ND,ND,ND,ND\"},"
                     "\"output7\":{\"name\":\"tanhc\", \"dtype\":" +
                     bDtype + ", \"format\":" + xFormat + ", \"unknownshape_format\":\"ND,ND,ND,ND\"}}";
    }
