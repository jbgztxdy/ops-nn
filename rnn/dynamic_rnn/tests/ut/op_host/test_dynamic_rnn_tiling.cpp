...
protected:
    static void SetUpTestCase() { std::cout << "DynamicRNNTilingTestParam SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "DynamicRNNTilingTestParam TearDown" << std::endl; }
};
