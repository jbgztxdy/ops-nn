                                                  ...
                                                  GM_ADDR outputTanhC, GM_ADDR workspace, GM_ADDR rnnTiling)
{
    ...
    if (TILING_KEY_IS(10000001)) {
        ...
        lstmOp.Init(inputX, weight, bias, seqLength, initH, initC, wCi, wCf, wCo, mask, outputY, outputH, outputC,
                    outputI, outputJ, outputF, outputO, outputTanhC, &tiling_data, workspace);
        lstmOp.Process();
