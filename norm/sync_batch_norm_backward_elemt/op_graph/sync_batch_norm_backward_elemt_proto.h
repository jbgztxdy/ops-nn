...
*@li grad_output: A ND tensor(2D-8D). Forward output differential. Must be one of the following types: float16,
bfloat16, float32.
...
*@li invstd: A ND tensor(2D-8D). Reciprocal of the standard deviation of the saved forward input. Has the same shape,
format and type as input "grad_output".
...
*@par Outputs:
* grad_input: A ND tensor(2D-8D). The reverse gradient corresponding to the input in the forward calculation. Has the
same shape, format and type as input "grad_output". \n
*/
