...
TEST_F(group_norm_grad_test, test_case_mode0_align)
{
    ...
    system("cp -r ../../../../norm/group_norm_grad/tests/ut/op_kernel/group_norm_grad_data ./");
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 1 32 576 8 float");

    char* path_ = get_current_dir_name();
    string path(path_);
    ReadFile(path + "/group_norm_grad_data/input_dy.bin", dy_size, dy, dy_size);
    ReadFile(path + "/group_norm_grad_data/input_mean.bin", mean_size, mean, mean_size);
    ReadFile(path + "/group_norm_grad_data/input_rstd.bin", rstd_size, rstd, rstd_size);
    ReadFile(path + "/group_norm_grad_data/input_x.bin", x_size, x, x_size);
    ReadFile(path + "/group_norm_grad_data/input_gamma.bin", gamma_size, gamma, gamma_size);
...
TEST_F(group_norm_grad_test, test_case_mode0_not_align)
{
    ...
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 1 32 566 8 float");
    system("cd ./group_norm_grad_data/ && python3 gen_tiling.py 1 32 566 8 float");
...
TEST_F(group_norm_grad_test, test_case_mode1)
{
    ...
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 1 32 8192 8 float");
...
TEST_F(group_norm_grad_test, test_case_mode2)
{
    ...
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 1 40 4096 8 float");
...
TEST_F(group_norm_grad_test, test_case_mode3)
{
    ...
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 1 32 16384 8 float");
...
TEST_F(group_norm_grad_test, test_case_mode5_float32_deterministic)
{
    ...
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 32 64 1 64 float");
...
TEST_F(group_norm_grad_test, test_case_mode0_bf16)
{
    ...
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 1 32 576 8 float16");
    ...
    tilingDatafromBin->task_num_per_tail_core = 1;   // 8
    tilingDatafromBin->tail_core = 8;                // 9
    tilingDatafromBin->mode1_ub_cap_C_num = 18;      // 10
    tilingDatafromBin->mode1_ub_iter_C_num = 1;      // 11
    tilingDatafromBin->mode1_ub_tail_C_num = 4;      // 12
    tilingDatafromBin->mode2_ub_capacity_ele = 0;    // 13
    tilingDatafromBin->mode2_ub_iteration_num = 0;   // 14
...
TEST_F(group_norm_grad_test, test_case_mode1_bf16)
{
    ...
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 1 32 8192 8 float16");
...
TEST_F(group_norm_grad_test, test_case_mode3_bf16)
{
    ...
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 1 32 16384 8 float16");
    ...
    tilingDatafromBin->mode1_ub_iter_C_num = 0;       // 11
    tilingDatafromBin->mode1_ub_tail_C_num = 0;       // 12
    tilingDatafromBin->mode2_ub_capacity_ele = 10832; // 13
    tilingDatafromBin->mode2_ub_iteration_num = 2;    // 14
    tilingDatafromBin->mode2_ub_tail_num = 5552;      // 15
    tilingDatafromBin->workSpaceSize = 0;             // 16
    tilingDatafromBin->stage2CoreUsed = 0;            // 17
    tilingDatafromBin->castEleNum = 0;                // 18
    tilingDatafromBin->tailCastNum = 0;               // 19
...
TEST_F(group_norm_grad_test, test_case_mode2_fp16)
{
    ...
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 1 32 4096 8 float16");
...
TEST_F(group_norm_grad_test, test_case_mode5_fp16_deterministic)
{
    ...
    system("chmod -R 755 ./group_norm_grad_data/");
    system("cd ./group_norm_grad_data/ && rm -rf ./*bin");
    system("cd ./group_norm_grad_data/ && python3 gen_data.py 128 512 1 512 float16");
