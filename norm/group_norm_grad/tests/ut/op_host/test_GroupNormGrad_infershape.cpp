...
protected:
    static void SetUpTestCase() { std::cout << "GroupNormGrad Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "GroupNormGrad Proto Test TearDown" << std::endl; }
};
