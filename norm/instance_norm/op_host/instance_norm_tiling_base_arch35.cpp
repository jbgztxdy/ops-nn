    ...
    if (format == FORMAT_NCHW) {
        OP_CHECK_IF(
            ...
            OP_LOGE_FOR_INVALID_SHAPEDIM_WITH_REASON(context_->GetNodeName(), "x", 
                std::to_string(xDimNum).c_str(), "The shape dim of input x must be 4 when the format of x is NCHW"),
            return ge::GRAPH_FAILED);
        ...
        OP_CHECK_IF(
            ...
            OP_LOGE_FOR_INVALID_SHAPEDIM_WITH_REASON(context_->GetNodeName(), "x",
                std::to_string(xDimNum).c_str(), "The shape dim of input x must be 5 when the format of x is NCDHW"),
            return ge::GRAPH_FAILED);
        a1 = xStorageShape.GetDim(DIM_0);
        a0 = xStorageShape.GetDim(DIM_1);
        ...
        OP_CHECK_IF(
            ...
            OP_LOGE_FOR_INVALID_SHAPEDIM_WITH_REASON(context_->GetNodeName(), "x",
                std::to_string(xDimNum).c_str(), "The shape dim of input x must be 4 when the format of x is NHWC"),
            return ge::GRAPH_FAILED);
        a1 = xStorageShape.GetDim(DIM_0);
        ...
        OP_CHECK_IF(
            ...
            OP_LOGE_FOR_INVALID_SHAPEDIM_WITH_REASON(context_->GetNodeName(), "x",
                std::to_string(xDimNum).c_str(), "The shape dim of input x must be 5 when the format of x is NDHWC"),
            return ge::GRAPH_FAILED);
        a1 = xStorageShape.GetDim(DIM_0);
