...
extern "C" __global__ __aicore__ void add_layer_norm_quant_v2(
    GM_ADDR x1, GM_ADDR x2, GM_ADDR gamma, GM_ADDR beta, GM_ADDR bias, GM_ADDR scales1, GM_ADDR scales2,
    GM_ADDR zeroOffset1, GM_ADDR zeroOffset2, GM_ADDR y1, GM_ADDR y2, GM_ADDR x, GM_ADDR layernormRes, GM_ADDR outScale1, GM_ADDR outScale2,
...
#define INIT_AND_PROCESS                                                                                        \
    op.Init(                                                                                                    \
        x1, x2, gamma, beta, bias, scales1, scales2, zeroOffset1, zeroOffset2, y1, y2, x, layernormRes, outScale1, outScale2, \
