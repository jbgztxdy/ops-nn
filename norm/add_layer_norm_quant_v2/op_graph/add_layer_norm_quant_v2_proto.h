...
/*!
 * \file add_layer_norm_quant_v2_proto.h
 * \brief
 */
#ifndef OPS_NORM_ADD_LAYER_NORM_QUANT_V2_PROTO_H_
#define OPS_NORM_ADD_LAYER_NORM_QUANT_V2_PROTO_H_
...
* @li layernorm_res: Describing the result of layernorm.
*     A tensor. Support dtype: float32, float16, bfloat16, support format: ND.
...
#endif // OPS_NORM_ADD_LAYER_NORM_QUANT_V2_PROTO_H_