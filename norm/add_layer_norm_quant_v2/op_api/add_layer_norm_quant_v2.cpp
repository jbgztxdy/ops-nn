...
{
    OP_LOGI("AddLayerNormQuantV2 L0 Start.");
    ...
    auto layernormRes = executor->AllocTensor(x1->GetViewShape(), x1->GetDataType(), op::Format::FORMAT_ND);
    ...
    return {y1Out, y2Out, xOut, layernormRes, outScales1Out, outScales2Out};
}
