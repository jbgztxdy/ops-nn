 ...
 */
#ifndef OP_API_INC_LEVEL0_ADD_LAYER_NORM_QUANT_V2_H_
#define OP_API_INC_LEVEL0_ADD_LAYER_NORM_QUANT_V2_H_

#include "opdev/op_executor.h"

namespace l0op {
constexpr size_t ADD_LAYER_NORM_QUANT_V2_OUT_NUM = 6;

const std::array<aclTensor*, ADD_LAYER_NORM_QUANT_V2_OUT_NUM> AddLayerNormQuantV2(
...
#endif // OP_API_INC_LEVEL0_ADD_LAYER_NORM_QUANT_V2_H_
