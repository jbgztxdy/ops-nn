...
/*!
 * \file add_layer_norm_quant_v2_def.cpp
 * \brief
 */
#include "register/op_def_registry.h"

namespace ops {
class AddLayerNormQuantV2 : public OpDef {
public:
    explicit AddLayerNormQuantV2(const char* name) : OpDef(name)
    {
        this->Input("x1")
            .ParamType(REQUIRED)
        ...
        config310P.Output("x")
            ...
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND})
            .AutoContiguous();
        config310P.Output("layernorm_res")
            .ParamType(REQUIRED)
            .DataType({ge::DT_FLOAT16, ge::DT_FLOAT})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND})
            .AutoContiguous();
        config310P.Output("out_scales1")
            .ParamType(REQUIRED)
            .DataType({ge::DT_FLOAT, ge::DT_FLOAT})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND})
            .AutoContiguous();
        config310P.Output("out_scales2")
            .ParamType(REQUIRED)
            .DataType({ge::DT_FLOAT, ge::DT_FLOAT})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND})
