...
class AddLayerNormQuantV2Tiling : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "AddLayerNormQuantV2Tiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AddLayerNormQuantV2Tiling TearDown" << std::endl; }
};

TEST_F(AddLayerNormQuantV2Tiling, add_layer_norm_quant_v2_tiling_001)
{
    ...
    platform_info.Init();
    struct AddLayerNormQuantV2CompileInfo {
    ...
    AddLayerNormQuantV2CompileInfo compile_info;

    std::string op_type("AddLayerNormQuantV2");
    ...
    ASSERT_EQ(tiling_key, 1152);
}

TEST_F(AddLayerNormQuantV2Tiling, add_layer_norm_quant_v2_tiling_002)
{
...
TEST_F(AddLayerNormQuantV2Tiling, add_layer_norm_quant_v2_tiling_static_001)
{
    gert::StorageShape input_shape = {{24, 1, 5120}, {24, 1, 5120}};
    gert::StorageShape gamma_shape = {{5120}, {5120}};
    gert::StorageShape out_shape = {{24, 1, 5120}, {24, 1, 5120}};
    gert::StorageShape reduce_shape = {{24, 1, 1}, {24, 1, 1}};
