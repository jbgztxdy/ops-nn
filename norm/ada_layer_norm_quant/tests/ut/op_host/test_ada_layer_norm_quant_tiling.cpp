...
protected:
    static void SetUpTestCase() { std::cout << "AdaLayerNormQuantTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AdaLayerNormQuantTiling TearDown" << std::endl; }
};
