...
static void RunTilingTest(
    gert::StorageShape &input0_shape, gert::StorageShape &input1_shape,
    gert::StorageShape &input2_shape, gert::StorageShape &input3_shape,
    gert::StorageShape &input4_shape,
    gert::StorageShape &output0_shape, gert::StorageShape &output1_shape,
    gert::StorageShape &output2_shape,
    ge::DataType dy_dt, ge::DataType x_dt, ge::DataType gamma_dt,
    ge::DataType pdx_dt, ge::DataType pdgamma_dt, ge::DataType pdbeta_dt,
    const std::string &compile_info_str,
    ge::graphStatus expected_status,
    ...
    std::map<std::string, std::string> *soc_version_infos = nullptr)
{
    ...
    auto kernel_holder =
        gert::KernelRunContextFaker()
            .KernelIONum(2, 1)
            .Inputs({const_cast<char*>(compile_info_str.c_str()), reinterpret_cast<void*>(&platform_info)})
            .Outputs({&compile_info})
            .Build();
...
TEST_F(LayerNormGradV3Tiling, tiling_base_dy_dim_less_than_gamma_dim)
{
    ...
    RunTilingTest(s0, s1, s2, s3, s4, o0, o1, o2,
                  ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16,
                  ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_FLOAT,
                  COMPILE_INFO_910B, ge::GRAPH_FAILED);
}
...
TEST_F(LayerNormGradV3Tiling, tiling_base_output_mask_wrong_size)
{
    ...
    auto kernel_holder = gert::KernelRunContextFaker()
        .KernelIONum(2, 1)
        .Inputs({const_cast<char*>(COMPILE_INFO_910B.c_str()), reinterpret_cast<void*>(&platform_info)})
    ...
    auto holder = gert::TilingContextFaker()
        .SetOpType("LayerNormGradV3").NodeIoNum(5, 3).IrInstanceNum({1, 1, 1, 1, 1})
        .InputShapes({&s0, &s1, &s2, &s3, &s4}).OutputShapes({&o0, &o1, &o2})
...
TEST_F(LayerNormGradV3Tiling, tiling_base_3d_dy_1d_gamma_success)
{
    ...
    RunTilingTest(s0, s1, s2, s3, s4, o0, o1, o2,
                  ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16,
                  ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_FLOAT,
                  COMPILE_INFO_910B, ge::GRAPH_SUCCESS, 412);
}
...
TEST_F(LayerNormGradV3Tiling, tiling_base_3d_dy_2d_gamma_success)
{
    ...
    RunTilingTest(s0, s1, s2, s3, s4, o0, o1, o2,
                  ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT16,
                  ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_FLOAT,
                  COMPILE_INFO_910B, ge::GRAPH_SUCCESS, 112);
}
...
TEST_F(LayerNormGradV3Tiling, tiling_base_bf16_bf16_dtype)
{
    ...
    RunTilingTest(s0, s1, s2, s3, s4, o0, o1, o2,
                  ...
                  COMPILE_INFO_910B, ge::GRAPH_SUCCESS, 114);
}
...
TEST_F(LayerNormGradV3Tiling, tiling_base_fp32_common_small_col)
{
    ...
    RunTilingTest(s0, s1, s2, s3, s4, o0, o1, o2,
                  ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
                  ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
                  COMPILE_INFO_910B, ge::GRAPH_SUCCESS, 411);
}
...
TEST_F(LayerNormGradV3Tiling, tiling_base_ascend950_workspace_fp32)
{
    ...
    RunTilingTest(s0, s1, s2, s3, s4, o0, o1, o2,
                  ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
                  ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
                  COMPILE_INFO_950, ge::GRAPH_SUCCESS, -1, &soc_ver);
}
...
TEST_F(LayerNormGradV3Tiling, tiling_base_fp32_single_read)
{
    ...
    RunTilingTest(s0, s1, s2, s3, s4, o0, o1, o2,
                  ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
                  ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
                  COMPILE_INFO_910B, ge::GRAPH_SUCCESS, 111);
}
...
TEST_F(LayerNormGradV3Tiling, tiling_base_fp16_float_gamma_single_read)
{
    ...
    RunTilingTest(s0, s1, s2, s3, s4, o0, o1, o2,
                  ge::DT_FLOAT16, ge::DT_FLOAT16, ge::DT_FLOAT,
                  ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_FLOAT,
                  COMPILE_INFO_910B, ge::GRAPH_SUCCESS, 113);
}
