...
extern "C" void layer_norm_grad_v3(uint8_t* dy, uint8_t* x, uint8_t* rstd, uint8_t* mean, uint8_t* gamma, uint8_t* dx,
                                   uint8_t* dgamma, uint8_t* dbeta, uint8_t* workspace, uint8_t* tiling);

class layer_norm_grad_v3_test : public testing::Test {
protected:
    static void SetUpTestCase() { cout << "layer_norm_grad_v3_test SetUp\n" << endl; }
    static void TearDownTestCase() { cout << "layer_norm_grad_v3_test TearDown\n" << endl; }
};
...
TEST_F(layer_norm_grad_v3_test, test_case_1)
{
    ...
    LayerNormGradV3TilingDataSingleRead* tilingDatafromBin = reinterpret_cast<LayerNormGradV3TilingDataSingleRead*>(
        tiling);
    ...
    ICPU_RUN_KF(layer_norm_grad_v3, blockDim, dy, x, rstd, mean, gamma, dx, dgamma, dbeta, workspace,
...
TEST_F(layer_norm_grad_v3_test, test_case_workspace_201)
{
    ...
    LayerNormGradV3TilingDataWorkspace* tilingDatafromBin = reinterpret_cast<LayerNormGradV3TilingDataWorkspace*>(
        tiling);
