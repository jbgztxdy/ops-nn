...
protected:
    static void SetUpTestCase() { std::cout << "QuantizeAddLayerNorm infershape Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "QuantizeAddLayerNorm infershape Test TearDown" << std::endl; }
};
