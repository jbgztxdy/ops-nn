...
protected:
    static void SetUpTestCase() { std::cout << "RmsNormGrad Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "RmsNormGrad Proto Test TearDown" << std::endl; }
};
