...
// 显式引入 C_DT_* 全局枚举常量定义。pkg 编译路径下 register/op_def.h 链会间接引入
// graph/c_types.h，但 UT kernel 编译路径不会，需要在这里直接 include 以保证
// ASCENDC_TPL_DATATYPE_DECL/SEL 里的 C_DT_FLOAT 等符号在两种构建中都可见。
