...
#include "log/log.h"
#include "../../../op_graph/layer_norm_grad_proto.h"
...
TEST_F(LayerNormGradTest, layer_norm_grad_infershape_test_1)
{
    // params_greater_norm
...
TEST_F(LayerNormGradTest, layer_norm_grad_infershape_test_2)
{
    // params_equal_norm
    ge::op::LayerNormGrad op;
...
TEST_F(LayerNormGradTest, layer_norm_grad_infershape_test_3)
{
    // norm_greater_params
    ge::op::LayerNormGrad op;
...
TEST_F(LayerNormGradTest, layer_norm_grad_infershape_test_4)
{
    // input_is_scala
    ge::op::LayerNormGrad op;
...
TEST_F(LayerNormGradTest, layer_norm_grad_infershape_test_5)
{
    // input_is_scala
    ge::op::LayerNormGrad op;
...
TEST_F(LayerNormGradTest, LayerNormGrad_InferDtype_case)
{
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("LayerNormGrad"), nullptr);
    auto data_type_func = gert::OpImplRegistry::GetInstance().GetOpImpl("LayerNormGrad")->infer_datatype;
