...
/* !
 * \file layer_norm_grad_grouped_reduce_big_n_tiling.cc
 * \brief
 */
...
bool LayerNormGradGroupedReduceBigNTiling::IsCapable()
{
...
ge::graphStatus LayerNormGradGroupedReduceBigNTiling::GammaBetaKernelTiling()
{
...
ge::graphStatus LayerNormGradGroupedReduceBigNTiling::BackwardKernelTiling()
{
    // 输入形状为(M, N)
    int64_t colSize = static_cast<int64_t>(commonParams.colSize);
    int64_t rowSize = static_cast<int64_t>(commonParams.rowSize);
...
ge::graphStatus LayerNormGradGroupedReduceBigNTiling::DoOpTiling()
{
...
ge::graphStatus LayerNormGradGroupedReduceBigNTiling::GetWorkspaceSize()
{
...
uint64_t LayerNormGradGroupedReduceBigNTiling::GetTilingKey() const
{
