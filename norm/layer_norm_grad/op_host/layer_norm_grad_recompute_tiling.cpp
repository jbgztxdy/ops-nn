...
/* !
 * \file layer_norm_grad_recompute_tiling.cc
 * \brief
 */
...
ge::graphStatus LayerNormGradRecomputeTiling::BackwardKernelTiling()
{
...
ge::graphStatus LayerNormGradRecomputeTiling::DoOpTiling()
{
...
uint64_t LayerNormGradRecomputeTiling::GetTilingKey() const
{
    constexpr uint64_t recomputeTemplateKey = 500;
    return recomputeTemplateKey;
}

REGISTER_TILING_TEMPLATE("LayerNormGrad", LayerNormGradRecomputeTiling, 7000);
} // namespace optiling
