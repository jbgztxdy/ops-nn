...
/*!
 * \file rms_norm_grad_quant.h
 * \brief L0 operator header for RmsNormGradQuant
 */
#ifndef OP_API_INC_LEVEL0_RMS_NORM_GRAD_QUANT_H_
#define OP_API_INC_LEVEL0_RMS_NORM_GRAD_QUANT_H_
...
#endif // OP_API_INC_LEVEL0_RMS_NORM_GRAD_QUANT_H_
