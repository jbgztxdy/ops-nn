...
/*!
 * \file rms_norm_grad_quant_empty_dgamma.h
 * \brief RmsNormGradQuant empty dgamma
 */
 
#ifndef RMS_NORM_GRAD_QUANT_EMPTY_DGAMMA_H
#define RMS_NORM_GRAD_QUANT_EMPTY_DGAMMA_H
...
class EmptyDgamma {
public:
    __aicore__ inline EmptyDgamma(TPipe *pipe, const RmsNormGradQuantRegbaseEmptyTilingData *tilingData) : Ppipe_(pipe), tiling_(tilingData)
    {
    }
