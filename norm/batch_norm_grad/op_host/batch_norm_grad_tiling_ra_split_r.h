...
/* !
 * \file batch_norm_grad_tiling_ra_split_r.h
 * \brief
 */

#ifndef __BATCH_NORM_GRAD_TILING_RA_SPLIT_H__
#define __BATCH_NORM_GRAD_TILING_RA_SPLIT_H__
...
#endif // __BATCH_NORM_GRAD_TILING_RA_SPLIT_H__
