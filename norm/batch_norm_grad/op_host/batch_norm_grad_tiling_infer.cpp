...
protected:
    bool IsCapable() override
    {
        ...
        OP_LOGD(context_, "BatchNormGradInferTiling RAR template is capable, fused shape: (%ld, %ld, %ld)", r1Dim, aDim,
                r0Dim);
        return true;
    }
...
uint64_t BatchNormGradInferTiling::GetTilingKey() const { return TILINGKEY_INFER_BASE + subTilingKey; }
