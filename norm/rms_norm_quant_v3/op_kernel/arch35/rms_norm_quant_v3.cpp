...
__global__ __aicore__ void rms_norm_quant_v3(GM_ADDR x, GM_ADDR gamma, GM_ADDR scales1, GM_ADDR scales2,
...
{
    rms_norm_quant_v2_impl<COMPUTE_MODE>(x, gamma, scales1, scales2, zero_points1, zero_points2, beta, y1, y2, rstd,
                                         workspace, tiling);
}
