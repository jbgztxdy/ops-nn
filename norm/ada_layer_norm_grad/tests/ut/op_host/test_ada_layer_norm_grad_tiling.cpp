...
protected:
    static void SetUpTestCase() { std::cout << "AdaLayerNormGradTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AdaLayerNormGradTiling TearDown" << std::endl; }
};
