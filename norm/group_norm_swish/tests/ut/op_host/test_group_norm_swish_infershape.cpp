...
protected:
    static void SetUpTestCase() { std::cout << "GroupNormSwish Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "GroupNormSwish Proto Test TearDown" << std::endl; }
};
