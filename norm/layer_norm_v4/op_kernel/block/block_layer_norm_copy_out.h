...
template <class SubBlockLayerNormCopyOut_, class BlockEpilogue_>
...
public:
    ...
    __aicore__ inline void operator()(const GlobalTensor<Tfm> yGlobal, const LocalTensor<float> yLocal,
                                      uint32_t dataSize)
    {
