...
* @par Inputs:
* @li dy: Gradient of the loss w.r.t the output, a tensor of type float16/bfloat16/float32. Supported formats: NCHW,
NHWC, NDHWC, NCDHW.
...
* @li save_rstd: Saved inverse standard deviation from the forward pass, a 1D tensor of type float32. Supported formats:
ND.
*
* @par Attributes:
...
* @par Outputs:
* @li dx: Gradient of the loss w.r.t the input, a tensor of type float16/bfloat16/float32. Supported formats: NCHW,
NHWC, NDHWC, NCDHW.
* @li dweight: Gradient of the loss w.r.t the scale parameter, a 1D tensor of type float16/bfloat16/float32. Supported
formats: ND.
