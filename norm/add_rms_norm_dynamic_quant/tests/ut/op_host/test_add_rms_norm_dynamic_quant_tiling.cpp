...
protected:
    static void SetUpTestCase() { std::cout << "AddRmsNormDynamicQuantTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AddRmsNormDynamicQuantTiling TearDown" << std::endl; }
};
