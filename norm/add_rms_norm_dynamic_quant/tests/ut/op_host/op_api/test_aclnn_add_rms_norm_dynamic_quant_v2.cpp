...
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND950);
    auto tensor_desc_x1 = TensorDesc({8, 0}, ACL_BF16, ACL_FORMAT_ND);
    auto tensor_desc_x2 = TensorDesc({8, 0}, ACL_BF16, ACL_FORMAT_ND);
    auto tensor_desc_gamma = TensorDesc({0,}, ACL_BF16, ACL_FORMAT_ND);
    auto tensor_desc_s1 = TensorDesc({0,}, ACL_BF16, ACL_FORMAT_ND);
    auto tensor_desc_s2 = TensorDesc({0,}, ACL_BF16, ACL_FORMAT_ND);
    auto tensor_desc_beta = TensorDesc({0,}, ACL_BF16, ACL_FORMAT_ND);
    auto tensor_desc_scale1 = TensorDesc({8}, ACL_FLOAT, ACL_FORMAT_ND);
    auto tensor_desc_scale2 = TensorDesc({8}, ACL_FLOAT, ACL_FORMAT_ND);
    auto tensor_desc_y1 = TensorDesc({8, 0}, ACL_HIFLOAT8, ACL_FORMAT_ND);
    auto tensor_desc_y2 = TensorDesc({8, 0}, ACL_HIFLOAT8, ACL_FORMAT_ND);
    auto tensor_desc_x = TensorDesc({8, 0}, ACL_BF16, ACL_FORMAT_ND);
