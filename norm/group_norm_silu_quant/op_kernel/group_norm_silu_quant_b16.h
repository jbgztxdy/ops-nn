...
#ifndef GROUP_NORM_SILU_QUANT_B16_H_
#define GROUP_NORM_SILU_QUANT_B16_H_

#include "group_norm_silu_quant_base.h"
...
private:
    ...
    // tiling params
    const GroupNormSiluQuantTilingData* tiling;
};
    ...
    const GroupNormSiluQuantTilingData* tilingData)
{
    ...
    pipe.InitBuffer(inQueueQuantScale, 1, shapeCAlign * sizeof(float));
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::Process()
{
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::ProcessPerCore(const int64_t& loopNum)
{
    CopyInGammaAndBeta();
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::CopyInGammaAndBeta()
{
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::CastGammaAndBeta()
{
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::ComputeSilu(const int64_t& loopNum)
{
    if (tiling->loopNum == 1) {
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::ComputeOneLoop(const int64_t& loopNum)
{
    ...
    LocalTensor<float> quantScaleLocal = this->inQueueQuantScale.template DeQue<float>();
    float quantScale = quantScaleLocal.GetValue(0);
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::ComputeMultipleLoop(const int64_t& loopNum)
{
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::AccumulateXandX2OneLoop(const int64_t& outIdx)
{
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::AccumulateXandX2MultipleLoop(const int64_t& outIdx)
{
    LocalTensor<float> xUb32 = xBuf32.Get<float>();
    LocalTensor<float> x1Ub32 = x1Buf32.Get<float>();
    LocalTensor<float> x2Ub32 = x2Buf32.Get<float>();
...
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::CopyInX(const int64_t xOffset, const int64_t copyNum)
{
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::ComputeSumX(const int64_t& num)
{
    LocalTensor<T1> xUb = inQueueX.DeQue<T1>();
    LocalTensor<float> xUb32 = xBuf32.Get<float>();
    LocalTensor<float> x1Ub32 = x1Buf32.Get<float>();
...
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::CalcSilu(const float& scale, const float& quantScale, const float& bias, const int64_t& calcNum)
{
    ...
    ComputeQuant(x1Ub32, calcNum, quantScale);
    PipeBarrier<PIPE_V>();
}
...
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::ComputeQuant(const AscendC::LocalTensor<float> &out, int64_t calcNum, const float quantScale)
{
    ...
    LocalTensor<half> yQuant = x2Buf32.Get<half>();
    Cast(yQuant, out, AscendC::RoundMode::CAST_NONE, calcNum);
    AscendC::PipeBarrier<PIPE_V>();
    LocalTensor<int8_t> yUb = outQueueSilu.template AllocTensor<int8_t>();
    this->CastFromF16ToI8(yUb, yQuant, -128, calcNum);
    PipeBarrier<PIPE_V>();
    outQueueSilu.template EnQue(yUb);
}

template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::CopyOutY(const int64_t& yOffset, const int64_t& copyNum)
{
    ...
    const float& scale, const float& bias, const int64_t& yOffset, const int64_t& copyNum)
{
    ...
    uint16_t blockLen = dataCount * sizeof(int8_t);
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSiluQuantB16<T1, T2>::CopyOutMeanAndRstd(const int64_t& copyNum)
{
...
#endif // GROUP_NORM_SILU_QUANT_B16_H_