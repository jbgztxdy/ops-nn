...
protected:
    static void SetUpTestCase() { cout << "group_norm_silu_quant_test SetUp\n" << endl; }
    static void TearDownTestCase() { cout << "group_norm_silu_quant_test TearDown\n" << endl; }
};
...
TEST_F(group_norm_silu_quant_test, test_case_dtype16_perchannel)
{
    ...
    ICPU_RUN_KF(group_norm_silu_quant, blockDim, x, gamma, beta, quantScale, silu, mean, rstd, workspace,
