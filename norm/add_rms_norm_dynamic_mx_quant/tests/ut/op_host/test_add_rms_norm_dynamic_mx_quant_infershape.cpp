...
protected:
    static void SetUpTestCase() { std::cout << "AddRmsNormDynamicMxQuantInferShapeTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AddRmsNormDynamicMxQuantInferShapeTest TearDown" << std::endl; }
};
