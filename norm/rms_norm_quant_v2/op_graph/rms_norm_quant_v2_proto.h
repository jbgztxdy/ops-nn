...
/*!
 * \file rms_norm_quant_v2_proto.h
 * \brief
 */
#ifndef OPS_NORM_RMS_NORM_QUANT_V2_PROTO_H_
#define OPS_NORM_RMS_NORM_QUANT_V2_PROTO_H_

#include "graph/operator_reg.h"

namespace ge {
/**
* @brief RmsNormQuantV2 operator interface implementation.
...
* @par Inputs
* @li x: A tensor. Input x for the add operation.
...
#endif // OPS_NORM_RMS_NORM_QUANT_V2_PROTO_H_
