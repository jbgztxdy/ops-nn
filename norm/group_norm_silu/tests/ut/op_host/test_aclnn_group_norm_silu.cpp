...
TEST_F(l2_group_norm_silu_test, ascend910B2_case_float16_normal)
{
    ...
    auto ut = OP_API_UT(aclnnGroupNormSiluV2, INPUT(self_desc, gamma_desc, beta_desc, group, eps, activateSilu),
...
TEST_F(l2_group_norm_silu_test, ascend910B2_case_bfloat16_normal)
{
    ...
    auto ut = OP_API_UT(aclnnGroupNormSilu, INPUT(self_desc, gamma_desc, beta_desc, group, eps),
                        OUTPUT(out_desc, mean_out_desc, rstd_out_desc));
...
TEST_F(l2_group_norm_silu_test, ascend910B2_case_self_nullptr_abnormal)
{
    ...
    auto ut = OP_API_UT(aclnnGroupNormSilu, INPUT((aclTensor*)nullptr, gamma_desc, beta_desc, group, eps),
                        OUTPUT(out_desc, mean_out_desc, rstd_out_desc));
...
TEST_F(l2_group_norm_silu_test, ascend910B2_case_beta_nullptr_normal)
{
    ...
    auto ut = OP_API_UT(aclnnGroupNormSilu, INPUT(self_desc, gamma_desc, (aclTensor*)nullptr, group, eps),
                        OUTPUT(out_desc, mean_out_desc, rstd_out_desc));
