...
protected:
    static void SetUpTestCase() { std::cout << "GroupNormSilu Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "GroupNormSilu Proto Test TearDown" << std::endl; }
};
