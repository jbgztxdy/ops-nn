...
protected:
    static void SetUpTestCase() { std::cout << "GroupNormSiluTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "GroupNormSiluTiling TearDown" << std::endl; }
};
...
TEST_F(GroupNormSiluTiling, group_norm_silu_tiling_012)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeOutputTd(1, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(2, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeAttrs({{"num_groups", Ops::NN::AnyValue::CreateFrom<int64_t>(31)},
                                  {"eps", Ops::NN::AnyValue::CreateFrom<float>(0.00001)},
                                  {"activate_silu", Ops::NN::AnyValue::CreateFrom<bool>(false)}})
                      .TilingData(param.get())
                      .Workspace(ws_size)
