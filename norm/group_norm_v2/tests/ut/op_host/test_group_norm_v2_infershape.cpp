...
protected:
    static void SetUpTestCase() { std::cout << "GroupNormV2 Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "GroupNormV2 Proto Test TearDown" << std::endl; }
};
