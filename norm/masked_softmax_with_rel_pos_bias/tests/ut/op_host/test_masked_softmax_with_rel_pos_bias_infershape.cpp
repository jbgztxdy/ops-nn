...
protected:
    static void SetUpTestCase() { std::cout << "MaskedSoftmaxWithRelPosBias Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "MaskedSoftmaxWithRelPosBias Proto Test TearDown" << std::endl; }
};
...
TEST_F(MaskedSoftmaxWithRelPosBias, MaskedSoftmaxWithRelPosBias_infershape_case_0)
{
    ...
    Runtime2TestParam param{{"scale_value", "inner_precision_mode"}}; // attr
