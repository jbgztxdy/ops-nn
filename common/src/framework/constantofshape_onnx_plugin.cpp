...
{
    static DataType onnxToGeDataType[UINT_64 + 1] = {DT_UNDEFINED, DT_FLOAT,  DT_UINT8,  DT_INT8,   DT_UINT16,
                                                     DT_INT16,     DT_INT32,  DT_INT64,  DT_STRING, DT_BOOL,
                                                     DT_FLOAT16,   DT_DOUBLE, DT_UINT32, DT_UINT64};
...
REGISTER_CUSTOM_OP("PartitionedCall")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::8::ConstantOfShape"), ge::AscendString("ai.onnx::9::ConstantOfShape"),
                   ge::AscendString("ai.onnx::10::ConstantOfShape"), ge::AscendString("ai.onnx::11::ConstantOfShape"),
                   ge::AscendString("ai.onnx::12::ConstantOfShape"), ge::AscendString("ai.onnx::13::ConstantOfShape"),
                   ge::AscendString("ai.onnx::14::ConstantOfShape"), ge::AscendString("ai.onnx::15::ConstantOfShape"),
                   ge::AscendString("ai.onnx::16::ConstantOfShape"), ge::AscendString("ai.onnx::17::ConstantOfShape"),
