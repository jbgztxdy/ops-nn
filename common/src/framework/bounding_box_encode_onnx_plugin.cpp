...
REGISTER_CUSTOM_OP("BoundingBoxEncode")
    .FrameworkType(ONNX)
    .OriginOpType(
        {ge::AscendString("ai.onnx::11::NPUBoundingBoxEncode"), ge::AscendString("ai.onnx::12::NPUBoundingBoxEncode"),
         ge::AscendString("ai.onnx::13::NPUBoundingBoxEncode"), ge::AscendString("ai.onnx::14::NPUBoundingBoxEncode"),
         ge::AscendString("ai.onnx::15::NPUBoundingBoxEncode"), ge::AscendString("ai.onnx::16::NPUBoundingBoxEncode"),
         ge::AscendString("ai.onnx::17::NPUBoundingBoxEncode"), ge::AscendString("ai.onnx::18::NPUBoundingBoxEncode"),
