...
REGISTER_CUSTOM_OP("LRN")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::8::LRN"), ge::AscendString("ai.onnx::9::LRN"),
                   ge::AscendString("ai.onnx::10::LRN"), ge::AscendString("ai.onnx::11::LRN"),
                   ge::AscendString("ai.onnx::12::LRN"), ge::AscendString("ai.onnx::13::LRN"),
                   ge::AscendString("ai.onnx::14::LRN"), ge::AscendString("ai.onnx::15::LRN"),
                   ge::AscendString("ai.onnx::16::LRN"), ge::AscendString("ai.onnx::17::LRN"),
