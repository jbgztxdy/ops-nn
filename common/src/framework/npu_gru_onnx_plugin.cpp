...
REGISTER_CUSTOM_OP("PartitionedCall")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("npu::1::NPUGru"), ge::AscendString("ai.onnx::11::NPUGru"),
                   ge::AscendString("ai.onnx::12::NPUGru"), ge::AscendString("ai.onnx::13::NPUGru"),
                   ge::AscendString("ai.onnx::14::NPUGru"), ge::AscendString("ai.onnx::15::NPUGru"),
                   ge::AscendString("ai.onnx::16::NPUGru"), ge::AscendString("ai.onnx::17::NPUGru"),
