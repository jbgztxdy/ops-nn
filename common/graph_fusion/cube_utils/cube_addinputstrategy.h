...
public:
    ...
    void SetClipValue6(ge::Graph& graph, const PostCubeFunctionParamPtr& functpara, ge::DataType dst_datatype,
                       std::vector<ge::GNodePtr>& new_nodes) const;
    ge::graphStatus CloneVectorInput(ge::Graph& graph, const PostCubeNodeInfo& tofuzednode,
                                     const PostCubeFunctionParamPtr& functpara,
                                     std::vector<ge::GNodePtr>& new_nodes) const;
    ...
    ge::GNode CreateNewDataNodeOnly(ge::Graph& graph, ge::TensorDesc tensor_desc, ge::Tensor tensornode,
                                    const std::string& op_name) const;
    ge::GNodePtr GetQuantScaleOffset(const PostCubePassInfo& match_pass, const uint32_t& index, float& scale,
                                     float& offset) const;
    ge::GNodePtr GetFirstNodeOutputDesc(const PostCubePassInfo& match_pass, const PostCubeFunctionParamPtr& functpara,
                                        ge::TensorDesc& output_desc) const;
    ge::GNodePtr GetNodeOutputDescByIndex(const std::vector<PostCubeNodeInfo>& opnodes, uint32_t index,
                                          ge::TensorDesc& output_desc) const;
    ge::graphStatus CreateAndRelinkCastNode(ge::Graph& graph, const ge::GNodePtr& inputnode,
    ...
    static ge::GNode CreateQuantScaleOpDesc(ge::Graph& graph, const std::string& op_name,
                                            const ge::GNodePtr& pre_op_desc, const ge::GNodePtr& post_op_desc,
    ...
    static ge::GNode CreateVectorMulScalarOpDesc(ge::Graph& graph, const std::string& op_name,
                                                 const ge::GNodePtr& pre_op_desc, const ge::GNodePtr& post_op_desc,
                                                 const ge::DataType& data_type);
    ...
    static bool CanBroadcast(const ge::TensorDesc& tensor_desc1, const ge::TensorDesc& tensor_desc2);
...
private:
    ge::graphStatus CreateAndLinkQuantScaleNodes(ge::Graph& graph, const PostCubeFunctionParamPtr& functpara,
                                                 const ge::GNodePtr& pre_fuze_node, const ge::GNodePtr& post_fuze_node,
