...
static const std::vector<ge::DataType> targetDataType = {ge::DT_INT64, ge::DT_INT64, ge::DT_INT64,
                                                         ge::DT_INT32, ge::DT_INT32, ge::DT_INT32};

static const std::vector<ge::DataType> weightDataType = {ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_FLOAT,
...
public:
    explicit CrossEntropyLossGrad(const char* name) : OpDef(name)
    {
        ...
        aicoreRegbaseConfig.Output("x_grad")
            ...
            .UnknownShapeFormat(dataFormat)
            .Format(dataFormat);
        aicoreRegbaseConfig.DynamicCompileStaticFlag(true).DynamicRankSupportFlag(true).DynamicShapeSupportFlag(true);
