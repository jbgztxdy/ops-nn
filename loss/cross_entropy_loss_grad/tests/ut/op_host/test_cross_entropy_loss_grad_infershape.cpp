...
protected:
    static void SetUpTestCase() { std::cout << "CrossEntropyLossGrad Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "CrossEntropyLossGrad Proto Test TearDown" << std::endl; }
};
...
TEST_F(CrossEntropyLossGrad, CrossEntropyLossGrad_infershape_case_0)
{
    ...
    gert::StorageShape target_shape = {{
                                           48,
                                       },
                                       {
                                           48,
                                       }};
    gert::StorageShape weight_shape = {{
                                           112595,
                                       },
                                       {
                                           112595,
