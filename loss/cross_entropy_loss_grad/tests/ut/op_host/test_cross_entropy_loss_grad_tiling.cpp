...
protected:
    static void SetUpTestCase() { std::cout << "CrossEntropyLossGradTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "CrossEntropyLossGradTiling TearDown" << std::endl; }
};
