                                                    ...
                                                    uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    if (self->IsEmpty()) {
        ...
        const aclTensor* dims = uniqueExecutor.get()->ConvertToTensor(fillShape.data(), fillShape.size(),
        ...
        binaryCrossEntropyOut = l0op::BinaryCrossEntropy(selfContiguous, targetContiguous, weightContiguous,
...
aclnnStatus aclnnBinaryCrossEntropy(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor,
                                    aclrtStream stream)
{
