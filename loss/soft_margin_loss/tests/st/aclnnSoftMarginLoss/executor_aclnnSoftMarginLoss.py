...
@register("ascend_method_torch_nn_soft_margin_loss")
class MethodAclnnSoftMarginLossApi(BaseApi):
    def __init__(self, task_result: TaskResult):
        super(MethodAclnnSoftMarginLossApi, self).__init__(task_result)
