...
struct SmoothL1LossGradV2OpDag {
    ...
    using OpXInvertSigma = Ops::Base::Bind<Ops::Base::Vec::Muls<PromteT>, OpX,
                                           Ops::Base::Placeholder::Var<PromteT, SCALAR_INVERT_SIGMA_IDX>>;

    using OpCommpareNeg = Ops::Base::Bind<Ops::Base::Vec::Compare<uint8_t, PromteT, COMPARE_MODE_LT>, OpX,
                                          Ops::Base::Placeholder::Var<PromteT, SCALAR_NEG_SIGMA_IDX>>;
    using OpCommparePos = Ops::Base::Bind<Ops::Base::Vec::Compare<uint8_t, PromteT, COMPARE_MODE_GT>, OpX,
                                          Ops::Base::Placeholder::Var<PromteT, SCALAR_SIGMA_IDX>>;
    using OpCommpareX = Ops::Base::Bind<Ops::Base::Vec::Compare<uint8_t, PromteT, COMPARE_MODE_GT>, OpXAbs,
                                        Ops::Base::Placeholder::Var<PromteT, SCALAR_SIGMA_IDX>>;
    // x > sigma ? 1.0 : 0.0
    using OpSelectPos = Ops::Base::Bind<Ops::Base::Vec::Select<uint8_t, PromteT, SELECT_SCALAR>, OpCommparePos,
                                        ConstValueOne, OpZeroTensor>;
    // x < -sigma ? -1.0 : 0.0
    using OpSelectNeg = Ops::Base::Bind<Ops::Base::Vec::Select<uint8_t, PromteT, SELECT_SCALAR>, OpCommpareNeg,
                                        ConstValueNegOne, OpZeroTensor>;
    // |x| > sigma ? 0.0 : (predict-latbel) / beta
    using OpSelectX = Ops::Base::Bind<Ops::Base::Vec::Select<uint8_t, PromteT, SELECT_SCALAR>, OpCommpareX,
                                      ConstValueZero, OpXInvertSigma>;
    ...
    using Mul0 = Ops::Base::Bind<Ops::Base::Vec::Muls<PromteT>, OpRes,
                                 Ops::Base::Placeholder::Var<PromteT, SCALAR_NORM_IDX>>;
...
struct SmoothL1LossGradV2OpScalarDag {
    ...
    using OpPredict = Ops::Base::Bind<Ops::Base::Vec::CopyInBrc<T>, Ops::Base::Placeholder::In0<T>>;
    using OpLabel = Ops::Base::Bind<Ops::Base::Vec::CopyInBrc<T>, Ops::Base::Placeholder::In1<T>>;
    using OpDout = Ops::Base::Bind<Ops::Base::Vec::Duplicate<T>,
                                   Ops::Base::Placeholder::In2<T, Ops::Base::Placeholder::ScalarAttr<true>>>;
    ...
    using OpCommpareNeg = Ops::Base::Bind<Ops::Base::Vec::Compare<uint8_t, PromteT, COMPARE_MODE_LE>, OpX,
                                          Ops::Base::Placeholder::Var<PromteT, SCALAR_NEG_SIGMA_IDX>>;
    using OpCommparePos = Ops::Base::Bind<Ops::Base::Vec::Compare<uint8_t, PromteT, COMPARE_MODE_GE>, OpX,
                                          Ops::Base::Placeholder::Var<PromteT, SCALAR_SIGMA_IDX>>;
    using OpCommpareX = Ops::Base::Bind<Ops::Base::Vec::Compare<uint8_t, PromteT, COMPARE_MODE_GE>, OpXAbs,
                                        Ops::Base::Placeholder::Var<PromteT, SCALAR_SIGMA_IDX>>;
    // x > sigma ? 1.0 : 0.0
    using OpSelectPos = Ops::Base::Bind<Ops::Base::Vec::Select<uint8_t, PromteT, SELECT_SCALAR>, OpCommparePos,
                                        ConstValueOne, OpZeroTensor>;
