...
protected:
    static void SetUpTestCase() { std::cout << "MseLossGradV2 Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "MseLossGradV2 Proto Test TearDown" << std::endl; }
};
