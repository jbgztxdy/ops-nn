...
ASCENDC_TPL_ARGS_DECL(SigmoidCrossEntropyWithLogitsV2, BRC_TEMP_SCH_MODE_KEY_DECL(schMode),
                      ASCENDC_TPL_UINT_DECL(Reduction, REDUCTION_BIT_WIDTH, ASCENDC_TPL_UI_LIST, SIGMOIDCEV2_NONE),
                      ASCENDC_TPL_UINT_DECL(HasWeight, WEIGHT_BIT_WIDTH, ASCENDC_TPL_UI_LIST, SIGMOIDCEV2_NO_WEIGHT,
                                            SIGMOIDCEV2_HAS_WEIGHT),
                      ASCENDC_TPL_UINT_DECL(HasPosWeight, WEIGHT_BIT_WIDTH, ASCENDC_TPL_UI_LIST, SIGMOIDCEV2_NO_WEIGHT,
                                            SIGMOIDCEV2_HAS_WEIGHT));
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(BRC_TEMP_SCH_MODE_KEY_SEL(schMode),
                                     ...
                                     ASCENDC_TPL_UINT_SEL(HasWeight, ASCENDC_TPL_UI_LIST, SIGMOIDCEV2_NO_WEIGHT,
                                                          SIGMOIDCEV2_HAS_WEIGHT),
                                     ASCENDC_TPL_UINT_SEL(HasPosWeight, ASCENDC_TPL_UI_LIST, SIGMOIDCEV2_NO_WEIGHT,
                                                          SIGMOIDCEV2_HAS_WEIGHT)), );
