...
TEST_F(l2_ctc_loss_test, test_ctc_loss_logprobs_dtype_error) {
    auto logProbs = TensorDesc({T, N, C}, ACL_INT8, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto targets = TensorDesc({N, S}, ACL_INT64, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto inputLengths = IntArrayDesc(vector<int64_t>{T, T, T, T});
...
TEST_F(l2_ctc_loss_test, test_ctc_loss_targets_dtype_error) {
    auto logProbs = TensorDesc({T, N, C}, ACL_DOUBLE, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto targets = TensorDesc({N, S}, ACL_INT8, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto inputLengths = IntArrayDesc(vector<int64_t>{T, T, T, T});
    auto targetLengths = IntArrayDesc(vector<int64_t>{S, S, S, S});
    int64_t blank = 0;
...
TEST_F(l2_ctc_loss_test, test_ctc_loss_logprobs_first_dim_0_error) {
    auto logProbs = TensorDesc({0, N, C}, ACL_DOUBLE, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto targets = TensorDesc({N, S}, ACL_INT64, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto inputLengths = IntArrayDesc(vector<int64_t>{T, T, T, T});
...
TEST_F(l2_ctc_loss_test, test_ctc_loss_logProbs_dimnum_not_3_error) {
    auto logProbs = TensorDesc({T, N, C, 2}, ACL_DOUBLE, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto targets = TensorDesc({N, S}, ACL_INT64, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto inputLengths = IntArrayDesc(vector<int64_t>{T, T, T, T});
...
TEST_F(l2_ctc_loss_test, test_ctc_loss_target_1_dim_size_not_sumtargetlengths_error) {
    auto logProbs = TensorDesc({T, N, C}, ACL_DOUBLE, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto targets = TensorDesc({4 * S + 1}, ACL_INT64, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto inputLengths = IntArrayDesc(vector<int64_t>{T, T, T, T});
    auto targetLengths = IntArrayDesc(vector<int64_t>{S, S, S, S});
    int64_t blank = 0;
...
TEST_F(l2_ctc_loss_test, test_ctc_loss_target_shape_isnot_1or2_error) {
    auto logProbs = TensorDesc({T, N, C}, ACL_DOUBLE, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto targets = TensorDesc({N, S, 2}, ACL_INT64, ACL_FORMAT_ND)
                            .ValueRange(-10, 10);
    auto inputLengths = IntArrayDesc(vector<int64_t>{T, T, T, T});
    auto targetLengths = IntArrayDesc(vector<int64_t>{S, S, S, S});
    int64_t blank = 0;
