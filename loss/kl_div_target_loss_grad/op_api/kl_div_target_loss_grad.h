...
/*!
 * \file kl_div_target_loss_grad.h
 * \brief
 */
#ifndef PTA_NPU_OP_API_INC_LEVEL0_OP_KL_DIV_TARGET_LOSS_GRAD_OP_H_
#define PTA_NPU_OP_API_INC_LEVEL0_OP_KL_DIV_TARGET_LOSS_GRAD_OP_H_
