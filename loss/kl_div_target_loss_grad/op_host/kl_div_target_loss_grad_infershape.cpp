...
static ge::graphStatus InferShape4InIdx1AndOutIdx0(gert::InferShapeContext* context)
{
    ...
    return CopyShapeInput2OutputWithForKlDivTargetLossGrad(context, input_index, output_index);
}

graphStatus InferDtypeForKlDivTargetLossGrad(gert::InferDataTypeContext* context)
{
