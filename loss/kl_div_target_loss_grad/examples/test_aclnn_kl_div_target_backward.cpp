...
int main()
{
    ...
    ret = CreateAclTensor(gradTargetHostData, gradTargetShape, &gradTargetDeviceAddr, aclDataType::ACL_FLOAT,
                          &gradTarget);
    CHECK_RET(ret == ACL_SUCCESS, return ret);
    ...
    ret = aclnnKlDivTargetBackwardGetWorkspaceSize(gradOutput, self, target, reduction, logTarget, gradTarget,
