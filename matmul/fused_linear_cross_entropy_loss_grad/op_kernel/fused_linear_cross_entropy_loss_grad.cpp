                                                                           ...
                                                                           GM_ADDR tiling)
{
    ...
    if TILING_KEY_IS (HIGH_PERF_KEY) {
        ...
        using MM = MatmulImpl<MatmulType<AscendC::TPosition::GM, CubeFormat::NZ, DTYPE_INPUT, true>,
                              MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT>,
                              MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT>,
                              MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT>, MM_MDL_CFG>;
        ...
        using MM0 = MatmulImpl<MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT>,
                               MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT, true>,
                               MatmulType<AscendC::TPosition::GM, CubeFormat::ND, float>,
                               MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT>, MM_MDL_CFG>;
        using MM1 = MatmulImpl<MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT>,
                               MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT>,
                               MatmulType<AscendC::TPosition::GM, CubeFormat::ND, float>,
                               MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT>, MM_MDL_CFG>;
        using MM2 = MatmulImpl<MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT, true>,
                               MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT>,
                               MatmulType<AscendC::TPosition::GM, CubeFormat::ND, float>,
                               MatmulType<AscendC::TPosition::GM, CubeFormat::ND, DTYPE_INPUT>, MM_MDL_CFG>;

        FusedLinearCrossEntropyLossGradMemFriendly<DTYPE_INPUT, DTYPE_TARGET_MASK, DTYPE_MASKED_TARGET, MM0, MM1, MM2>
            op;
        op.Init(grad, input, weight, target_mask, masked_target, logits_max, sum_exp_logits, input_grad_out,
                weight_grad_out, workspace, tdp);
        op.Process();
    }
