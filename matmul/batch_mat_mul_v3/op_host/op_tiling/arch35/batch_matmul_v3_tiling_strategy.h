...
constexpr int32_t AL1_FULL_LOAD = 4;
constexpr int32_t BL1_FULL_LOAD_BASIC = 5;
constexpr int32_t BL1_FULL_LOAD = 6;
...
const static std::map<platform_ascendc::SocVersion, std::vector<int32_t>> BatchMatMulV3PrioritiesMap = {
    {platform_ascendc::SocVersion::ASCEND910_95,
     {strategy::BATCH_MATMUL_INPUT_K_EQUAL_ZERO, strategy::BATCH_MATMUL_TO_MUL,
      strategy::ITER_BATCH, strategy::AL1_FULL_LOAD, strategy::BL1_FULL_LOAD_BASIC,
