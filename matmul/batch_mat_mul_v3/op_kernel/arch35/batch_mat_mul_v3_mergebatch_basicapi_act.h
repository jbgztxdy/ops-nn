...
/* !
 * \file batch_mat_mul_v3_mergebatch_basicapi_act.h
 * \brief
 */
#ifndef BATCH_MAT_MUL_V3_MERGEBATCH_BASICAPI_ACT_H
#define BATCH_MAT_MUL_V3_MERGEBATCH_BASICAPI_ACT_H
#include "matmul_act/matmul/kernel/kernel_matmul_merge_batch.h"
