...
int aclnnQuantMatmulWeightNzTest(int32_t deviceId, aclrtStream& stream)
{
    ...
    workspaceSize = 0;
    ret = aclnnQuantMatmulWeightNzGetWorkspaceSize(x1, x2Transposed, nullptr, quantParam, nullptr, nullptr, nullptr,
                                                   nullptr, bias, transposeX1, transposeX2, 0, out, &workspaceSize,
                                                   &executor);
