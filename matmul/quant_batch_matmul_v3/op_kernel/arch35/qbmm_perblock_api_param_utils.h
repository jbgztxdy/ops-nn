    ...
    LoadData2DParamsV2& loadData2dParams, const uint64_t& kOffset, const bool& isTailAL1)
{
    ...
    if constexpr (aTrans) {
        ...
        loadData2dParams.srcStride = DequantBmm::Align(DequantBmm::CeilDiv(isTailAL1 ? kA1Tail_ : kA1_, k0_FLOAT16),
                                                       2UL);
        loadData2dParams.dstStride = DequantBmm::Align(DequantBmm::CeilDiv(currM, static_cast<uint64_t>(k0_FLOAT16)),
                                                       2UL);
        ...
        loadData2dParams.srcStride = DequantBmm::CeilDiv(currM * matmulTiling_->stepM,
                                                         static_cast<uint64_t>(k0_FLOAT16));
    ...
    LoadData2DParamsV2& loadData2dParams, const uint64_t& kOffset, const bool& isTailBL1)
{
    ...
    if constexpr (bTrans) {
        ...
        loadData2dParams.kStep = DequantBmm::CeilDiv(currK, static_cast<uint64_t>(K0_INT8));
        loadData2dParams.srcStride = DequantBmm::CeilDiv(currN * matmulTiling_->stepN,
                                                         static_cast<uint64_t>(k0_FLOAT16));
        ...
        loadData2dParams.srcStride = DequantBmm::Align(DequantBmm::CeilDiv(isTailBL1 ? kB1Tail_ : kB1_, k0_FLOAT16),
                                                       2UL);
        loadData2dParams.dstStride = DequantBmm::Align(DequantBmm::CeilDiv(currN, static_cast<uint64_t>(k0_FLOAT16)),
                                                       2UL);
    }
}
} // namespace QuantBatchMatmulV3
