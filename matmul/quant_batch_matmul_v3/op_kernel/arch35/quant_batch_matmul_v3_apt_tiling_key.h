...
#define QBMMV3_IS_MX_DTYPE_TPL false
    ...
    ASC_DEVKIT_MAJOR >= 9 && ASC_DEVKIT_MINOR > 0
#define SUPPORT_MX_WITHOUT_BATCH_TILING_KEY QBMMV3_IS_MX_DTYPE_TPL
#else
#define SUPPORT_MX_WITHOUT_BATCH_TILING_KEY false
#endif

#if defined(__CCE_AICORE__) && defined(FORMAT_X2)
#define QBMMV3_IS_MX_TPL QBMMV3_IS_MX_DTYPE_TPL
#else
...
#if !__FIXED_POINT_ONLY_CUBE_TO_L0C__ && \
    defined(ASC_DEVKIT_MAJOR) && defined(ASC_DEVKIT_MINOR) && ASC_DEVKIT_MAJOR >= 9 && ASC_DEVKIT_MINOR > 0 &&     \
    defined(ORIG_DTYPE_X1) && defined(ORIG_DTYPE_X2) && defined(ORIG_DTYPE_SCALE) && defined(FORMAT_X2) &&         \
    defined(FORMAT_FRACTAL_NZ) &&                                                                                  \
...
#define SUPPORT_MIX_WITHOUT_BATCH_TILING_KEY                                                                       \
    ...
    (ORIG_DTYPE_X2 == DT_FLOAT8_E4M3FN || ORIG_DTYPE_X2 == DT_HIFLOAT8) &&                                         \
    (ORIG_DTYPE_SCALE == DT_FLOAT) && ORIG_DTYPE_Y != DT_INT32) || (ORIG_DTYPE_X1 == DT_INT8 &&                    \
    ORIG_DTYPE_X2 == DT_INT8 && ORIG_DTYPE_Y == DT_BF16 && (ORIG_DTYPE_SCALE == DT_FLOAT ||                        \
    ORIG_DTYPE_SCALE == DT_BF16))) && FORMAT_X2 == FORMAT_FRACTAL_NZ && ORIG_DTYPE_X1 == ORIG_DTYPE_X2
#else
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(
        KERNELTYPE, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, TPL_NO_VEC_EPILOGUE_WITH_MMAPI,
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(       // kernel type {11, 12} * ATRANS {0} * BTRANS {0, 1}
        ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),
        ASCENDC_TPL_UINT_SEL(ATRANS, ASCENDC_TPL_UI_LIST, 0),
    ...
    ASCENDC_TPL_ARGS_SEL(       // kernel type {2, 3} * ATRANS {1} * BTRANS {0, 1}
        ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),
        ASCENDC_TPL_UINT_SEL(ATRANS, ASCENDC_TPL_UI_LIST, 1),
        ASCENDC_TPL_UINT_SEL(BTRANS, ASCENDC_TPL_UI_LIST, 0, 1),
    ...
    ASCENDC_TPL_ARGS_SEL(       // kernel type {11, 12, 13, 14} * api level {2} * ATRANS {0, 1} * BTRANS {0, 1}
        ...
        ASCENDC_TPL_UINT_SEL(
            KERNELTYPE, ASCENDC_TPL_UI_LIST, TPL_NO_VEC_EPILOGUE_WITH_MMAPI_MX_L0C_PINGPONG,
            TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI_MX_L0C_PINGPONG,
            TPL_NO_VEC_EPILOGUE_WITH_MMAPI_MX_L0C_PINGPONG_WITHOUT_BATCH,
            TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI_MX_L0C_PINGPONG_WITHOUT_BATCH),
        ASCENDC_TPL_UINT_SEL(APILEVEL, ASCENDC_TPL_UI_LIST, TPL_API_LEVEL_BLAZE)),
    ...
    ASCENDC_TPL_ARGS_SEL( // kernel type {0, 1} * api level {2} * ATRANS {0, 1} * BTRANS {0, 1}
        ...
        ASCENDC_TPL_UINT_SEL(APILEVEL, ASCENDC_TPL_UI_LIST, TPL_API_LEVEL_BLAZE)),
#endif
#if ((!defined(__CCE_AICORE__)) || (defined(__NPU_ARCH__) && (__NPU_ARCH__ == 3510) && !IS_BLAZE && \
