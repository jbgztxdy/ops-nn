...
TEST_F(l2_mv_test, l2_mv_test_03)
{
    ...
    test_run_invalid({2, 3}, ACL_BF16, ACL_FORMAT_ND, {-10, 10}, {3}, ACL_BF16, ACL_FORMAT_ND, {-15, -10}, {2},
                     ACL_BF16, ACL_FORMAT_ND, 1);
}
...
TEST_F(l2_mv_test, l2_mv_test_06)
{
    ...
    test_run({3, 0}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {0}, ACL_BOOL, ACL_FORMAT_ND, {-15, -10}, {3}, ACL_BOOL,
             ACL_FORMAT_ND, 1);
    test_run_invalid({3, 0}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {0}, ACL_FLOAT16, ACL_FORMAT_ND, {-15, -10}, {3},
                     ACL_BOOL, ACL_FORMAT_ND, 1);
}
