...
protected:
    ...
    static void MatMulCommonTest(TensorDesc x1_desc, TensorDesc x2_desc, TensorDesc bias_desc,
                                 TensorDesc addOffset_desc, TensorDesc mulScale_desc, TensorDesc diagonalMatrix_desc,
                                 TensorDesc deqOffset_desc, TensorDesc deqScale_desc, bool transpose_a,
                                 bool transpose_b, TensorDesc out_desc, aclnnStatus expect_status)
    {
        auto ut = OP_API_UT(aclnnWeightQuantBatchMatmul,
                            INPUT(x1_desc, x2_desc, diagonalMatrix_desc, deqOffset_desc, deqScale_desc, addOffset_desc,
                                  mulScale_desc, bias_desc, transpose_a, transpose_b, 1.0, 1.0),
                            OUTPUT(out_desc));
...
TEST_F(l2_weight_quant_batch_matmul_test, ascend910B2_test_mm_case_0)
{
    ...
    TensorDesc addOffset_desc = TensorDesc(
        {
            1,
        },
        ACL_FLOAT16, ACL_FORMAT_ND);
    TensorDesc mulScale_desc = TensorDesc(
        {
            1,
        },
        ACL_FLOAT16, ACL_FORMAT_ND);
    TensorDesc diagonalMatrix_desc = TensorDesc({32, 32}, ACL_INT8, ACL_FORMAT_ND);
    TensorDesc deqOffset_desc = TensorDesc(
        {
            16,
        },
        ACL_INT32, ACL_FORMAT_ND);
    TensorDesc deqScale_desc = TensorDesc(
        {
            16,
        },
        ACL_UINT64, ACL_FORMAT_ND);
    TensorDesc out_desc = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND);
    MatMulCommonTest(x1_desc, x2_desc, bias_desc, addOffset_desc, mulScale_desc, diagonalMatrix_desc, deqOffset_desc,
                     deqScale_desc, false, false, out_desc, ACL_SUCCESS);
}
...
TEST_F(l2_weight_quant_batch_matmul_test, ascend910B2_test_mm_case_1)
{
    ...
    TensorDesc out_desc = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND);
    MatMulCommonTest(x1_desc, x2_desc, bias_desc, addOffset_desc, mulScale_desc, diagonalMatrix_desc, deqOffset_desc,
                     deqScale_desc, false, false, out_desc, ACLNN_ERR_PARAM_INVALID);
}
...
TEST_F(l2_weight_quant_batch_matmul_test, ascend910B2_test_mm_emptyinput)
{
    ...
    MatMulCommonTest(x1_desc, x2_desc, bias_desc, addOffset_desc, mulScale_desc, diagonalMatrix_desc, deqOffset_desc,
                     deqScale_desc, false, false, out_desc, ACLNN_SUCCESS);
}
...
TEST_F(l2_weight_quant_batch_matmul_test, ascend910B2_test_bmm_scaleN_offsetN_SingleOp_tranx1)
{
    ...
    TensorDesc out_desc = TensorDesc({128, 16}, ACL_FLOAT16, ACL_FORMAT_ND);
    MatMulCommonTest(x1_desc, x2_desc, bias_desc, addOffset_desc, mulScale_desc, diagonalMatrix_desc, deqOffset_desc,
                     deqScale_desc, true, false, out_desc, ACLNN_SUCCESS);
}
...
TEST_F(l2_weight_quant_batch_matmul_test, ascend910B2_test_bmm_scaleN_SingleOp_tranx2)
{
    ...
    TensorDesc bias_desc = TensorDesc(
        {
            8,
        },
    ...
    MatMulCommonTest(x1_desc, x2_desc, bias_desc, addOffset_desc, mulScale_desc, diagonalMatrix_desc, deqOffset_desc,
                     deqScale_desc, false, true, out_desc, ACLNN_SUCCESS);
}
