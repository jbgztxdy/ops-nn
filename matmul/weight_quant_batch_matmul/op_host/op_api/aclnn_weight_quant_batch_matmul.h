...
__attribute__((deprecated(
    "aclnnWeightQuantBatchMatmulGetWorkspaceSize is scheduled to be deprecated in a post-December 2026 version update, "
...
aclnnWeightQuantBatchMatmulGetWorkspaceSize(const aclTensor* x1, const aclTensor* x2, const aclTensor* diagonalMatrix,
                                            const aclTensor* deqOffset, const aclTensor* deqScale,
 ...
 */
__attribute__((
    deprecated("aclnnWeightQuantBatchMatmul is scheduled to be deprecated in a post-December 2026 version update, "
               "and will be replaced by the aclnnWeightQuantBatchMatmulV3. "
               "We apologize for any inconvenience caused and appreciate your timely migration to the new interface.")))
ACLNN_API aclnnStatus
aclnnWeightQuantBatchMatmul(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, const aclrtStream stream);
