...
ASCENDC_TPL_ARGS_DECL(MatmulCompress,
                      ASCENDC_TPL_UINT_DECL(PP_MAT_MUL_MODE, ASCENDC_TPL_1_BW, ASCENDC_TPL_UI_LIST,
                                            MATMUL_COMPRESS_PP_MAT_MUL_MODE_FALSE,
                                            MATMUL_COMPRESS_PP_MAT_MUL_MODE_TRUE),
                      ASCENDC_TPL_UINT_DECL(TRANS, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, MATMUL_COMPRESS_NOT_TRANS,
                                            MATMUL_COMPRESS_A_TRANS, MATMUL_COMPRESS_B_TRANS,
                                            MATMUL_COMPRESS_ALL_TRANS), );

ASCENDC_TPL_SEL(
#if defined(__NPU_ARCH__) && (__NPU_ARCH__ == 2002)
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(PP_MAT_MUL_MODE, ASCENDC_TPL_UI_LIST,
                                              MATMUL_COMPRESS_PP_MAT_MUL_MODE_TRUE),
