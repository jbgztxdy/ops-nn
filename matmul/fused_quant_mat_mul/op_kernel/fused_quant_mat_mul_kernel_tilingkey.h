...
ASCENDC_TPL_ARGS_DECL(FusedQuantMatMul,
                      ...
                      ASCENDC_TPL_UINT_DECL(OPTION_ATTRS, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST,
                                            ...
                                            QUANT_BATCH_MATMUL_V3_NEED_ATOMICLEAN, QUANT_BATCH_MATMUL_V3_IS_AICAIV_1_2),
                      ASCENDC_TPL_UINT_DECL(FUSED_OPTYPE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, FUSED_OPTYPE_NONE,
                                            FUSED_OPTYPE_RELU, FUSED_OPTYPE_SWIGLU, FUSED_OPTYPE_GELU_TANH,
                                            FUSED_OPTYPE_GELU_ERF), );
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(SET_CV11_ATTR_NONE(QUANT_BATCH_MATMUL_V3_NOT_TRANS, BASIC, IS_PERTOKEN),
                         ASCENDC_TPL_UINT_SEL(FUSED_OPTYPE, ASCENDC_TPL_UI_LIST, FUSED_OPTYPE_GELU_TANH,
                                              FUSED_OPTYPE_GELU_ERF), ),
