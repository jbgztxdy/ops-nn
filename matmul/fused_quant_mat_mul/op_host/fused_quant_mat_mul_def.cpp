...
public:
    explicit FusedQuantMatMul(const char* name) : OpDef(name)
    {
        this->Input("x1")
            .ParamType(REQUIRED)
            .DataType({// 第1-12组：y=FP16分支（x1/x2 dtype: int8×6组 + int4×6组）
                       ...
                       ge::DT_INT8, ge::DT_INT8, ge::DT_INT8, ge::DT_INT8, ge::DT_INT8, ge::DT_INT4, ge::DT_INT4,
        ...
        this->Input("x2")
            .ParamType(REQUIRED)
            .DataType({// 第1-12组：y=FP16分支（x1/x2 dtype与x1一致）
                       ge::DT_INT8, ge::DT_INT8, ge::DT_INT8, ge::DT_INT8, ge::DT_INT8, ge::DT_INT8, ge::DT_INT4,
                       ge::DT_INT4, ge::DT_INT4, ge::DT_INT4, ge::DT_INT4, ge::DT_INT4,
                       ...
                       ge::DT_INT4, ge::DT_INT4, ge::DT_INT4, ge::DT_INT4, ge::DT_INT4, ge::DT_INT4, ge::DT_INT4,
                       ge::DT_INT4, ge::DT_INT4, ge::DT_INT4})
            .Format({// 第1-3组：x2=ND；4-6组：x2=FRACTAL_NZ；7-9组：x2=ND；10-12组：x2=FRACTAL_NZ
        ...
        this->Input("bias")
            .ParamType(OPTIONAL)
            .DataType({// 第1-12组：y=FP16分支（bias: int32/fp16/fp32）
                       ge::DT_INT32, ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_INT32, ge::DT_FLOAT16, ge::DT_FLOAT,
                       ge::DT_INT32, ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_INT32, ge::DT_FLOAT16, ge::DT_FLOAT,
                       // 第13-36组：y=BF16分支（bias: int32/BF16/fp32）
                       ge::DT_INT32, ge::DT_INT32, ge::DT_BF16, ge::DT_BF16, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_INT32,
                       ge::DT_INT32, ge::DT_BF16, ge::DT_BF16, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_INT32, ge::DT_INT32,
                       ge::DT_BF16, ge::DT_BF16, ge::DT_FLOAT, ge::DT_FLOAT, ge::DT_INT32, ge::DT_INT32, ge::DT_BF16,
        ...
        this->Input("x2_scale")
            .ParamType(OPTIONAL)
            .DataType({// 第1-12组：y=FP16分支（全部为FP32）
