...
{
    detail::TileCastImpl<AscendC::Std::remove_cvref_t<ArchTag>, AscendC::Std::remove_cvref_t<TensorOut>,
                         AscendC::Std::remove_cvref_t<TensorIn>, AscendC::Std::remove_cvref_t<Shape> >::Run(tensorOut,
                                                                                                            tensorIn,
                                                                                                            shape);
};
} // namespace Cmct::Prologue::Tile
