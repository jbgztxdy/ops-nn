...
public:
    ...
    __aicore__ inline BlockSchedulerSwizzleInMnCore(Params const &params)
    {
        ...
        uint64_t singleM = Cmct::Gemm::CeilAlign(Cmct::Gemm::CeilDiv(mSize_, blockDimM), AscendC::BLOCK_CUBE);
        uint64_t singleN = Cmct::Gemm::CeilAlign(Cmct::Gemm::CeilDiv(nSize_, blockDimN), AscendC::BLOCK_CUBE);
        ...
        mIter_ = Cmct::Gemm::CeilDiv(mSingleCoreSize, mL1Size_);
        nIter_ = Cmct::Gemm::CeilDiv(nSingleCoreSize, nL1Size_);
