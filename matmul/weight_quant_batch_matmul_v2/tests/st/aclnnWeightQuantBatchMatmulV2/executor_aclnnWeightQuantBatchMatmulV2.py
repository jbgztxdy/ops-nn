...
@register("execute_weight_quant_batch_matmul_v2")
class weightQuantBatchMatmulV2Api(BaseApi):
...
@register("execute_aclnn_weight_quant_batch_matmul_v2")
class aclnnWeightQuantBatchMatmulV2Api(AclnnBaseApi):
