...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL( // 平台大类
        SOC_VERSION_TYPE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, WQBMMV2_SOC_RESERVERD, WQBMMV2_SOC_SUPPORT_L0C_TO_OUT,
    ...
    ASCENDC_TPL_UINT_DECL( // 算法大类
        ...
        WQBMMV2_ALGO_MULTI_SCALE_DEQUANT, WQBMMV2_ALGO_FIXPIPE_ANTIQUANT, WQBMMV2_ALGO_CUSTOM),
    ASCENDC_TPL_UINT_DECL( // 算法小类
        ...
        WQBMMV2_SUB_ALGO_N_FIRST_TAIL_RESPLIT, WQBMMV2_SUB_ALGO_N_FIRST_BASIC_BLOCK),
    ...
    ASCENDC_TPL_UINT_DECL( // innerPrecise
        INNER_PRECISE, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, WQBMMV2_INNER_PRECISE_ZERO, WQBMMV2_INNER_PRECISE_ONE),
    ASCENDC_TPL_UINT_DECL( // fix模板自定义
        TEMPLATE_CUSTOM, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, WQBMMV2_TEMPLATE_CUSTOM_A_NORMAL_LOAD,
    ...
    ASCENDC_TPL_UINT_DECL( // Extra模板类型
        TEMPLATE_EXTRA, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, PLACEHOLDER_0, WQBMMV2_TEMPLATE_EXTRA_MSD_GENERAL,
        WQBMMV2_TEMPLATE_EXTRA_HIGH_PRECISION, WQBMMV2_TEMPLATE_EXTRA_NOT_USED),
    ASCENDC_TPL_UINT_DECL( // FullLoadMode
        FULL_LOAD_MODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, WQBMMV2_FULL_LOAD_MODE_NONE_AB_K,
        WQBMMV2_FULL_LOAD_MODE_FULL_AKL1, WQBMMV2_FULL_LOAD_MODE_FULL_BKL1, WQBMMV2_FULL_LOAD_MODE_FULL_K,
        WQBMMV2_FULL_LOAD_MODE_FULL_K_REORDER_MN, WQBMMV2_FULL_LOAD_MODE_NOT_USED),
    ASCENDC_TPL_UINT_DECL( // batch
        BATCH, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, WQBMMV2_BATCH_ZERO, WQBMMV2_BATCH_ONE), );
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
                    ...
                    ASCENDC_TPL_BOOL_SEL(HAS_ANTIQUANT_OFFSET, 0, 1), ASCENDC_TPL_BOOL_SEL(HAS_BIAS, 0, 1),
                    ASCENDC_TPL_BOOL_SEL(IS_BIAS_FP32, 0), ASCENDC_TPL_BOOL_SEL(IS_WEIGHT_NZ, 0),
#if (defined(__NPU_ARCH__) && __NPU_ARCH__ == 3003)
                    ASCENDC_TPL_UINT_SEL(TEMPLATE_EXTRA, ASCENDC_TPL_UI_LIST, PLACEHOLDER_0,
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
                    ...
                    ASCENDC_TPL_UINT_SEL(TEMPLATE_CUSTOM, ASCENDC_TPL_UI_LIST, WQBMMV2_TEMPLATE_CUSTOM_A_NORMAL_LOAD),
                    ASCENDC_TPL_UINT_SEL(API_CONSTEXPR, ASCENDC_TPL_UI_LIST, WQBMMV2_DEFAULT),
                    ASCENDC_TPL_BOOL_SEL(TRANS_A, 0, 1), ASCENDC_TPL_BOOL_SEL(TRANS_B, 0, 1),
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(FULL_LOAD_MODE, ASCENDC_TPL_UI_LIST, WQBMMV2_FULL_LOAD_MODE_NOT_USED),
        ASCENDC_TPL_UINT_SEL(BATCH, ASCENDC_TPL_UI_LIST, WQBMMV2_BATCH_ZERO)),
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(SOC_VERSION_TYPE, ASCENDC_TPL_UI_LIST, WQBMMV2_SOC_SUPPORT_L0C_TO_OUT),
                         ASCENDC_TPL_UINT_SEL(SUB_SOC_VERSION_TYPE, ASCENDC_TPL_UI_LIST, WQBMMV2_DEFAULT),
                         ASCENDC_TPL_UINT_SEL(ANTIQUANT_SCENARIO, ASCENDC_TPL_UI_LIST, WQBMMV2_DEFAULT),
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(SOC_VERSION_TYPE, ASCENDC_TPL_UI_LIST, WQBMMV2_SOC_SUPPORT_L0C_TO_OUT),
                         ...
                         ASCENDC_TPL_UINT_SEL(ANTIQUANT_TYPE, ASCENDC_TPL_UI_LIST, WQBMMV2_ANTIQUANT_TYPE_PER_GROUP),
                         ASCENDC_TPL_UINT_SEL(QUANT_TYPE, ASCENDC_TPL_UI_LIST, WQBMMV2_QUANT_TYPE_PER_TENSOR),
                         ASCENDC_TPL_BOOL_SEL(HAS_ANTIQUANT_OFFSET, 1), ASCENDC_TPL_BOOL_SEL(HAS_BIAS, 0),
                         ASCENDC_TPL_BOOL_SEL(IS_BIAS_FP32, 0), ASCENDC_TPL_BOOL_SEL(IS_WEIGHT_NZ, 0),
                         ASCENDC_TPL_UINT_SEL(TEMPLATE_EXTRA, ASCENDC_TPL_UI_LIST, WQBMMV2_TEMPLATE_EXTRA_NOT_USED),
                         ASCENDC_TPL_UINT_SEL(FULL_LOAD_MODE, ASCENDC_TPL_UI_LIST, WQBMMV2_FULL_LOAD_MODE_NOT_USED),
                         ASCENDC_TPL_UINT_SEL(BATCH, ASCENDC_TPL_UI_LIST, WQBMMV2_BATCH_ZERO)), );
