...
// fixp方案
    ...
    if ASCEND_IS_AIC {
        if constexpr (SOC_VERSION_TYPE == WQBMMV2_SOC_SUPPORT_L0C_TO_OUT && SUB_SOC_VERSION_TYPE == WQBMMV2_DEFAULT &&
                      ...
                      ANTIQUANT_TYPE == WQBMMV2_ANTIQUANT_TYPE_PER_CHANNEL && QUANT_TYPE == WQBMMV2_QUANT_TYPE_NONE &&
                      IS_BIAS_FP32 == 0 && IS_WEIGHT_NZ == 0) {
            static constexpr bool A_FULL_LOAD = TEMPLATE_CUSTOM ==
            ...
            INVOKE_WEIGHT_QUANT_BMM_OP_FIXPIPE_IMPL(WeightQuantBatchMatmulV2FixpipeKernel, false, true,
                                                    QuantType::PER_CHANNEL, QuantType::NONE, HAS_ANTIQUANT_OFFSET,
                                                    HAS_BIAS, CubeFormat::ND, A_FULL_LOAD);
        }
    }
#endif
#elif (ORIG_DTYPE_Y == DT_INT8)
    if constexpr (SUB_ALGORITHM_CUSTOM == WQBMMV2_SUB_ALGO_CUSTOM_ANTIQUANT && ALGORITHM == WQBMMV2_ALGO_CUSTOM &&
                  IS_WEIGHT_NZ == 0 && TEMPLATE_EXTRA == WQBMMV2_TEMPLATE_EXTRA_NOT_USED &&
        ...
        INVOKE_WEIGHT_QUANT_BMM_OP_IMPL(WeightQuantBatchMatmulV2CustomKernel, TRANS_A, TRANS_B, antiQuantType,
    ...
    if constexpr (SUB_ALGORITHM_CUSTOM == WQBMMV2_SUB_ALGO_CUSTOM_ANTIQUANT && ALGORITHM == WQBMMV2_ALGO_CUSTOM &&
        ...
        INVOKE_WEIGHT_QUANT_BMM_OP_MSD_IMPL(WeightQuantBatchMatmulV2MsdMultiCoreKernel, false, TRANS_B,
                                            QuantType::PER_CHANNEL, HAS_ANTIQUANT_OFFSET, QuantType::PER_TENSOR,
                                            CubeFormat::ND);
                         ...
                         QUANT_TYPE == WQBMMV2_QUANT_TYPE_PER_TENSOR && TRANS_B == 0 && TRANS_A == 0 &&
                         ALGORITHM == WQBMMV2_ALGO_CUSTOM && FULL_LOAD_MODE == WQBMMV2_FULL_LOAD_MODE_NOT_USED) {
        static constexpr QuantType antiQuantType = static_cast<QuantType>(ANTIQUANT_TYPE);
        // 模板参数为aTrans bTrans antiQuantType hasAntiQuantOffset quantType weightFormat
        INVOKE_WEIGHT_QUANT_BMM_OP_MSD_IMPL(WeightQuantBatchMatmulV2MsdSplitKKernel, false, false, antiQuantType,
                                            HAS_ANTIQUANT_OFFSET, QuantType::PER_TENSOR, CubeFormat::ND);
                         ...
                         QUANT_TYPE == WQBMMV2_QUANT_TYPE_NONE && HAS_BIAS == 0 && IS_BIAS_FP32 == 0 &&
                         IS_WEIGHT_NZ == 0) {
        // 模板参数为aTrans bTrans antiQuantType hasAntiQuantOffset quantType weightFormat preciseType
        INVOKE_WEIGHT_QUANT_BMM_OP_MSD_IMPL(WeightQuantBatchMatmulV2MsdSplitKKernel, false, false, QuantType::PER_GROUP,
                                            HAS_ANTIQUANT_OFFSET, QuantType::PER_GROUP, CubeFormat::ND,
                                            HighPerformanceType);
    } else if constexpr (TEMPLATE_EXTRA == WQBMMV2_TEMPLATE_EXTRA_MSD_GENERAL && IS_WEIGHT_NZ == 0 &&
                         SUB_ALGORITHM_CUSTOM == WQBMMV2_SUB_ALGO_MSD_MULTI_CORE &&
                         QUANT_TYPE == WQBMMV2_QUANT_TYPE_PER_TENSOR &&
        ...
        INVOKE_WEIGHT_QUANT_BMM_OP_MSD_IMPL(WeightQuantBatchMatmulV2MsdMultiCoreKernel, false, true,
                                            QuantType::PER_CHANNEL, HAS_ANTIQUANT_OFFSET, QuantType::PER_TENSOR,
                                            CubeFormat::ND, PrecisionType::HIGH_PRECISION);
        ...
        WeightQuantBatchMatMulV2MsdGroupKernel<DTYPE_X, DTYPE_WEIGHT, DTYPE_BIAS, DTYPE_Y, false, false,
                                               QuantType::PER_GROUP, HAS_ANTIQUANT_OFFSET, QuantType::PER_TENSOR,
    ...
    if constexpr (SUB_ALGORITHM_CUSTOM == WQBMMV2_SUB_ALGO_WEIGHT_NZ && QUANT_TYPE == WQBMMV2_QUANT_TYPE_PER_TENSOR &&
                  ANTIQUANT_TYPE == WQBMMV2_ANTIQUANT_TYPE_PER_CHANNEL && ALGORITHM == WQBMMV2_ALGO_CUSTOM &&
                  TEMPLATE_EXTRA == WQBMMV2_TEMPLATE_EXTRA_NOT_USED &&
                  FULL_LOAD_MODE == WQBMMV2_FULL_LOAD_MODE_NOT_USED) {
        // 模板参数为aTrans bTrans antiQuantType hasAntiQuantOffset quantType
        INVOKE_WEIGHT_QUANT_BMM_OP_IMPL(WeightQuantBatchMatmulV2CustomWeightNzKernel, TRANS_A, TRANS_B,
                                        QuantType::PER_CHANNEL, HAS_ANTIQUANT_OFFSET, QuantType::PER_TENSOR);
                         ...
                         FULL_LOAD_MODE == WQBMMV2_FULL_LOAD_MODE_NOT_USED) {
        // 模板参数为aTrans bTrans antiQuantType hasAntiQuantOffset quantType
        INVOKE_WEIGHT_QUANT_BMM_OP_IMPL(WeightQuantBatchMatmulV2CustomWeightNzKernel, false, TRANS_B,
                                        QuantType::PER_GROUP, HAS_ANTIQUANT_OFFSET, QuantType::PER_TENSOR);
        ...
        INVOKE_WEIGHT_QUANT_BMM_OP_MSD_IMPL(WeightQuantBatchMatmulV2MsdMultiCoreKernel, false, TRANS_B,
                         ...
                         QUANT_TYPE == WQBMMV2_QUANT_TYPE_NONE && HAS_BIAS == 0 && IS_BIAS_FP32 == 0 &&
                         IS_WEIGHT_NZ == 1) {
        using SelectedType = std::conditional_t<(INNER_PRECISE == WQBMMV2_INNER_PRECISE_ONE), HighPerformanceType,
                                                HighPreciseType>;
        // 模板参数为aTrans bTrans antiQuantType hasAntiQuantOffset quantType weightFormat preciseType
        INVOKE_WEIGHT_QUANT_BMM_OP_MSD_IMPL(WeightQuantBatchMatmulV2MsdSplitKKernel, false, false, QuantType::PER_GROUP,
                                            HAS_ANTIQUANT_OFFSET, QuantType::PER_GROUP, CubeFormat::NZ, SelectedType);
        ...
        INVOKE_WEIGHT_QUANT_BMM_OP_MSD_IMPL(WeightQuantBatchMatmulV2MsdMultiCoreKernel, false, true,
                                            QuantType::PER_CHANNEL, HAS_ANTIQUANT_OFFSET, QuantType::PER_TENSOR,
                                            CubeFormat::NZ, PrecisionType::HIGH_PRECISION);
                         ...
                         ALGORITHM == WQBMMV2_ALGO_CUSTOM && FULL_LOAD_MODE == WQBMMV2_FULL_LOAD_MODE_NOT_USED) {
        // 模板参数为aTrans bTrans antiQuantType hasAntiQuantOffset quantType weightFormat
        INVOKE_WEIGHT_QUANT_BMM_OP_MSD_IMPL(WeightQuantBatchMatmulV2MsdSplitKKernel, false, TRANS_B,
                                            QuantType::PER_CHANNEL, HAS_ANTIQUANT_OFFSET, QuantType::PER_TENSOR,
                                            CubeFormat::NZ);
    } else if constexpr (SOC_VERSION_TYPE == WQBMMV2_SOC_SUPPORT_L0C_TO_OUT &&
                         SUB_SOC_VERSION_TYPE == WQBMMV2_DEFAULT && ANTIQUANT_SCENARIO == WQBMMV2_DEFAULT &&
        ...
        op.Process();
                         ...
                         INNER_PRECISE == WQBMMV2_INNER_PRECISE_ZERO && API_CONSTEXPR == WQBMMV2_DEFAULT &&
        ...
        static constexpr bool AL1_FULL_LOAD = TEMPLATE_CUSTOM == WQBMMV2_TEMPLATE_CUSTOM_A_SINGLE_M_SINGLE_K_FULL_LOAD ?
                                                  true :
                                                  false;
        INVOKE_WEIGHT_QUANT_BMM_OP_CUSTOM_SPLITK_IMPL(WeightQuantBatchMatmulV2CustomNzSplitkKernel, false, true,
                                                      QuantType::PER_CHANNEL, HAS_ANTIQUANT_OFFSET,
    ...
    if constexpr (BATCH == WQBMMV2_BATCH_ZERO && SUB_ALGORITHM_CUSTOM == WQBMMV2_SUB_ALGO_WEIGHT_NZ &&
                  FULL_LOAD_MODE == WQBMMV2_FULL_LOAD_MODE_NONE_AB_K && ALGORITHM == WQBMMV2_ALGO_CUSTOM &&
                  TEMPLATE_EXTRA == WQBMMV2_TEMPLATE_EXTRA_NOT_USED) {
        // 模板参数为aTrans bTrans antiQuantType hasAntiQuantOffset
        static constexpr QuantType antiQuantType = static_cast<QuantType>(ANTIQUANT_TYPE);
        INVOKE_WEIGHT_QUANT_BMM_OP_NZ_IMPL(WeightQuantBatchMatmulV2WeightNzPerformanceKernel, TRANS_A, true,
                                           antiQuantType, HAS_ANTIQUANT_OFFSET);
    } else if constexpr (BATCH == WQBMMV2_BATCH_ONE && SUB_ALGORITHM_CUSTOM == WQBMMV2_SUB_ALGO_WEIGHT_NZ &&
                         FULL_LOAD_MODE == WQBMMV2_FULL_LOAD_MODE_NONE_AB_K && ALGORITHM == WQBMMV2_ALGO_CUSTOM &&
                         TEMPLATE_EXTRA == WQBMMV2_TEMPLATE_EXTRA_NOT_USED) {
        // 模板参数为aTrans bTrans antiQuantType hasAntiQuantOffset
        static constexpr QuantType antiQuantType = static_cast<QuantType>(ANTIQUANT_TYPE);
        INVOKE_WEIGHT_QUANT_BMM_OP_NZ_IMPL(WeightQuantBatchMatmulV2WeightNzKernel, TRANS_A, true, antiQuantType,
                                           HAS_ANTIQUANT_OFFSET);
    }
#endif
}