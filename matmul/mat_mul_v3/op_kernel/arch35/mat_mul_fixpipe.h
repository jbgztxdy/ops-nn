...
__aicore__ inline void MatMulFixpipeOptiTensorKernel(
...
using L0TileShape = AscendC::Shape<_128, _256, _64>;
	...
	using BlockMmad = Blaze::Gemm::Block::BlockMmad<DispatchPolicy, AType, LayoutA, BType, LayoutB, OutType,
