...
__aicore__ inline void MatMulToMulActKernel(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR biasGM, GM_ADDR yGM, GM_ADDR workspaceGM,
                                            const MatMulToMulBasicTilingData& tilingData, int64_t batch = 0)
{
    ...
    using BlockMmad = Block::BlockMmadBuilder<AType, LayoutA, BType, LayoutB, OutType, LayoutC, BiasType, LayoutC,
                                              L1TileShape, L0TileShape, BlockScheduler, MatmulToMul<>>;
