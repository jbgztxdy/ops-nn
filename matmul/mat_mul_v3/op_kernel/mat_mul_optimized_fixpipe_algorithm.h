...
class MatmulBaseUnalignedNKernel
...
__aicore__ inline void MatmulBaseUnalignedNKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG, MM_CB,
                                                  FIXPIPE_OPT>::Init(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR cGM,
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE, const MatmulConfig& MM_CFG,
          class MM_CB, FIXPIPE_OPT_SELECT FIXPIPE_OPT>
__aicore__ inline void MatmulBaseUnalignedNKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG, MM_CB,
                                                  FIXPIPE_OPT>::AivProcess(GlobalTensor<C_T>& cTensor,
                                                                           uint8_t pingPongId)
{
    if ASCEND_IS_AIV {
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE, const MatmulConfig& MM_CFG,
          class MM_CB, FIXPIPE_OPT_SELECT FIXPIPE_OPT>
__aicore__ inline void MatmulBaseUnalignedNKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG, MM_CB,
                                                  FIXPIPE_OPT>::AivNz2NdProcess(GlobalTensor<C_T> cNzGlobal,
                                                                                uint8_t pingPongId)
{
    if ASCEND_IS_AIV {
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE, const MatmulConfig& MM_CFG,
          class MM_CB, FIXPIPE_OPT_SELECT FIXPIPE_OPT>
__aicore__ inline void MatmulBaseUnalignedNKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG, MM_CB,
                                                  FIXPIPE_OPT>::Process(uint64_t index, uint8_t enAtomic)
{
    ctx.isFirst = true;
    ...
    const MatmulTilingData* matmulTilingData, TPipe* pipe)
{
    ...
    this->fixpipeInnerParams_.workspaceGMNZ = workspaceGM +
                                              this->baseSize_ * NUM_TWO *
                                                  this->block_.matmulTilingData_->matmulTiling.usedCoreNum * cDtypeSize;
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE, const MatmulConfig& MM_CFG,
          class MM_CB, FIXPIPE_OPT_SELECT FIXPIPE_OPT>
__aicore__ inline void MatmulBaseAToNZWithBL1FixpipeKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG, MM_CB,
                                                           FIXPIPE_OPT>::Process(uint64_t index, uint8_t enAtomic)
{
    if ASCEND_IS_AIV {
