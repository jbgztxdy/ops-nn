...
#ifndef NN_MATMUL_TO_MATMULV3_FUSION_PASS_H
#define NN_MATMUL_TO_MATMULV3_FUSION_PASS_H

#include "ge/fusion/pass/pattern_fusion_pass.h"

namespace ops {

class __attribute__((visibility("default"))) MatMulToMatmulV3FusionPass : public ge::fusion::PatternFusionPass {
protected:
...
#endif // NN_MATMUL_TO_MATMULV3_FUSION_PASS_H