...
DECLARE_SCHEMA(MatMulV3TunnerTiling, FIELD(MatMulV3TunnerTiling, usedCoreNum), FIELD(MatMulV3TunnerTiling, singleCoreM),
               FIELD(MatMulV3TunnerTiling, singleCoreN), FIELD(MatMulV3TunnerTiling, singleCoreK),
               FIELD(MatMulV3TunnerTiling, baseM), FIELD(MatMulV3TunnerTiling, baseN),
               FIELD(MatMulV3TunnerTiling, baseK), FIELD(MatMulV3TunnerTiling, depthA1),
               FIELD(MatMulV3TunnerTiling, depthB1), FIELD(MatMulV3TunnerTiling, stepM),
               FIELD(MatMulV3TunnerTiling, stepN), FIELD(MatMulV3TunnerTiling, iterateOrder),
               FIELD(MatMulV3TunnerTiling, stepKa), FIELD(MatMulV3TunnerTiling, stepKb),
               FIELD(MatMulV3TunnerTiling, dbL0A), FIELD(MatMulV3TunnerTiling, dbL0B),
               FIELD(MatMulV3TunnerTiling, dbL0C), FIELD(MatMulV3TunnerTiling, l2MTileCnt),
               FIELD(MatMulV3TunnerTiling, l2NTileCnt), FIELD(MatMulV3TunnerTiling, l2MTileBlock),
               FIELD(MatMulV3TunnerTiling, l2NTileBlock), FIELD(MatMulV3TunnerTiling, l2IterateOrder),
