...
namespace QuantBatchMatmulInplaceAddArch35TilingKey {
    ...
    defined(ORIG_DTYPE_X1) && defined(ORIG_DTYPE_X2) && defined(ORIG_DTYPE_X2_SCALE) && \
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(
        KERNELTYPE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
        TPL_NO_VEC_EPILOGUE_WITH_MMAPI, TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI,
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(
            KERNELTYPE, ASCENDC_TPL_UI_LIST,
            TPL_NO_VEC_EPILOGUE_WITH_MMAPI_WITHOUT_BATCH,
            TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI_WITHOUT_BATCH)),
#endif
    ASCENDC_TPL_ARGS_SEL(
