...
// Kernel Type - MX quantization path
#define TPL_NO_VEC_EPILOGUE_WITH_MMAPI 0
#define TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI 1
// Kernel Type - Cube FixPipe quantization path (HiFloat8 T-T)
#define TPL_CUBE_FIXPIPE_DEFAULT_LOAD_WITH_MMAPI 2
#define TPL_CUBE_FIXPIPE_A_FULL_LOAD_WITH_MMAPI 3
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(
        ...
        TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI, TPL_CUBE_FIXPIPE_DEFAULT_LOAD_WITH_MMAPI,
        TPL_CUBE_FIXPIPE_A_FULL_LOAD_WITH_MMAPI));
