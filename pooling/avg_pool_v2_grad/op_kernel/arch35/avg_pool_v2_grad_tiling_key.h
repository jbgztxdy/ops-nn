...
ASCENDC_TPL_ARGS_DECL(
    AvgPoolV2Grad,
    ASCENDC_TPL_UINT_DECL(schMode, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, TPL_NCHW_KERNEL, TPL_NHWC_KERNEL,
                          TPL_SIMT_KERNEL),
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, TPL_NCHW_KERNEL),
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(schMode, ASCENDC_TPL_UI_LIST, TPL_NHWC_KERNEL),
