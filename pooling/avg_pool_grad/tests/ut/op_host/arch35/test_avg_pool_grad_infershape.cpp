...
protected:
    ...
    {
        std::cout << "AvgPoolGradInfershape SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "AvgPoolGradInfershape TearDown" << std::endl;
    }
};

static void ExecuteAvgPoolGradInfershapeTest(
...
{
    ExecuteAvgPoolGradInfershapeTest(
        {2, 3, 8, 8},
        {{2, 3, 4, 4}, {2, 3, 4, 4}},
        ge::FORMAT_NCHW,
        ge::DT_FLOAT,
