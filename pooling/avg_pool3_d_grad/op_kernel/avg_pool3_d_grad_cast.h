...
template <typename T>
__aicore__ inline void KernelAvgPool3DGradCast<T>::Init(GM_ADDR grads, GM_ADDR output,
...
template <typename T>
__aicore__ inline void KernelAvgPool3DGradCast<T>::CopyOut(int64_t n, int64_t d, int64_t h, int64_t w, int64_t c,
                                                           int64_t ubIndex)
{
