...
template <typename T>
__aicore__ inline void KernelAvgPool3DGradTCast<T>::Init(GM_ADDR grads, GM_ADDR output,
...
template <typename T>
__aicore__ inline void KernelAvgPool3DGradTCast<T>::CopyOut(int64_t n, int64_t c, int64_t d, int64_t hw,
                                                            int64_t ubIndex)
{
