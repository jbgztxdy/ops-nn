...
template <typename DIV_T>
__simt_callee__ __aicore__ __attribute__((always_inline)) inline static DIV_T startIndexNoMagic(DIV_T a, DIV_T b,
                                                                                                DIV_T c)
{
...
__simt_callee__ __aicore__ __attribute__((always_inline)) inline static void executeFunc(
    FORMAT_T count, __gm__ VALUE_T* bottomData, FORMAT_T ncSize, FORMAT_T height, FORMAT_T width, FORMAT_T outputNc,
    FORMAT_T outputHeight, FORMAT_T outputWidth, __gm__ VALUE_T* valueData, __gm__ INDICES_T* indicesData,
    DIV_T magicHW, DIV_T shiftHW, DIV_T magicH, DIV_T shiftH, DIV_T magicW, DIV_T shiftW)
{
...
template <typename VALUE_T, typename INDICES_T, typename FORMAT_T, typename DIV_T>
__aicore__ inline void AdaptiveMaxPool2DSimt<VALUE_T, INDICES_T, FORMAT_T, DIV_T>::Init(GM_ADDR x, GM_ADDR y,
                                                                                        GM_ADDR indices)
{
...
template <typename VALUE_T, typename INDICES_T, typename FORMAT_T, typename DIV_T>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM) inline void AdaptiveMaxPool2DNchwUb(
    FORMAT_T count, __gm__ VALUE_T* bottomData, FORMAT_T ncSize, FORMAT_T height, FORMAT_T width, FORMAT_T outputNc,
    FORMAT_T outputHeight, FORMAT_T outputWidth, __gm__ VALUE_T* valueData, __gm__ INDICES_T* indicesData,
    __ubuf__ DIV_T* SimtParam)
{
    ...
    executeFunc<VALUE_T, INDICES_T, FORMAT_T, DIV_T>(count, bottomData, ncSize, height, width, outputNc, outputHeight,
                                                     outputWidth, valueData, indicesData, magicHW, shiftHW, magicH,
                                                     shiftH, magicW, shiftW);
}

template <typename VALUE_T, typename INDICES_T, typename FORMAT_T, typename DIV_T>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM) inline void AdaptiveMaxPool2DNchwFunc(
    FORMAT_T count, __gm__ VALUE_T* bottomData, FORMAT_T ncSize, FORMAT_T height, FORMAT_T width, FORMAT_T outputNc,
    FORMAT_T outputHeight, FORMAT_T outputWidth, __gm__ VALUE_T* valueData, __gm__ INDICES_T* indicesData,
    DIV_T magicHW, DIV_T shiftHW, DIV_T magicH, DIV_T shiftH, DIV_T magicW, DIV_T shiftW)
{
...
__aicore__ inline void AdaptiveMaxPool2DSimt<VALUE_T, INDICES_T, FORMAT_T, DIV_T>::Process()
{
    ...
    if constexpr (std::is_same<FORMAT_T, int32_t>::value && std::is_same<DIV_T, uint32_t>::value) {
        Simt::VF_CALL<AdaptiveMaxPool2DNchwFunc<VALUE_T, INDICES_T, FORMAT_T, DIV_T>>(
            Simt::Dim3(THREAD_DIM), static_cast<FORMAT_T>(totalSize), inputData, ncSize,
            static_cast<FORMAT_T>(tilingData_->Hi), static_cast<FORMAT_T>(tilingData_->Wi), static_cast<FORMAT_T>(hw),
            static_cast<FORMAT_T>(tilingData_->Ho), static_cast<FORMAT_T>(tilingData_->Wo), outputData, indicesData,
