...
protected:
    static void SetUpTestCase() { std::cout << "AdaptiveAvgPool3dGradTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AdaptiveAvgPool3dGradTest TearDown" << std::endl; }
};
