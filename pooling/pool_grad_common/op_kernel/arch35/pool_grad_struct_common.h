...
ASCENDC_TPL_ARGS_DECL(MaxPoolGrad, ASCENDC_TPL_DTYPE_DECL(INDEX_DTYPE, TPL_INT32, TPL_INT64),
                      ASCENDC_TPL_BOOL_DECL(IS_SIMT, 0, 1), ASCENDC_TPL_BOOL_DECL(IS_CHANNEL_LAST, 0, 1),
                      ASCENDC_TPL_BOOL_DECL(IS_BIGGER_THAN_INT32, 0, 1), ASCENDC_TPL_BOOL_DECL(IS_BIG_KERNEL, 0, 1));
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIV_ONLY),
                                     ...
                                     ASCENDC_TPL_BOOL_SEL(IS_BIGGER_THAN_INT32, 0, 1),
