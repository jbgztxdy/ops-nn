...
{
    MaxPoolGradWithArgmaxNHWCNameSpace::MaxPoolGradWithArgmaxSimtTilingCommonData* tilingData = context->GetTilingData<
...
ge::graphStatus MaxPoolGradWithArgmaxSIMTTilingCommon::PostTiling(gert::TilingContext* context_,
