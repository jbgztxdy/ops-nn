...
protected:
    static void SetUpTestCase() { std::cout << "l2_max_pool_test SetUp" << std::endl; }
...
TEST_F(l2_max_pool_test, ascend910B2_normal_float_testcase01)
{
    ...
    auto ut = OP_API_UT(
        aclnnMaxPool, INPUT(tensor_self_desc, kernel_desc, stride_desc, autoPad, padding_desc, dilation_desc, ceilMode),
