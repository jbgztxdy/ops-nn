...
es::EsTensorHolder CreatePoolNode(es::EsGraphBuilder& graphBuilder, const char* opType, const es::EsTensorHolder& x,
...
TEST_F(MaxPoolFusionPassTest, max_pool_fusion_pass_test1)
{
    ...
    auto y = CreatePoolNode(graphBuilder, "MaxPool", x, {1, 2, 2, 1}, {1, 2, 2, 1}, "SAME", "NHWC");
...
TEST_F(MaxPoolFusionPassTest, max_pool_fusion_pass_missing_ksize)
{
    ...
    auto x = graphBuilder.CreateInput(0, "x", DT_FLOAT, FORMAT_NHWC, {1, 8, 8, 3});
    auto y = CreatePoolNode(graphBuilder, "MaxPool", x, {}, {1, 2, 2, 1}, "SAME", "NHWC");
    std::shared_ptr<Graph> graph = graphBuilder.BuildAndReset({y});
...
TEST_F(MaxPoolFusionPassTest, max_pool_fusion_pass_missing_padding)
{
    ...
    auto x = graphBuilder.CreateInput(0, "x", DT_FLOAT, FORMAT_NHWC, {1, 8, 8, 3});
    auto y = CreatePoolNode(graphBuilder, "MaxPool", x, {1, 2, 2, 1}, {1, 2, 2, 1}, "", "NHWC");
    std::shared_ptr<Graph> graph = graphBuilder.BuildAndReset({y});
...
TEST_F(MaxPoolFusionPassTest, max_pool_fusion_pass_test_nchw)
{
    ...
    auto y = CreatePoolNode(graphBuilder, "MaxPool", x, {1, 1, 2, 2}, {1, 1, 2, 2}, "SAME", "NCHW");
    std::shared_ptr<Graph> graph = graphBuilder.BuildAndReset({y});
...
TEST_F(MaxPoolFusionPassTest, max_pool_fusion_pass_invalid_ksize)
{
    ...
    auto x = graphBuilder.CreateInput(0, "x", DT_FLOAT, FORMAT_NHWC, {1, 8, 8, 3});
    auto y = CreatePoolNode(graphBuilder, "MaxPool", x, {1, 2, 2}, {1, 2, 2, 1}, "SAME", "NHWC");
    std::shared_ptr<Graph> graph = graphBuilder.BuildAndReset({y});
