...
protected:
    static void SetUpTestCase() { std::cout << "MaxPoolV3UT Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "MaxPoolV3UT Proto Test TearDown" << std::endl; }
};
...
protected:
    static void SetUpTestCase() { std::cout << "MaxPoolV3InferDataType SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "MaxPoolV3InferDataType TearDown" << std::endl; }
};
