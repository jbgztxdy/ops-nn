...
template <uint64_t INDEX_DTYPE = TPL_INT32, uint64_t IS_SIMT = 0, uint64_t IS_CHANNEL_LAST = 0,
          uint64_t IS_CHECK_RANGE = 0, uint64_t USE_INT64_INDEX = 0>
__global__ __aicore__ void max_pool3d_grad(GM_ADDR orig_x, GM_ADDR orig_y, GM_ADDR grads, GM_ADDR y, GM_ADDR workspace,
                                           GM_ADDR tiling)
{
    ...
    if constexpr (IS_SIMT == 0 && INDEX_DTYPE == TPL_INT32 && IS_CHECK_RANGE == 1) {
        ...
        REGISTER_TILING_FOR_TILINGKEY(
            "IS_SIMT == 1 && INDEX_DTYPE == TPL_INT64 && IS_CHANNEL_LAST == 0 && USE_INT64_INDEX == 0",
            MaxPool3DGradSimtTilingData);
        GET_TILING_DATA_WITH_STRUCT(MaxPool3DGradSimtTilingData, tilingData, tiling);
        ...
        REGISTER_TILING_FOR_TILINGKEY(
            "IS_SIMT == 1 && INDEX_DTYPE == TPL_INT32 && IS_CHANNEL_LAST == 1 && USE_INT64_INDEX == 0",
            MaxPool3DGradSimtTilingData);
        GET_TILING_DATA_WITH_STRUCT(MaxPool3DGradSimtTilingData, tilingData, tiling);
        ...
        REGISTER_TILING_FOR_TILINGKEY(
            "IS_SIMT == 1 && INDEX_DTYPE == TPL_INT64 && IS_CHANNEL_LAST == 1 && USE_INT64_INDEX == 0",
            MaxPool3DGradSimtTilingData);
        GET_TILING_DATA_WITH_STRUCT(MaxPool3DGradSimtTilingData, tilingData, tiling);
        ...
        REGISTER_TILING_FOR_TILINGKEY(
            "IS_SIMT == 1 && INDEX_DTYPE == TPL_INT64 && IS_CHANNEL_LAST == 0 && USE_INT64_INDEX == 1",
            MaxPool3DGradSimtTilingData);
        GET_TILING_DATA_WITH_STRUCT(MaxPool3DGradSimtTilingData, tilingData, tiling);
        ...
        REGISTER_TILING_FOR_TILINGKEY(
            "IS_SIMT == 1 && INDEX_DTYPE == TPL_INT64 && IS_CHANNEL_LAST == 1 && USE_INT64_INDEX == 1",
            MaxPool3DGradSimtTilingData);
        GET_TILING_DATA_WITH_STRUCT(MaxPool3DGradSimtTilingData, tilingData, tiling);
