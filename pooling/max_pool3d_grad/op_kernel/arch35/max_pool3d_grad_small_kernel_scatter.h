...
__aicore__ inline void IndexConvNcdhw(MicroAPI::RegTensor<T>& argmaxReg, MicroAPI::RegTensor<int32_t>& dIndexReg,
...
template <typename T, const uint32_t IS_MUL_NC = 0>
__aicore__ inline void IndexConvNchw(MicroAPI::RegTensor<T>& argmaxReg, MicroAPI::RegTensor<int32_t>& dIndexReg,
                                     MicroAPI::RegTensor<int32_t>& hIndexReg, MicroAPI::RegTensor<int32_t>& wIndexReg,
                                     MicroAPI::RegTensor<T>& hwOutputConstReg, MicroAPI::RegTensor<T>& wOutputConstReg,
                                     int64_t curDIndex, int64_t curHIndex, int64_t curWIndex, int32_t hOutputActual,
                                     int32_t wOutputAligned, int32_t highOutputOffset, int32_t highOutputPlaneActual,
                                     int32_t highArgmaxPlaneActual)
{
    ...
    AscendC::MicroAPI::Muls((AscendC::MicroAPI::RegTensor<int32_t>&)dTmpIndexReg, dIndexReg,
                            T(wOutputAligned * hOutputActual), allMaskU32);
...
__aicore__ inline void DoSingleNCNchw(__local_mem__ computeType* yAddr, __local_mem__ T1* gradAddr,
                                      ...
                                      MicroAPI::RegTensor<T3>& hwOutputConstReg,
                                      MicroAPI::RegTensor<T3>& wOutputConstReg, int64_t curDIndex, int64_t curHIndex,
                                      int64_t curWIndex, int32_t hOutputActual, int32_t wOutputAligned,
                                      ...
                                      MicroAPI::RegTensor<int32_t>& dMaxReg)
{
...
__aicore__ inline void DoSingleNCNcdhw(__local_mem__ computeType* yAddr, __local_mem__ T1* gradAddr,
                                       ...
                                       int32_t hOutputActual, MicroAPI::RegTensor<int32_t>& zeroConstReg,
                                       MicroAPI::RegTensor<int32_t>& dMaxReg, MicroAPI::RegTensor<int32_t>& hMaxReg,
