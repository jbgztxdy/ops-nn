    ...
    uint32_t outputOffset, uint32_t partNC, int32_t offD, int32_t offH, int32_t offW)
{
    ...
    Select<T>(
        transDataTensorUb2, maskIndex, transDataTensorUb2[indexStart], 1.f + this->kernelDHW,
    ...
    Select<T>(
        transDataTensorUb2[indexStart], maskIndex, transDataTensorUb2[indexStart], -1.f,
    ...
    const uint32_t pWR)
{
    ...
    Select<T>(
        transDataTensorUb2, maskIndex, this->kernelIndexes, (T)(1.f + this->kernelDHW),
