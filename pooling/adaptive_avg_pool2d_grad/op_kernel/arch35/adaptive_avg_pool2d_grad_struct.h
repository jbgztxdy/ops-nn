...
/*!
 * \file adaptive_avg_pool2d_grad_struct.h
 * \brief adaptive_avg_pool2d_grad tiling struct
 */
#ifndef ADAPTIVE_AVG_POOL2D_GRAD_STRUCT_H_
#define ADAPTIVE_AVG_POOL2D_GRAD_STRUCT_H_
...
struct AdaptiveAvgPool2dGradBigKernelTiling {
    int64_t hInput = 0;
    int64_t wInput = 0;
    int64_t hOutput = 0;
    int64_t wOutput = 0;
