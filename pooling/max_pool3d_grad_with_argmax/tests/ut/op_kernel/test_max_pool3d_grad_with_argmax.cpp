...
TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_scatter_case_1)
{
    vector<uint64_t> xShape = {40, 1, 1, 17, 17};
    vector<uint64_t> gradShape = {40, 1, 1, 8, 8};
    vector<uint64_t> ksize = {1, 3, 3};
    vector<uint64_t> strides = {1, 2, 2};
    vector<uint64_t> pads = {0, 0, 0};
    vector<uint64_t> dilation = {2, 1, 1};
    ...
    size_t xByteSize = ncDim * diDim * hiDim * wiDim * sizeof(bfloat16_t);
    size_t gradByteSize = ncDim * doDim * hoDim * woDim * sizeof(bfloat16_t);
    size_t argmaxByteSize = ncDim * doDim * hoDim * woDim * sizeof(int32_t);
    size_t dxByteSize = ncDim * diDim * hiDim * wiDim * sizeof(bfloat16_t);
    size_t tilingDataSize = sizeof(MaxPool3DGradWithArgmaxTilingData);
...
TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_nosplit_case_0)
{
    vector<uint64_t> xShape = {1, 8, 6, 6, 6};
    vector<uint64_t> gradShape = {1, 8, 2, 2, 2};
    vector<uint64_t> ksize = {3, 3, 3};
    vector<uint64_t> strides = {3, 3, 3};
    vector<uint64_t> pads = {0, 0, 0};
    vector<uint64_t> dilation = {1, 1, 1};
    uint64_t workspaceSize = 1024 * 1024 * 16;
    uint64_t blockDim = 48;
    uint64_t tilingKey = 100000;
    TestMaxPool3dGradWithArgmaxKernelNew<float>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_nosplit_case_1)
{
    vector<uint64_t> xShape = {1, 16, 6, 6, 6};
    vector<uint64_t> gradShape = {1, 16, 2, 2, 2};
    vector<uint64_t> ksize = {3, 3, 3};
    vector<uint64_t> strides = {3, 3, 3};
    vector<uint64_t> pads = {0, 0, 0};
    vector<uint64_t> dilation = {1, 1, 1};
    ...
    TestMaxPool3dGradWithArgmaxKernelNew<half>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_nosplit_case_2)
{
    vector<uint64_t> xShape = {1, 8, 6, 6, 6};
    vector<uint64_t> gradShape = {1, 8, 2, 2, 2};
    vector<uint64_t> ksize = {3, 3, 3};
    ...
    uint64_t workspaceSize = 1024 * 1024 * 16;
    uint64_t blockDim = 48;
    uint64_t tilingKey = 100002;
    TestMaxPool3dGradWithArgmaxKernelNew<bfloat16_t>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_splitd_case_0)
{
    vector<uint64_t> xShape = {1, 8, 16, 16, 16};
    vector<uint64_t> gradShape = {1, 8, 8, 8, 8};
    vector<uint64_t> ksize = {2, 2, 2};
    vector<uint64_t> strides = {2, 2, 2};
    vector<uint64_t> pads = {0, 0, 0};
    vector<uint64_t> dilation = {1, 1, 1};
    uint64_t workspaceSize = 1024 * 1024 * 16;
    uint64_t blockDim = 48;
    uint64_t tilingKey = 110000;
    TestMaxPool3dGradWithArgmaxKernelNew<float>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_splitd_case_1)
{
    vector<uint64_t> xShape = {1, 16, 16, 16, 16};
    vector<uint64_t> gradShape = {1, 16, 8, 8, 8};
    vector<uint64_t> ksize = {2, 2, 2};
    vector<uint64_t> strides = {2, 2, 2};
    vector<uint64_t> pads = {0, 0, 0};
    vector<uint64_t> dilation = {1, 1, 1};
    uint64_t workspaceSize = 1024 * 1024 * 16;
    uint64_t blockDim = 48;
    uint64_t tilingKey = 110001;
    TestMaxPool3dGradWithArgmaxKernelNew<half>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_splitd_case_2)
{
    vector<uint64_t> xShape = {1, 8, 16, 16, 16};
    vector<uint64_t> gradShape = {1, 8, 8, 8, 8};
    vector<uint64_t> ksize = {2, 2, 2};
    ...
    uint64_t workspaceSize = 1024 * 1024 * 16;
    uint64_t blockDim = 48;
    uint64_t tilingKey = 110002;
    TestMaxPool3dGradWithArgmaxKernelNew<bfloat16_t>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_splith_case_0)
{
    vector<uint64_t> xShape = {1, 8, 64, 64, 64};
    vector<uint64_t> gradShape = {1, 8, 32, 32, 32};
    vector<uint64_t> ksize = {2, 2, 2};
    vector<uint64_t> strides = {2, 2, 2};
    vector<uint64_t> pads = {0, 0, 0};
    vector<uint64_t> dilation = {1, 1, 1};
    uint64_t workspaceSize = 1024 * 1024 * 16;
    uint64_t blockDim = 48;
    uint64_t tilingKey = 111000;
    TestMaxPool3dGradWithArgmaxKernelNew<float>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_splith_case_1)
{
    vector<uint64_t> xShape = {1, 16, 64, 64, 64};
    vector<uint64_t> gradShape = {1, 16, 32, 32, 32};
    vector<uint64_t> ksize = {2, 2, 2};
    vector<uint64_t> strides = {2, 2, 2};
    vector<uint64_t> pads = {0, 0, 0};
    vector<uint64_t> dilation = {1, 1, 1};
    uint64_t workspaceSize = 1024 * 1024 * 16;
    uint64_t blockDim = 48;
    uint64_t tilingKey = 111001;
    TestMaxPool3dGradWithArgmaxKernelNew<half>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_splith_case_2)
{
    vector<uint64_t> xShape = {1, 8, 64, 64, 64};
    vector<uint64_t> gradShape = {1, 8, 32, 32, 32};
    vector<uint64_t> ksize = {2, 2, 2};
    ...
    uint64_t workspaceSize = 1024 * 1024 * 16;
    uint64_t blockDim = 48;
    uint64_t tilingKey = 111002;
    TestMaxPool3dGradWithArgmaxKernelNew<bfloat16_t>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_splitw_case_0)
{
    vector<uint64_t> xShape = {1, 8, 16, 16, 1024};
    vector<uint64_t> gradShape = {1, 8, 8, 8, 512};
    vector<uint64_t> ksize = {2, 2, 2};
    vector<uint64_t> strides = {2, 2, 2};
    vector<uint64_t> pads = {0, 0, 0};
    vector<uint64_t> dilation = {1, 1, 1};
    uint64_t workspaceSize = 1024 * 1024 * 16;
    uint64_t blockDim = 48;
    uint64_t tilingKey = 111100;
    TestMaxPool3dGradWithArgmaxKernelNew<float>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_splitw_case_1)
{
    vector<uint64_t> xShape = {1, 16, 16, 16, 1024};
    vector<uint64_t> gradShape = {1, 16, 8, 8, 512};
    vector<uint64_t> ksize = {2, 2, 2};
    vector<uint64_t> strides = {2, 2, 2};
    vector<uint64_t> pads = {0, 0, 0};
    vector<uint64_t> dilation = {1, 1, 1};
    uint64_t workspaceSize = 1024 * 1024 * 16;
    uint64_t blockDim = 48;
    uint64_t tilingKey = 111101;
    TestMaxPool3dGradWithArgmaxKernelNew<half>(
        xShape, gradShape, ksize, strides, pads, dilation, workspaceSize, blockDim, tilingKey);
}

TEST_F(MaxPool3dGradWithArgmaxKernel, max_pool3d_grad_with_argmax_splitw_case_2)
{
    vector<uint64_t> xShape = {1, 8, 16, 16, 1024};
    vector<uint64_t> gradShape = {1, 8, 8, 8, 512};
    vector<uint64_t> ksize = {2, 2, 2};
