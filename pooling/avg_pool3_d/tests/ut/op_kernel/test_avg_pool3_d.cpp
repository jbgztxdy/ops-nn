...
protected:
    static void SetUpTestCase() { std::cout << "AvgPool3DTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AvgPool3DTest TearDown" << std::endl; }
};
...
TEST_P(AvgPool3DTest, test_case_avg_pool3d)
{
    ...
    int64_t outputShapeSize = tilingParam.inN * tilingParam.inC * tilingParam.outD * tilingParam.outH *
                              tilingParam.outW;
...
static AvgPool3DTestParam cases[] = {
    {"test_case_split_c_float32", sizeof(float), 10, {2, 256, 256, 8, 16, 16, 8,  7,  7,  1,  3,   3, 1, 2, 2,
                                                      0, 0,   0,   0, 1,  0,  17, 16, 16, 32, 128, 0, 0, 0}},
    {"test_case_split_w_float32", sizeof(float), 20, {2, 128, 0, 8, 16, 16, 8,  7,  7,  1,  4,   4, 1, 2, 2,
                                                      0, 0,   0, 0, 1,  0,  17, 16, 16, 32, 128, 0, 3, 0}},
    {"test_case_multi_w_float32", sizeof(float), 30, {2, 128, 0, 8, 16, 16, 8,  7,  7,  1,  3,   3, 1, 2, 2,
                                                      0, 0,   0, 0, 1,  0,  17, 16, 16, 32, 128, 4, 0, 0}},
    {"test_case_normal_float32", sizeof(float), 50, {2, 128, 0, 8, 16, 16, 3,  16, 16, 3,  1,   1, 2, 1,  1,
                                                     0, 0,   0, 0, 1,  0,  43, 32, 42, 16, 128, 0, 0, 256}},
    {"test_case_normal_float16", sizeof(half), 51, {2, 128, 0, 8, 16, 16, 3,  16, 16, 3,  1,   1, 2, 1,  1,
                                                    0, 0,   0, 0, 1,  0,  43, 32, 42, 16, 128, 0, 0, 256}},
    {"test_case_normal_bfloat16", sizeof(bfloat16_t), 52, {2, 128, 0, 8, 16, 16, 3,  16, 16, 3,  1,   1, 2, 1,  1,
                                                           0, 0,   0, 0, 1,  0,  43, 32, 42, 16, 128, 0, 0, 256}},
    {"test_case_big_kernel_float32", sizeof(float), 60, {1, 16, 0, 8, 16, 16, 8,  7,  7,  1,   3, 3, 1, 2, 2, 0,
                                                         0, 0,  0, 1, 0,  17, 16, 16, 32, 128, 4, 0, 0, 0, 0, 0,
