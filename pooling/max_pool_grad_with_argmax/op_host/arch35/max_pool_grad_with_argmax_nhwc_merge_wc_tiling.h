...
public:
    explicit MaxPoolGradWithArgmaxNHWCMergeWcTiling(gert::TilingContext* context)
        : MaxPoolGradWithArgmaxBaseTiling(context), NHWCBase(new MaxPoolGradWithArgmaxNHWCTilingCommon(&inputData))
    {}

    ~MaxPoolGradWithArgmaxNHWCMergeWcTiling() override { delete NHWCBase; }
