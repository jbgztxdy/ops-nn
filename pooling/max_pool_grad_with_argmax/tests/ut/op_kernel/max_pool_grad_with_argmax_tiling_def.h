...
{
    memcpy_s(constData, sizeof(MaxPoolGradWithArgmaxSimtTilingCommonData), tiling,
             sizeof(MaxPoolGradWithArgmaxNHWCTilingCommonData));
}

inline void InitTilingData(uint8_t* tiling, MaxPoolGradWithArgmaxSimtTilingCommonData* constData)
{
    memcpy_s(constData, sizeof(MaxPoolGradWithArgmaxSimtTilingCommonData), tiling,
             sizeof(MaxPoolGradWithArgmaxSimtTilingCommonData));
}
