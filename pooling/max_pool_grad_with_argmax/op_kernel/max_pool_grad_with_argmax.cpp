                                                                ...
                                                                GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    if (TILING_KEY_IS(NO_CHECK_RANGE_TILING_KEY_NHWC_MERGE_HWC)) {
        ...
        REGISTER_TILING_FOR_TILINGKEY("TILING_KEY_VAR == 801",
                                      MaxPoolGradWithArgmaxNHWCNameSpace::MaxPoolGradWithArgmaxSimtTilingCommonData);
        GET_TILING_DATA_WITH_STRUCT(MaxPoolGradWithArgmaxNHWCNameSpace::MaxPoolGradWithArgmaxSimtTilingCommonData,
                                    tilingDataIn, tiling);
        ...
        REGISTER_TILING_FOR_TILINGKEY("TILING_KEY_VAR == 802",
                                      MaxPoolGradWithArgmaxNHWCNameSpace::MaxPoolGradWithArgmaxSimtTilingCommonData);
        GET_TILING_DATA_WITH_STRUCT(MaxPoolGradWithArgmaxNHWCNameSpace::MaxPoolGradWithArgmaxSimtTilingCommonData,
                                    tilingDataIn, tiling);
        ...
        REGISTER_TILING_FOR_TILINGKEY("TILING_KEY_VAR == 803",
                                      MaxPoolGradWithArgmaxNHWCNameSpace::MaxPoolGradWithArgmaxSimtTilingCommonData);
        GET_TILING_DATA_WITH_STRUCT(MaxPoolGradWithArgmaxNHWCNameSpace::MaxPoolGradWithArgmaxSimtTilingCommonData,
                                    tilingDataIn, tiling);
        ...
        REGISTER_TILING_FOR_TILINGKEY("TILING_KEY_VAR == 804",
                                      MaxPoolGradWithArgmaxNHWCNameSpace::MaxPoolGradWithArgmaxSimtTilingCommonData);
        GET_TILING_DATA_WITH_STRUCT(MaxPoolGradWithArgmaxNHWCNameSpace::MaxPoolGradWithArgmaxSimtTilingCommonData,
                                    tilingDataIn, tiling);
